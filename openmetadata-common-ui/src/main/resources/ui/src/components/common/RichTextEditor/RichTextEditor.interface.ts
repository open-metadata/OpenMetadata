...
export interface PreviewerProp {
  markdown?: string; // with newer version we expect to use html instead of markdown
  className?: string;
  ...
  // Translation function for library integration
  i18n?: (key: string, options?: Record<string, unknown>) => string;
}
