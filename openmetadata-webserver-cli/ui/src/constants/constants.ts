...
// import { getEncodedFqn } from '../utils/CommonUtils';
import {
...
export const LOCALSTORAGE_RECENTLY_VIEWED = 'recentlyViewedData_'; //`recentlyViewedData_${COOKIE_VERSION}`;
export const LOCALSTORAGE_RECENTLY_SEARCHED = 'recentlySearchedData_'; //`recentlySearchedData_${COOKIE_VERSION}`;
...
export const getKpiPath = (kpiName: string) => {
  ...
  path = path.replace(PLACEHOLDER_ROUTE_FQN, kpiName);
