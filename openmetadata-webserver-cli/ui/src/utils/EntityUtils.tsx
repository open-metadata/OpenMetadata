...
//   const tier = "tier-tag" // getTierTags(tags ?? []);
...
//   const tier = "tier-tags";//getTierTags(tags ?? []);
...
export const getEntityOverview = (
  ...
  switch (type) {
    ...
    default:
      if (entityDetail || additionalInfo) return [];
      return [];
  }
};
...
export const getEntityFeedLink = (
  ...
  return `<#E${ENTITY_LINK_SEPARATOR}${type}${ENTITY_LINK_SEPARATOR}${fqn}${field ? `${ENTITY_LINK_SEPARATOR}${field}` : ''
    }>`;
};
