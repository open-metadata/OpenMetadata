...
generate:  ## Generate the pydantic models from the JSON Schemas to the ingestion module
	...
	datamodel-codegen --input catalog-rest-service/src/main/resources/json/schema --input-file-type jsonschema --output ingestion/src/metadata/generated --set-default-enum-member
	$(MAKE) py_antlr
	$(MAKE) install
...
core_generate:  ## Generate the pydantic models from the JSON Schemas to the ingestion-core module
	...
	datamodel-codegen --input catalog-rest-service/src/main/resources/json/schema  --input-file-type jsonschema --output ingestion-core/src/metadata/generated
	$(MAKE) core_py_antlr
