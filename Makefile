...
docker-docs-local:  ## Runs the OM docs in docker with a local image
	docker run --env NEXT_PUBLIC_ALGOLIA_APP_ID=9JH19D2DQ0 --env NEXT_PUBLIC_ALGOLIA_API_KEY=38758af91d7e29692db598a007069a29 --name openmetadata-docs -p 3000:3000 -v ${PWD}/openmetadata-docs/content:/docs/content/ -v ${PWD}/openmetadata-docs/images:/docs/public/images openmetadata-docs:local yarn dev
...
docker-docs:  ## Runs the OM docs in docker passing openmetadata-docs-v1 as volume for content and images
	...
	docker run --env NEXT_PUBLIC_ALGOLIA_APP_ID=9JH19D2DQ0 --env NEXT_PUBLIC_ALGOLIA_API_KEY=38758af91d7e29692db598a007069a29 --name openmetadata-docs -p 3000:3000 -v ${PWD}/openmetadata-docs/content:/docs/content/ -v ${PWD}/openmetadata-docs/images:/docs/public/images openmetadata/docs:latest yarn dev
