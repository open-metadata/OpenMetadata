...
ui-checkstyle-all:
	cd openmetadata-ui/src/main/resources/ui && yarn install --frozen-lockfile && yarn ui-checkstyle && yarn ui-checkstyle:playwright && yarn license-header-fix && yarn i18n && yarn generate:app-docs
	cd openmetadata-ui-core-components/src/main/resources/ui && yarn install --frozen-lockfile && yarn lint:fix && yarn pretty

# Run all changed-file UI checkstyle operations with one command.
.PHONY: ui-checkstyle-changed
ui-checkstyle-changed:
	cd openmetadata-ui/src/main/resources/ui && yarn install --frozen-lockfile && yarn ui-checkstyle:changed && yarn ui-checkstyle:playwright:changed && yarn license-header-fix && yarn i18n && yarn generate:app-docs
	cd openmetadata-ui-core-components/src/main/resources/ui && yarn install --frozen-lockfile && yarn ui-checkstyle:changed
