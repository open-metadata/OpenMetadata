...
* [Requirements](run-presto-connector-with-the-cli.md#requirements)
* [Metadata Ingestion](run-presto-connector-with-the-cli.md#metadata-ingestion)
* [Query Usage and Lineage Ingestion](run-presto-connector-with-the-cli.md#query-usage-and-lineage-ingestion)
* [Data Profiler and Quality Tests](run-presto-connector-with-the-cli.md#data-profiler-and-quality-tests)
* [DBT Integration](run-presto-connector-with-the-cli.md#dbt-integration)
...
The same as the [metadata](run-presto-connector-with-the-cli.md#workflow-configuration) ingestion.
