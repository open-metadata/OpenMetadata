...
# Run Presto Connector with the Airflow SDK

Configure and schedule Presto **metadata** and **profiler** workflows using your own Airflow instances.

* [Requirements](run-presto-connector-with-the-airflow-sdk.md#requirements)
* [Metadata Ingestion](run-presto-connector-with-the-airflow-sdk.md#metadata-ingestion)
* [Data Profiler and Quality Tests](run-presto-connector-with-the-airflow-sdk.md#data-profiler-and-quality-tests)
* [DBT Integration](run-presto-connector-with-the-airflow-sdk.md#dbt-integration)
...
This is a sample config for Presto profiler:
...
The same as the [metadata](run-presto-connector-with-the-airflow-sdk.md#workflow-configuration) ingestion.
