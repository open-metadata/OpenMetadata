...
# Run Vertica Connector using Airflow SDK

Configure and schedule Vertica **metadata**, and **profiler** workflows using your own Airflow instances.

* [Requirements](run-vertica-connector-using-airflow-sdk.md#requirements)
* [Metadata Ingestion](run-vertica-connector-using-airflow-sdk.md#metadata-ingestion)
* [Data Profiler and Quality Tests](run-vertica-connector-using-airflow-sdk.md#data-profiler-and-quality-tests)
* [DBT Integration](run-vertica-connector-using-airflow-sdk.md#dbt-integration)
...
All connectors are now defined as JSON Schemas. [Here](https://github.com/open-metadata/OpenMetadata/blob/main/catalog-rest-service/src/main/resources/json/schema/entity/services/connections/database/bigQueryConnection.json) you can find the structure to create a connection to Vertica.
...
This is a sample config for a Vertica profiler:
...
The same as the [metadata](run-vertica-connector-using-airflow-sdk.md#workflow-configuration) ingestion.
