...
# Run MariaDB Connector using CLI

Configure and schedule MariaDB **metadata**, and **profiler** workflows using CLI.

* [Requirements](run-mariadb-connector-using-cli.md#requirements)
* [Metadata Ingestion](run-mariadb-connector-using-cli.md#metadata-ingestion)
* [Data Profiler and Quality Tests](run-mariadb-connector-using-cli.md#data-profiler-and-quality-tests)
* [DBT Integration](run-mariadb-connector-using-cli.md#dbt-integration)
...
All connectors are now defined as JSON Schemas. [Here](https://github.com/open-metadata/OpenMetadata/blob/main/catalog-rest-service/src/main/resources/json/schema/entity/services/connections/database/mariaDBConnection.json) you can find the structure to create a connection to MariaDB.
...
You can find all the definitions and types for the `serviceConnection` [here](https://github.com/open-metadata/OpenMetadata/blob/main/catalog-rest-service/src/main/resources/json/schema/entity/services/connections/database/mariaDBConnection.json).

* **username**: Enter the username of your MariaDB user in the _Username_ field. The specified user should be authorized to read all databases you want to include in the metadata ingestion workflow.
* **password**: Enter the password for your MariaDB user in the _Password_ field.
* **hostPort**: Enter the fully qualified hostname and port number for your MariaDB deployment in the _Host and Port_ field.
...
* **connectionOptions** (Optional): Enter the details for any additional connection options that can be sent to MariaDB during the connection. These details must be added as Key-Value pairs.
* **connectionArguments** (Optional): Enter the details for any additional connection arguments such as security or protocol configs that can be sent to MariaDB during the connection. These details must be added as Key-Value pairs
...
This is a sample config for a MariaDB profiler:
...
The same as the [metadata](run-mariadb-connector-using-cli.md#workflow-configuration) ingestion.
