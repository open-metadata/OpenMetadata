---
description: Use your own Airflow instance to schedule and run the MariaDB Connector.
---

# Run MariaDB Connector with the Airflow SDK

Configure and schedule MariaDB **metadata** and **profiler** workflows using your own Airflow instances.

* [Requirements](run-mariadb-connector-with-the-airflow-sdk.md#requirements)
* [Metadata Ingestion](run-mariadb-connector-with-the-airflow-sdk.md#metadata-ingestion)
* [Data Profiler and Quality Tests](run-mariadb-connector-with-the-airflow-sdk.md#data-profiler-and-quality-tests)
* [DBT Integration](run-mariadb-connector-with-the-airflow-sdk.md#dbt-integration)
...
The same as the [metadata](run-mariadb-connector-with-the-airflow-sdk.md#workflow-configuration) ingestion.
