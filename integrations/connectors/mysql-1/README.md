---
description: >-
  In this section, we provide the guides and reference to use the MariaDB
  connector.
---
...
{% content-ref url="run-mariadb-connector-with-the-airflow-sdk.md" %}
[run-mariadb-connector-with-the-airflow-sdk.md](run-mariadb-connector-with-the-airflow-sdk.md)
{% endcontent-ref %}

{% content-ref url="run-mariadb-connector-using-cli.md" %}
[run-mariadb-connector-using-cli.md](run-mariadb-connector-using-cli.md)
{% endcontent-ref %}
...
Select MariaDB as the service type and click _Next_.

![Select your Service type](<../../../.gitbook/assets/Screenshot 2022-05-17 at 1.45.04 PM.png>)
...
OpenMetadata uniquely identifies services by their _Service Name_. Provide a name that distinguishes your deployment from other services, including the other MariaDB services that you might be ingesting metadata from.

![Provide a Name and a description for your Service](<../../../.gitbook/assets/Screenshot 2022-05-17 at 1.46.03 PM.png>)

### 5. Configure the Service Connection

In this step, we will configure the connection settings required for this connector. Please follow the instructions below to ensure that you've configured the connector to read from your MariaDB service as desired.
...
![Service has been saved](<../../../.gitbook/assets/Screenshot 2022-05-17 at 1.46.38 PM.png>)
