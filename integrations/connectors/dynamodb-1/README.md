---
description: >-
  In this section, we provide the guides and references to use the Datalake
  connector.
---

# Datalake

Configure and schedule Datalake **metadata** workflows from the OpenMetadata UI.
...
![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 1.09.03 PM.png>)

### 4. Name and Describe your Service

Provide a name and description for your service as illustrated below.

![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 2.30.17 PM.png>)
...
![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 2.32.04 PM.png>)
...
![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 3.01.59 PM.png>)
...
![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 2.34.18 PM.png>)

### 6. Configure the Metadata Ingestion

Once the service is created, we can add a **Metadata Ingestion Workflow**, either directly from the _Add Ingestion_ button in the figure above, or from the Service page:

![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 2.35.20 PM.png>)
...
![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 2.36.15 PM.png>)
...
![](<../../../.gitbook/assets/Screenshot 2022-07-13 at 2.36.54 PM.png>)
...
{% content-ref url="../dynamodb/run-dynamodb-connector-using-airflow-sdk.md" %}
[run-dynamodb-connector-using-airflow-sdk.md](../dynamodb/run-dynamodb-connector-using-airflow-sdk.md)
{% endcontent-ref %}
...
{% content-ref url="../dynamodb/run-dynamodb-connector-with-the-cli.md" %}
[run-dynamodb-connector-with-the-cli.md](../dynamodb/run-dynamodb-connector-with-the-cli.md)
{% endcontent-ref %}
