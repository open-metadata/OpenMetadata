---
description: Use your own Airflow instance to schedule and run the Redash Connector.
---

# Run Redash Connector with the Airflow SDK

Configure and schedule Redash **metadata** workflows using your own Airflow instances.

* [Requirements](run-redash-connector-with-the-airflow-sdk.md#requirements)
* [Metadata Ingestion](run-redash-connector-with-the-airflow-sdk.md#metadata-ingestion)
