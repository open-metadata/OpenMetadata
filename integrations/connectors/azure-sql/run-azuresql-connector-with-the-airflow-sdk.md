...
* [Requirements](run-azuresql-connector-with-the-airflow-sdk.md#requirements)
* [Metadata Ingestion](run-azuresql-connector-with-the-airflow-sdk.md#metadata-ingestion)
* [Query Usage and Lineage Ingestion](run-azuresql-connector-with-the-airflow-sdk.md#query-usage-and-lineage-ingestion)
* [Data Profiler and Quality Tests](run-azuresql-connector-with-the-airflow-sdk.md#data-profiler-and-quality-tests)
* [DBT Integration](run-azuresql-connector-with-the-airflow-sdk.md#dbt-integration)
...
The same as the [metadata](run-azuresql-connector-with-the-airflow-sdk.md#workflow-configuration) ingestion.
