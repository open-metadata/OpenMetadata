...
* [Requirements](run-azuresql-connector-with-the-cli.md#requirements)
* [Metadata Ingestion](run-azuresql-connector-with-the-cli.md#metadata-ingestion)
* [Query Usage and Lineage Ingestion](run-azuresql-connector-with-the-cli.md#query-usage-and-lineage-ingestion)
* [Data Profiler and Quality Tests](run-azuresql-connector-with-the-cli.md#data-profiler-and-quality-tests)
* [DBT Integration](run-azuresql-connector-with-the-cli.md#dbt-integration)
...
The same as the [metadata](run-azuresql-connector-with-the-cli.md#workflow-configuration) ingestion.
