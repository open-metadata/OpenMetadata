---
description: >-
  In this section, we provide the guides and reference to use the Tableau
  connector.
---
...
{% content-ref url="run-tableau-connector-with-the-airflow-sdk.md" %}
[run-tableau-connector-with-the-airflow-sdk.md](run-tableau-connector-with-the-airflow-sdk.md)
{% endcontent-ref %}

{% content-ref url="run-tableau-connector-with-the-cli.md" %}
[run-tableau-connector-with-the-cli.md](run-tableau-connector-with-the-cli.md)
{% endcontent-ref %}
...
![Add a New Service from the Services Page](<../../../.gitbook/assets/image (171).png>)

### 3. Select the Service Type

Select Redash as the service type and click _Next_.

![Select your Service type](<../../../.gitbook/assets/Screenshot 2022-05-20 at 3.56.46 PM.png>)
...
![Schedule the Ingestion Pipeline and Deploy](<../../../.gitbook/assets/image (20) (1) (1).png>)
