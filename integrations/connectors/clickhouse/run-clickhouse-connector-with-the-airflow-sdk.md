...
* **databaseSchema**: If you want to limit metadata ingestion to a single database schema, enter the name of this database schema in the DatabaseSchema field. If no value is entered for this field, the connector will ingest metadata from all databases that the specified user is authorized to read.
