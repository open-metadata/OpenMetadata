---
description: >-
  In this section, we provide the guides and references to use the Data Lake
  connector.
---
...
{% content-ref url="run-data-lake-connector-using-airflow-sdk.md" %}
[run-data-lake-connector-using-airflow-sdk.md](run-data-lake-connector-using-airflow-sdk.md)
{% endcontent-ref %}

{% content-ref url="run-data-lake-connector-with-the-cli.md" %}
[run-data-lake-connector-with-the-cli.md](run-data-lake-connector-with-the-cli.md)
{% endcontent-ref %}
...
Select Data Lake as the service type and click _Next_.
...
OpenMetadata uniquely identifies services by their _Service Name_. Provide a name that distinguishes your deployment from other services, including the other Data Lake services that you might be ingesting metadata from.

### 5. Configure the Service Connection

In this step, we will configure the connection settings required for this connector. Please follow the instructions below to ensure that you've configured the connector to read from your Data Lake service as desired. OpenMetadata connects to Amazon S3 and Google Cloud Storage.
...
<summary>Connection Options for AWS</summary>

**AWS Access Key ID**

Enter your secure access key ID for your Amazon S3 connection. The specified key ID should be authorized to read all databases you want to include in the metadata ingestion workflow.
...
Specify the region in which your Amazon S3 bucket is located.
...
The Amazon S3 connector will automatically determine the Amazon S3 endpoint URL based on the AWS Region. You may specify a value to override this behavior.
...
Enter the details for any additional connection options that can be sent to Amazon S3 during the connection. These details must be added as Key-Value pairs.

**Connection Arguments (Optional)**

Enter the details for any additional connection arguments such as security or protocol configs that can be sent to Amazon S3 during the connection. These details must be added as Key-Value pairs.
...
After hitting Save you will see that your Data Lake connector has been added successfully, and you can add an ingestion.
