...
public class StorageServiceTestFactory {
   ...
   */
  public static StorageService createS3(OpenMetadataClient client, TestNamespace ns) {
    ...
    return client.storageServices().create(request);
  }

  /** Get storage service by ID. */
  public static StorageService getById(OpenMetadataClient client, String id) {
    return client.storageServices().get(id);
  }
}
