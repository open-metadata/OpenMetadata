...
public class explore {
    ...
    public void checkTableCount() throws InterruptedException {
        ...
        By countService = By.xpath("//span[@class=\"tw-py-px tw-px-1 tw-ml-1 tw-border tw-rounded tw-text-xs tw-min-w-badgeCount tw-text-center tw-bg-badge tw-py-0 tw-px-0\"]");//count of services
