...
public class tableDetails {
    ...
    By manage = By.xpath("(//button[@data-testid=\"tab\"])[1]");
    ...
    By schema = By.xpath("(//button[@data-testid=\"tab\"])[1]");;
    By lineage = By.xpath("(//button[@data-testid=\"tab\"])[4]");;
    By lineageComponents = By.xpath("//div[@class=\"tw-relative nowheel \"]");
    By profiler = By.xpath("(//button[@data-testid=\"tab\"])[3]");;
    By sampleData = By.xpath("(//button[@data-testid=\"tab\"])[2]");;
    ...
    By toolTip = By.xpath("//div[@class=\"recharts-tooltip-wrapper recharts-tooltip-wrapper-left recharts-tooltip-wrapper-top\"]");
    ...
    public By versionDrawer() {
        return versionDrawer;
    }
