...
public class TopicDetailsUIErrorHandlingTest {
  ...
  @Test
  @Order(1)
  void exceptionCheckForFetchTopicDetails() throws InterruptedException {
    Events.click(webDriver, common.closeWhatsNew());
    Events.click(webDriver, common.explore());
    Events.click(webDriver, common.topics());
    interceptor.interceptor("/topics/name", "/testing/name");
  ...
  void exceptionCheckForAddTags() throws InterruptedException {
    ...
    interceptor.interceptor("/topics", "testing");
