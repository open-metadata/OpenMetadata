...
public class MyDataPageTest {
  ...
  public void checkOverview() throws Exception {
    ...
    String tablesCount =
        webDriver
            .findElement(
                By.xpath("//div[@data-testid='tables-summary']//span[@data-testid='filter-count']"))
    ...
    String topicsCount =
        webDriver
            .findElement(
                By.xpath("//div[@data-testid='topics-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
    ...
    String dashboardsCount =
        webDriver
            .findElement(
                By.xpath(
                    "//div[@data-testid='dashboards-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
    ...
    String pipelinesCount =
        webDriver
            .findElement(
                By.xpath(
                    "//div[@data-testid='pipelines-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
    ...
    String servicesCount =
        webDriver
            .findElement(
                By.xpath(
                    "//div[@data-testid='service-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
    ...
    String ingestionCount =
        webDriver
            .findElement(
                By.xpath(
                    "//div[@data-testid='ingestion-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
    ...
    String usersCount =
        webDriver
            .findElement(
                By.xpath("//div[@data-testid='user-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
    ...
    String teamsCount =
        webDriver
            .findElement(
                By.xpath("//div[@data-testid='terms-summary']//span[@data-testid='filter-count']"))
            .getAttribute("innerHTML");
  ...
  public void checkRecentViews() throws Exception {
    ...
    WebElement recentViews =
        webDriver.findElement(
            By.xpath("//*[text()[contains(.,'" + "No recently viewed data!" + "')]] "));
  ...
  public void checkMyDataTab() throws Exception {
    ...
    WebElement myDataResults =
        webDriver.findElement(
            By.xpath("//*[text()[contains(.,'" + "You have not owned anything yet!" + "')]] "));
  ...
  public void checkFollowingTab() throws Exception {
    ...
    WebElement followResults =
        webDriver.findElement(
            By.xpath("//*[text()[contains(.,'" + "You have not followed anything yet!" + "')]] "));
  ...
  public void checkSearchResults() throws Exception {
    ...
    String searchedEntity =
        webDriver
            .findElement(By.cssSelector("[data-testid='no-search-results']"))
            .getAttribute("innerHTML");
