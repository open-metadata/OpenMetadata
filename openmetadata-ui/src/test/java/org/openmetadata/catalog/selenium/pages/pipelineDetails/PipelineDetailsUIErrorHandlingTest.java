...
public class PipelineDetailsUIErrorHandlingTest {
  ...
  void exceptionCheckForFetchDashboardDetails() throws InterruptedException {
    ...
    Events.click(webDriver, common.pipeline());
    interceptor.interceptor("/pipelines/name", "/testing/name");
    Events.click(webDriver, common.selectTableLink(1));
    Thread.sleep(2000);
    String errorMessage = webDriver.findElement(toastMessage).getText();
    Assert.assertEquals(errorMessage, "Error while fetching pipeline details!");
  ...
  void exceptionCheckForAddTags() throws InterruptedException {
    ...
    interceptor.interceptor("/pipelines", "testing");
  ...
  void exceptionCheckForUpdatingDescription() throws InterruptedException {
    ...
    interceptor.interceptor("/api/v1/pipelines", "/api/v1/test");
  ...
  void exceptionCheckForFetchLineage() throws InterruptedException {
    ...
    Events.click(webDriver, common.pipeline());
    Events.click(webDriver, common.selectTableLink(1));
    interceptor.interceptor("/api/v1/lineage/pipeline/name", "/api/v1/test/pipeline/name");
