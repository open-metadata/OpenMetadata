...
letter-spacing. See foundations/typography.md.
...
| `--om-color-border-subtle` | `rgb(0 0 0 / 0.08)` |
| `--om-color-border-success-subtle` | `#75e0a7` |
