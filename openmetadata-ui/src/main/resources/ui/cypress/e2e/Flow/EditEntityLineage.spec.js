...
const mlmodelEntity = SEARCH_ENTITY_MLMODEL.mlmodel_1

const ENTITIES_LIST=[tableEntity,topicEntity,pipelineEntity,dashboardEntity,mlmodelEntity]
...
describe('Entity Details Page', () => {
  ...
  ENTITIES_LIST.map((entity) => {
    ...
    cy.get('[data-testid="edit-lineage"]').should("be.visible").should("not.be.disabled")
  })
  })
