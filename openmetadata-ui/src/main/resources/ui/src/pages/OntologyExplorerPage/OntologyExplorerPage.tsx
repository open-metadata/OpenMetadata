...
const getSelectedGlossaryLabel = (
  selectedGlossary: Glossary | undefined,
...
const getExplorerSurface = (
  mode: StudioMode,
  viewSurface: ViewSurface
): 'graph' | 'tree' => (mode === 'view' ? viewSurface : 'graph');

const getContentSectionClassName = (mode: StudioMode): string =>
  classNames(
