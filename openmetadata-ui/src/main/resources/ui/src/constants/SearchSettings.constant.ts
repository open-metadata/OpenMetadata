...
export const ENTITY_PATH_TO_SEARCH_INDEX: Record<string, SearchIndex> = {
  ...
  apiCollection: SearchIndex.API_COLLECTION,
  apiEndpoint: SearchIndex.API_ENDPOINT,
  dataProduct: SearchIndex.DATA_PRODUCT,
  metric: SearchIndex.METRIC,
  ...
  directory: SearchIndex.DIRECTORY,
  file: SearchIndex.FILE,
  spreadsheet: SearchIndex.SPREADSHEET,
  worksheet: SearchIndex.WORKSHEET,
