...
const OIDC_CALLBACK_URL = 'OIDC Callback URL';
const E_G_HTTPS_ACCOUNTS_GOOGLE_COM = 'e.g. https://accounts.google.com';
const ENABLE_SELF_SIGNUP = 'Enable Self Signup';
const AUTO_GENERATED_CALLBACK_URL_COPY_THIS_AND =
...
export const COMMON_UI_FIELDS = {
  ...
  authority: {
    'ui:title': 'Authority',
    'ui:placeholder': E_G_HTTPS_ACCOUNTS_GOOGLE_COM,
  },
  callbackUrl: {
...
export const LDAP_UI_SCHEMA = {
  ...
  enableSelfSignup: { 'ui:title': ENABLE_SELF_SIGNUP },
...
export const OIDC_UI_SCHEMA = {
  oidcConfiguration: {
    ...
    callbackUrl: {
      'ui:title': OIDC_CALLBACK_URL,
      'ui:readonly': true,
      'ui:help': AUTO_GENERATED_CALLBACK_URL_COPY_THIS_AND,
    },
