...
export const API_COLLECTION_API_ENDPOINTS: APIEndpoint[] = [
  {
    ...
    apiCollection: {
      ...
      displayName: 'store',
      deleted: false,
      href: 'https://sandbox-beta.open-metadata.org/api/v1/apiCollections/a5580b17-739b-4f86-b72a-96eb5c59de6f',
    },
    ...
    service: {
      ...
      displayName: 'pet_api_service',
      deleted: false,
      href: 'https://sandbox-beta.open-metadata.org/api/v1/services/apiServices/c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8',
    },
    serviceType: APIServiceType.REST,
    deleted: false,
