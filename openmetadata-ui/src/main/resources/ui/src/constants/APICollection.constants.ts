...
const STORE_COLLECTION_ID = 'a5580b17-739b-4f86-b72a-96eb5c59de6f';
const PET_API_SERVICE_ID = 'c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8';
const STORE_COLLECTION_FQN = 'pet_api_service.store';
const STORE_COLLECTION_DESCRIPTION = 'Access to Petstore orders';
const INGESTION_BOT = 'ingestion-bot';
const STORE_COLLECTION_HREF =
  'https://sandbox-beta.open-metadata.org/api/v1/apiCollections/a5580b17-739b-4f86-b72a-96eb5c59de6f';
const PET_API_SERVICE_HREF =
  'https://sandbox-beta.open-metadata.org/api/v1/services/apiServices/c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8';

export const API_COLLECTION_DUMMY_DATA: APICollection = {
  id: STORE_COLLECTION_ID,
  name: 'store',
  displayName: 'Store',
  fullyQualifiedName: STORE_COLLECTION_FQN,
  description: STORE_COLLECTION_DESCRIPTION,
  version: 0.1,
...
export const API_COLLECTION_API_ENDPOINTS: APIEndpoint[] = [
  {
    ...
    apiCollection: {
      ...
      displayName: 'store',
      deleted: false,
      href: STORE_COLLECTION_HREF,
    },
    href: 'https://sandbox-beta.open-metadata.org/api/v1/apiEndpoints/eb95db42-9b0d-46e0-945d-dc6a4e115692',
    owners: [],
    service: {
      id: PET_API_SERVICE_ID,
      type: 'apiService',
  ...
  },
  {
    ...
    href: 'https://sandbox-beta.open-metadata.org/api/v1/apiEndpoints/24f70b58-d285-4f5e-881e-8d27076a3050',
    owners: [],
    service: {
      id: PET_API_SERVICE_ID,
      type: 'apiService',
  ...
  },
  {
    ...
    href: 'https://sandbox-beta.open-metadata.org/api/v1/apiEndpoints/80cebee6-c433-4aca-be10-00835607f434',
    owners: [],
    service: {
      id: PET_API_SERVICE_ID,
      type: 'apiService',
