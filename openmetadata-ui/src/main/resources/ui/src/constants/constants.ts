...
export const ROUTES = {
  ...
  SETTINGS: `/settings`,
  CONTEXT_CENTER_PAGE: '/context-center',
  CONTEXT_CENTER: '/context-center',
  CONTEXT_PAGE: `/context-center/${PLACEHOLDER_ROUTE_FQN}`,
  CONTEXT_PAGE_WITH_TAB: `/context-center/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  CONTEXT_PAGE_WITH_SUB_TAB: `/context-center/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_SUB_TAB}`,
  CONTEXT_PAGE_VERSION: `/context-center/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
