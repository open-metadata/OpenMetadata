...
export const PLACEHOLDER_ROUTE_COLUMN_PART = ':columnPart';
...
export const ROUTES = {
  ...
  ENTITY_DETAILS_WITH_COLUMN: `/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_COLUMN_PART}`,
  ENTITY_DETAILS_WITH_COLUMN_TAB: `/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_COLUMN_PART}/${PLACEHOLDER_ROUTE_TAB}`,
