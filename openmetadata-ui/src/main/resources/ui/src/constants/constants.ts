...
export const ROUTES_RELATIVE = {
  ADD_GLOSSARY: '/add',
  GLOSSARY_DETAILS: `/${PLACEHOLDER_ROUTE_FQN}`,
  GLOSSARY_DETAILS_WITH_ACTION: `/${PLACEHOLDER_ROUTE_FQN}/action/${PLACEHOLDER_ACTION}`,
  ADD_GLOSSARY_TERMS: `/${PLACEHOLDER_ROUTE_FQN}/add-term`,
  GLOSSARY_DETAILS_WITH_TAB: `/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  GLOSSARY_DETAILS_WITH_SUBTAB: `/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_SUB_TAB}`,
  GLOSSARY_VERSION: `/${PLACEHOLDER_ROUTE_ID}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  GLOSSARY_TERMS_VERSION: `/${PLACEHOLDER_ROUTE_ID}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  GLOSSARY_TERMS_VERSION_TAB: `/${PLACEHOLDER_ROUTE_ID}/versions/${PLACEHOLDER_ROUTE_VERSION}/${PLACEHOLDER_ROUTE_TAB}`,
  DOMAIN_DETAILS: `/${PLACEHOLDER_ROUTE_FQN}`,
  DOMAIN_DETAILS_WITH_TAB: `/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  DOMAIN_VERSION: `/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  ADD_DOMAIN: '/add',
  ADD_ROLE: '/access/roles/add-role',
  ADD_POLICY: '/access/policies/add-policy',
  ADD_POLICY_RULE: `/access/policies/${PLACEHOLDER_ROUTE_FQN}/add-rule`,
  EDIT_POLICY_RULE: `/access/policies/${PLACEHOLDER_ROUTE_FQN}/edit-rule/${PLACEHOLDER_RULE_NAME}`,
  SETTINGS_EDIT_CUSTOM_LOGIN_CONFIG: `/OpenMetadata/loginConfiguration/edit-custom-login-configuration`,
  NOTIFICATION_ALERTS: `/${GlobalSettingsMenuCategory.NOTIFICATIONS}`,
  NOTIFICATION_ALERT_DETAILS: `/${GlobalSettingsMenuCategory.NOTIFICATIONS}/alert/${PLACEHOLDER_ROUTE_FQN}`,
  EDIT_NOTIFICATION_ALERTS: `/${GlobalSettingsMenuCategory.NOTIFICATIONS}/${GlobalSettingOptions.EDIT_NOTIFICATION}/${PLACEHOLDER_ROUTE_FQN}`,
  SETTINGS_WITH_CATEGORY: `/${PLACEHOLDER_SETTING_CATEGORY}`,
  SETTINGS_WITH_CATEGORY_FQN: `/${PLACEHOLDER_SETTING_CATEGORY}/${PLACEHOLDER_ROUTE_FQN}`,
  SETTINGS_WITH_TAB: `/${PLACEHOLDER_SETTING_CATEGORY}/${PLACEHOLDER_ROUTE_TAB}`,
  SETTINGS_WITH_TAB_FQN: `/${PLACEHOLDER_SETTING_CATEGORY}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_FQN}`,
  SETTINGS_WITH_TAB_FQN_ACTION: `/${PLACEHOLDER_SETTING_CATEGORY}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ACTION}`,
  SETTINGS_EDIT_EMAIL_CONFIG: `/OpenMetadata/email/edit-email-configuration`,

  ENTITY_DETAILS: `/${PLACEHOLDER_ROUTE_FQN}`,
  ENTITY_DETAILS_WITH_TAB: `/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  ENTITY_DETAILS_WITH_SUB_TAB: `/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_SUB_TAB}`,

  ENTITY_VERSION_DETAILS: `/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  ENTITY_VERSION_DETAILS_WITH_TAB: `/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}/${PLACEHOLDER_ROUTE_TAB}`,
};
