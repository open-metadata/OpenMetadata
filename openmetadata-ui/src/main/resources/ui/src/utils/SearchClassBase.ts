...
import IconAPIService from '../assets/svg/ic-api-service-default.svg?react';
...
import SearchIcon from '../assets/svg/ic-search.svg?react';
...
import IconTable from '../assets/svg/table-grey.svg?react';
