...
const DAE534B6_F5D1_4FC7_9DDF_0D1EC9DF5C7E =
  'dae534b6-f5d1-4fc7-9ddf-0d1ec9df5c7e';
const BUSINESS_DEPARTMENT = 'Business Department';
const BUSINESSES_OFTEN_HAVE_SEVERAL_DEPARTMENTS =
...
export const getGlossaryChildTermsForCustomization = () => [
  {
    ...
    glossary: {
      id: DAE534B6_F5D1_4FC7_9DDF_0D1EC9DF5C7E,
      type: 'glossary',
      name: BUSINESS_DEPARTMENT,
      fullyQualifiedName: BUSINESS_DEPARTMENT,
      description: BUSINESSES_OFTEN_HAVE_SEVERAL_DEPARTMENTS,
      displayName: BUSINESS_DEPARTMENT,
      deleted: false,
    },
    references: [],
    version: 0.9,
