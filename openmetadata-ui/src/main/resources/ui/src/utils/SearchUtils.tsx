...
import IconChart from '../assets/svg/chart.svg?react';
import IconDashboard from '../assets/svg/dashboard-grey.svg?react';
import IconApiCollection from '../assets/svg/ic-api-collection-default.svg?react';
import IconApiEndpoint from '../assets/svg/ic-api-endpoint-default.svg?react';
import DataProductIcon from '../assets/svg/ic-data-product.svg?react';
import IconDatabase from '../assets/svg/ic-database.svg?react';
import IconDatabaseSchema from '../assets/svg/ic-schema.svg?react';
import IconContainer from '../assets/svg/ic-storage.svg?react';
...
import IconMlModal from '../assets/svg/mlmodal.svg?react';
import IconPipeline from '../assets/svg/pipeline-grey.svg?react';
import IconTag from '../assets/svg/tag-grey.svg?react';
import IconTopic from '../assets/svg/topic-grey.svg?react';
