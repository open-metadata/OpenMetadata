...
export const getFieldThreadElement = (
  ...
  return !isEmpty(threadValue) ? (
    <Button
      className="link-text self-start w-8 h-7 m-r-xss d-flex items-center hover-cell-icon p-0"
    ...
    <Fragment>
      {entityType && entityFqn && entityField && flag && !isTaskType ? (
        <Button
          className="link-text self-start w-7 h-7 m-r-xss flex-none hover-cell-icon p-0"
