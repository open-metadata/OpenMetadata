...
const SERVICE_ROUTE_BY_CATEGORY_MAP: Partial<
  Record<ServiceCategory, GlobalSettingOptions>
> = {
...
export const getServiceRouteFromServiceType = (type: ServiceTypes) =>
  SERVICE_ROUTE_BY_CATEGORY_MAP[type as ServiceCategory] ??
...
const RESOURCE_ENTITY_BY_CATEGORY_MAP: Partial<Record<string, ResourceEntity>> =
  {
...
export const getResourceEntityFromServiceCategory = (
  ...
  RESOURCE_ENTITY_BY_CATEGORY_MAP[category] ?? ResourceEntity.DATABASE_SERVICE;
...
const SERVICE_CATEGORY_BY_ENTITY_TYPE_MAP: Partial<
...
export const getServiceCategoryFromEntityType = (
  ...
  SERVICE_CATEGORY_BY_ENTITY_TYPE_MAP[entityType] ??
  ServiceCategory.DATABASE_SERVICES;

const ENTITY_TYPE_BY_SERVICE_CATEGORY_MAP: Partial<
  Record<ServiceCategory, EntityType>
> = {
