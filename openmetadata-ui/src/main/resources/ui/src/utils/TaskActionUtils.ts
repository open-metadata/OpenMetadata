...
export const isDescriptionTaskType = (taskType: string) =>
  ['DescriptionUpdate'].includes(taskType);

export const isTagsTaskType = (taskType: string) =>
  ['TagUpdate'].includes(taskType);
