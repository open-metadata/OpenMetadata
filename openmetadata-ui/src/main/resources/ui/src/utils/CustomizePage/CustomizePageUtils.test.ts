...
describe('CustomizePageUtils', () => {
  ...
  describe('areLayoutsEqual', () => {
    it('should return true for identical layouts', () => {
      ...
      expect(areLayoutsEqual(layoutA, layoutB)).toBe(true);
    });
    ...
    it('should return false for different layouts', () => {
      ...
      expect(areLayoutsEqual(layoutA, layoutB)).toBe(false);
    });

    it('should return true for layouts with different order but same content', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return true for layouts with null/undefined values removed', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return true for layouts with nested children', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'parent1',
          x: 0,
    ...
    it('should return false for layouts with different nested children', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'parent1',
          x: 0,
    ...
    it('should return true for layouts with config objects', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return false for layouts with different config objects', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return true when both layouts are undefined', () => {
      expect(areLayoutsEqual(undefined, undefined)).toBe(true);
    });

    it('should return false when one layout is undefined and other is not', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
      ...
      expect(areLayoutsEqual(layoutA, undefined)).toBe(false);
      expect(areLayoutsEqual(undefined, layoutA)).toBe(false);
    });

    it('should return true for layouts with isDraggable property', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return false for layouts with different isDraggable properties', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return true for layouts with data objects', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return false for layouts with different data objects', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should handle complex nested structures with mixed properties', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'parent1',
          x: 0,
    ...
    it('should return false for layouts with different widget IDs', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return false for layouts with different dimensions', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return false for layouts with different positions', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
    ...
    it('should return false for layouts with different static properties', () => {
      const layoutA: WidgetConfig[] = [
        {
          i: 'widget1',
          x: 0,
