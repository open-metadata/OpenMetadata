...
describe('EntityPatchUtils', () => {
  describe('getEntityPatchAPI', () => {
    it('should return patch API for TABLE entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.TABLE);
    ...
    it('should return patch API for DASHBOARD entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.DASHBOARD);
    ...
    it('should return patch API for TOPIC entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.TOPIC);
    ...
    it('should return patch API for PIPELINE entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.PIPELINE);
    ...
    it('should return patch API for MLMODEL entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.MLMODEL);
    ...
    it('should return patch API for CHART entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.CHART);
    ...
    it('should return patch API for API_COLLECTION entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.API_COLLECTION);
    ...
    it('should return patch API for API_ENDPOINT entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.API_ENDPOINT);
    ...
    it('should return patch API for DATABASE entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.DATABASE);
    ...
    it('should return patch API for DATABASE_SCHEMA entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.DATABASE_SCHEMA);
    ...
    it('should return patch API for STORED_PROCEDURE entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.STORED_PROCEDURE);
    ...
    it('should return patch API for CONTAINER entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.CONTAINER);
    ...
    it('should return patch API for DASHBOARD_DATA_MODEL entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.DASHBOARD_DATA_MODEL);
    ...
    it('should return patch API for SEARCH_INDEX entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.SEARCH_INDEX);
    ...
    it('should return patch API for DATA_PRODUCT entity type', () => {
      const patchAPI = getEntityPatchAPI(EntityType.DATA_PRODUCT);
    ...
    it('should throw error when entity type is undefined', () => {
      expect(() => getEntityPatchAPI(undefined)).toThrow(
    ...
    it('should throw error for unsupported entity type', () => {
      ...
      expect(() => getEntityPatchAPI(unsupportedType)).toThrow(
        `No patch API available for entity type: ${unsupportedType}`
      );
    });

    it('should return same function reference for same entity type', () => {
      const api1 = getEntityPatchAPI(EntityType.TABLE);
      const api2 = getEntityPatchAPI(EntityType.TABLE);

      expect(api1).toBe(api2);
    });

    it('should return different functions for different entity types', () => {
      const tableAPI = getEntityPatchAPI(EntityType.TABLE);
      const dashboardAPI = getEntityPatchAPI(EntityType.DASHBOARD);
