...
class FileClassBase {
  defaultWidgetHeight: Record<FileWidgetKeys, number>;
  ...
  public getFileDetailPageTabs(
    fileDetailsPageProps: FileDetailPageTabProps
  ): TabProps[] {
    return getFileDetailsPageTabs(fileDetailsPageProps);
  }
  ...
  public getDummyData(): File {
    return FILE_DUMMY_DATA;
  }
  ...
  public getWidgetsFromKey(widgetConfig: WidgetConfig) {
    return getFileWidgetsFromKey(widgetConfig);
  }
...
const fileClassBase = new FileClassBase();

export default fileClassBase;
export { FileClassBase };
