...
import IconFormatAttachment from '../assets/svg/ic-format-attachment.svg?react';
import IconFormatAudio from '../assets/svg/ic-format-audio.svg?react';
import IconFormatImage from '../assets/svg/ic-format-image.svg?react';
import IconFormatVideo from '../assets/svg/ic-format-video.svg?react';
