...
export const LANDING_WIDGET_ENTITY_ICON_URL_MAP: Record<string, string> = {
  [EntityType.TABLE]: tableIconUrl,
  [EntityType.TABLE_COLUMN]: tableIconUrl,
  [EntityType.DASHBOARD]: dashboardIconUrl,
  [EntityType.CHART]: dashboardIconUrl,
...
export const LANDING_WIDGET_DEFAULT_ICON_URL = defaultServiceIconUrl;
