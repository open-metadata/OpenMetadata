...
export enum EntityFields {
  ...
  DATA_PRODUCT_TYPE = 'dataProductType.keyword',
  LIFECYCLE_STAGE = 'lifecycleStage.keyword',
  VISIBILITY = 'visibility.keyword',
  PORTFOLIO_PRIORITY = 'portfolioPriority.keyword',
