 ...
 */
/**
 * Trigger is the mechanism that creates a DAG Run from a DAG. It declares when a DAG will
 * be executed and its environment.
 */
...
export interface ExecutionConfiguration {
    /**
     * The Runtime Configuration to use when runnning a DAG with Spark Jobs
     */
    runtimeConfig: string;
    /**
     * What type of run either staging or production
     */
    runType: string;
    [property: string]: any;
}
