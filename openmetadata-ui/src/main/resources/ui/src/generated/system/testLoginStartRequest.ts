 ...
 */
/**
 * Admin-only request to start an interactive Test Login round-trip against a candidate
 * (unsaved) security configuration. Starting a test never mutates the live authentication
 * system.
 */
export interface TestLoginStartRequest {
    /**
     * Candidate (unsaved) security configuration to test against.
     */
