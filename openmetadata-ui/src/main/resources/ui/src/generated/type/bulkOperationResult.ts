...
export interface Response {
    /**
     * True when a dryRun preview detected a side effect on this request (e.g., a domain
     * move or broken data product relationship). UI clients can use this flag to decide
