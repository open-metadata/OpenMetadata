 ...
 */
/**
 * LLM Service Entity for managing Large Language Model providers such as OpenAI, Anthropic,
...
export interface LlmService {
    ...
    deleted?: boolean;
    /**
     * Description of this LLM service instance
     */
    description?: string;
    /**
    ...
    displayName?: string;
    /**
     * Domains the LLM service belongs to
     */
    ...
    /**
     * Link to the resource corresponding to this LLM service
     */
    href?: string;
    /**
     * Unique identifier of this LLM service instance
     */
    id: string;
    /**
     * Change that led to this version of the entity
    ...
    /**
     * LLM Models registered with this service
     */
    models?: EntityReference[];
    /**
     * Name that identifies this LLM service
     */
    name: string;
    /**
    ...
    /**
     * References to pipelines deployed for this LLM service
     */
