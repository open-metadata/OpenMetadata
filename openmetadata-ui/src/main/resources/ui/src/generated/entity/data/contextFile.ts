...
export interface ContextFile {
    /**
     * Legacy reference to the current Asset entity storing the file blob. Prefer headContentId
     * for new flows.
     */
    assetId?: string;
    /**
    ...
    description?: string;
    /**
     * Display name (original filename or user-provided title).
     */
    displayName?: string;
    /**
    ...
    /**
     * Full text extracted from the file for search and AI context.
     */
    ...
    /**
     * Identifier of the current ContextFileContent snapshot for this file.
     */
    ...
    sourceId?: string;
    /**
     * How this file was added.
     */
    sourceType?: SourceType;
    /**
     * URL to view the file in the external source system.
     */
    sourceUrl?: string;
    /**
 ...
 * How this file was added.
 *
 * How this file was added to the drive.
 */
