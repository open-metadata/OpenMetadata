...
export interface Domain {
    /**
     * Aggregated data assets collection including assets from this domain and all its
     * sub-domains.
     */
    ...
    /**
     * Children domains or sub-domains.
     */
    ...
    /**
     * Parent domains. When 'null' or not set, indicates that this is the top level domain.
     */
