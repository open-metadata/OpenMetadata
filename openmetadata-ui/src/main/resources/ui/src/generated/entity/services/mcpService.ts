 ...
 */
/**
 * MCP (Model Context Protocol) Service for discovering and managing MCP servers. This
 * service connects to MCP server configurations, registries, or individual servers to
 * catalog tools, resources, and prompts for AI governance.
 */
export interface MCPService {
    ...
    displayName?: string;
    /**
     * Domains the MCP service belongs to
     */
    ...
    href?: string;
    /**
     * Unique identifier of this MCP service instance
     */
    id: string;
    /**
    ...
    /**
     * References to pipelines deployed for this MCP service to extract metadata
     */
    ...
    tags?: TagLabel[];
    /**
     * Result of the last test connection performed on this service
     */
