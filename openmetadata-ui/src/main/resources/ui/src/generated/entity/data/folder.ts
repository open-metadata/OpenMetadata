 ...
 */
/**
 * A directory container for organizing files in the Context Center Drive. Folders can nest
 * other folders. Access is determined by owners.
 */
export interface Folder {
    ...
    /**
     * Count of direct children (folders + files).
     */
    childrenCount?: number;
    /**
     * Optional color for the folder icon.
     */
    color?: string;
    /**
    ...
    /**
     * Followers of this folder.
     */
    followers?: EntityReference[];
    /**
     * Fully qualified name of the folder.
     */
    ...
    name: string;
    /**
     * Owners of this folder. User-owned = personal, Team-owned = team folder, Org-owned =
     * org-wide.
     */
