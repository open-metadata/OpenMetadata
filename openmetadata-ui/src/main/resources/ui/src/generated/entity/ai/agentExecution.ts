 ...
 */
/**
 * Agent Execution entity representing a single execution run of an AI agent. Tracks inputs,
 * outputs, data lineage, performance metrics, and errors for observability and governance.
 */
export interface AgentExecution {
    /**
     * AI Agent that was executed
     */
    agent: EntityReference;
    /**
     * ID of the AI Agent (for indexing)
     */
    agentId: string;
    /**
    ...
    /**
     * Data sources accessed during execution - KEY FOR LINEAGE
     */
