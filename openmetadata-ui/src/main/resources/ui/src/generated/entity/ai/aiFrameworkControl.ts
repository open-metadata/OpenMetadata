 ...
 */
/**
 * A single control within an AI Governance Framework (e.g. EU AI Act Article 10). Controls
 * drive per-asset compliance assessments.
 */
export interface AIFrameworkControl {
    category?:          ControlCategory;
    changeDescription?: ChangeDescription;
    /**
     * Stable short code for the control within its framework (e.g. 'art-10').
     */
    code?:        string;
    deleted?:     boolean;
    description?: string;
    /**
     * Human-readable label (e.g. 'Article 10 — Data and data governance').
     */
    displayName?: string;
    domains?:     EntityReference[];
    /**
     * What evidence assessors should attach to demonstrate this control is met.
     */
    ...
    lifeCycle?:                    LifeCycle;
    /**
     * Control name (typically the code, e.g. 'art-10').
     */
    name:        string;
