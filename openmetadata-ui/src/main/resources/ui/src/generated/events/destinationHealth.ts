 ...
 */
/**
 * The health of one destination.
 */
export interface DestinationHealth {
    /**
     * Ticks in a row in which this destination failed.
     */
    consecutiveFailedTicks?: number;
    /**
     * When the current run of failing ticks started. Absent while the destination is healthy.
     */
    failingSince?: number;
    /**
     * The status of the most recent tick that produced a target for this destination.
     */
