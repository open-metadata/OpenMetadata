 ...
 */
/**
 * Durable Draft produced by a selective ontology structural merge.
 */
export interface OntologyStructuralMergeResult {
    changeSet:              EntityReference;
    relationshipOperations: RelationshipOperation[];
