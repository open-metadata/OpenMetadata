...
export interface GlossaryTermRelationGraph {
    /**
     * Maximum number of edges requested for this slice.
     */
    edgeLimit: number;
    /**
    ...
    /**
     * Maximum number of nodes requested for this slice.
     */
    nodeLimit: number;
    /**
    ...
    /**
     * Whether additional authorized nodes or edges were omitted by the requested slice limits.
     */
    truncated: boolean;
    /**
     * Limit that bounded the returned graph slice.
     */
