...
export interface CreateFile {
    ...
    description?: string;
    /**
     * Link to the parent directory fully qualified name
     */
    directory?: string;
    /**
    ...
    mimeType?: string;
    /**
     * Name that identifies this file.
     */
    name: string;
    /**
     * Owners of this file
    ...
    path?: string;
    /**
     * Link to the drive service fully qualified name where this file is hosted in
     */
    service: string;
    /**
     * File size in bytes
