 ...
 */
/**
 * Typed standards-mapping proposals returned by the configured AI provider.
 */
export interface OntologyMappingSuggestionList {
    generatedAt: number;
    modelId:     string;
    suggestions: OntologyMappingSuggestion[];
}
