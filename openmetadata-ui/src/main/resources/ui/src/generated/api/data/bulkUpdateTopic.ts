 ...
 */
/**
 * Schema for bulk updating multiple topics with differential updates
 */
export interface BulkUpdateTopic {
    /**
     * If true, validate without persisting
     */
    dryRun?: boolean;
    /**
     * List of topic update requests
     */
    updates: TopicUpdate[];
}

/**
 * Partial topic update - only include fields that have changed
 */
export interface TopicUpdate {
    /**
     * Updated cleanup policies
     */
    ...
    extension?: any;
    /**
     * Fully qualified name of the topic to update
     */
    fqn: string;
    /**
    ...
    messageSchema?: Topic;
    /**
     * Updated minimum number of in-sync replicas
     */
    ...
    /**
     * Updated number of partitions
     */
    partitions?: number;
    /**
     * Updated replication factor
     */
    replicationFactor?: number;
    /**
     * Updated maximum size of a partition in bytes
     */
    retentionSize?: number;
    /**
     * Updated retention time in milliseconds
     */
