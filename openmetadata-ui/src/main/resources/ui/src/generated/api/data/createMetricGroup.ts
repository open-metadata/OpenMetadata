 ...
 */
/**
 * Create Metric Group entity request
 */
export interface CreateMetricGroup {
    ...
    displayName?: string;
    /**
     * Fully qualified names of the domains the Metric Group belongs to.
     */
    domains?: string[];
    /**
    ...
    extension?: any;
    /**
     * Fully qualified names of the metrics that belong to this group.
     */
    metrics?: string[];
    /**
     * Name that identifies this Metric Group.
     */
    name: string;
    /**
