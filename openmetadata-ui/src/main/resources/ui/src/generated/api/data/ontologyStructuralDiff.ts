 ...
 */
/**
 * Typed three-way structural comparison between a captured base, current source, and
 * application subset.
 */
export interface OntologyStructuralDiff {
    data:           TermDiff[];
...
export interface TermDiff {
    base:                 OntologyTermStructure;
    baseVersion:          number;
    conflictingFields:    Field[];
    currentSource:        OntologyTermStructure;
    currentSourceVersion: number;
    currentSubset:        OntologyTermStructure;
    sourceChangedFields:  Field[];
    sourceTerm:           EntityReference;
    state:                State;
    subsetChangedFields:  Field[];
    subsetTerm:           EntityReference;
