 ...
 */
/**
 * Result of materializing enabled RDF inference rules inside the triplestore.
 */
export interface InferenceMaterializationResult {
    completedAt:     number;
    failedRules:     number;
    processedRules:  InferenceRuleStatus[];
    startedAt:       number;
