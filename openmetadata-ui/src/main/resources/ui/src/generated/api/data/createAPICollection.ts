 ...
 */
export interface CreateAPICollection {
    /**
    ...
    dataProducts?: string[];
    /**
     * Description of the API Collection instance. What it has and how to use it.
     */
    description?: string;
    /**
    ...
    /**
     * Link to the API service fully qualified name where this API collection is hosted in
     */
    service: string;
    /**
