...
export interface CreateDashboardDataModel {
    ...
    dataProducts?: string[];
    /**
     * Description of the data model instance. What it has and how to use it.
     */
    description?: string;
    /**
    ...
    lifeCycle?: LifeCycle;
    /**
     * Name that identifies this data model.
     */
    name: string;
    /**
    ...
    project?: string;
    /**
     * Link to the data model service where this data model is hosted in.
     */
    service: string;
    /**
...
export enum DataModelType {
    ...
    RillMetricsView = "RillMetricsView",
    RillModel = "RillModel",
