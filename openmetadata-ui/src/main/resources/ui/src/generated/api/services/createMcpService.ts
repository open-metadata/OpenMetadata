...
export interface CreateMCPService {
    ...
    dataProducts?: string[];
    /**
     * Description of MCP service entity.
     */
    description?: string;
    /**
    ...
    displayName?: string;
    /**
     * Fully qualified names of the domains the MCP Service belongs to.
     */
    domains?: string[];
    /**
    ...
    /**
     * Name that identifies this entity instance uniquely
     */
    name: string;
    /**
 ...
 * Service type
 *
 * Type of MCP service - currently only Mcp is supported
 */
export enum MCPType {
    MCP = "Mcp",
}
