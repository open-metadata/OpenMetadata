 ...
 */
/**
 * Request an asynchronously-generated audit pack (JSON/PDF bundle) scoped to a framework,
 * domain, or single AI asset.
 */
export interface CreateAuditReport {
    ...
    format?:      ReportFormat;
    /**
     * Framework to scope the report to (omit for an estate-wide multi-framework pack)
     */
    framework?:       string;
    ...
    scope?:           ReportScope;
    /**
     * FQN of the domain or AI asset when scope is not Estate
     */
    scopeTarget?: string;
    tags?:        TagLabel[];
}
