 ...
 */
/**
 * Typed entries and detail context used to browse the Metric hierarchy.
 */
export interface MetricHierarchyItem {
    /**
     * Top-level Metric Group when kind is metricGroup.
     */
    group?: MetricGroup;
    kind:   Kind;
    /**
     * Standalone root Metric when kind is metric.
     */
    metric?: Metric;
}
...
/**
 * Kind of top-level hierarchy entry.
 */
export enum Kind {
    Metric = "metric",
