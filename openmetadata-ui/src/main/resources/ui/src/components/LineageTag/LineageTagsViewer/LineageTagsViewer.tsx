...
import LineageTagsV1 from '../LineageTagsV1/LineageTagsV1.component';
import './Lineagetags-viewer.less';
import {
  DisplayType,
  LineageTagsViewerProps,
} from './LineageTagsViewer.interface';

const LineageTagsViewer: FunctionComponent<LineageTagsViewerProps> = ({
  tags,
  sizeCap = LIST_SIZE,
...
export default LineageTagsViewer;
