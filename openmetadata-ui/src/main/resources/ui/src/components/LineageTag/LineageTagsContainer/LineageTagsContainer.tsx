...
import TagSelectForm from '../LineageTagsSelectForm/LineageTagsSelectForm.component';
import LineageTagsV1 from '../LineageTagsV1/LineageTagsV1.component';
import LineageTagsViewer from '../LineageTagsViewer/LineageTagsViewer';
import { LineageTagsContainerV2Props } from './LineageTagsContainer.interface';

const LineageTagsContainer = ({
  permission,
    ...
    () =>
      showAddTagButton ? (
        <Col className="m-t-xss" onClick={handleAddClick}>
          <LineageTagsV1 startWith={TAG_START_WITH.PLUS} tag={TAG_CONSTANT} />
        </Col>
      ) : null,
    [showAddTagButton]
  );
...
export default LineageTagsContainer;
