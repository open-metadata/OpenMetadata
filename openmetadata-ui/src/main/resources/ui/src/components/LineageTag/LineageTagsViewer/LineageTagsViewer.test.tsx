...
import LineageTagsViewer from './LineageTagsViewer';
import { DisplayType } from './LineageTagsViewer.interface';
...
jest.mock('../LineageTagsV1/LineageTagsV1.component', () => {
  return jest.fn().mockReturnValue(<p>TagsV1</p>);
});

describe('Test LineageTagsViewer Component', () => {
  it('Should render placeholder if tags is empty', () => {
    render(<LineageTagsViewer sizeCap={-1} tags={[]} />);
  ...
  it('Should render all tags', () => {
    render(<LineageTagsViewer sizeCap={-1} tags={tags} />);
  ...
  it('Should render tags as per sizeCap', () => {
    render(<LineageTagsViewer sizeCap={2} tags={tags} />);
    const allTags = screen.getAllByText('TagsV1');
  ...
  it('Should render tags on popover style', () => {
    render(<LineageTagsViewer tags={tags} />);
  ...
  it('Should render tags on read more style', () => {
    render(
      <LineageTagsViewer displayType={DisplayType.READ_MORE} tags={tags} />
    );
