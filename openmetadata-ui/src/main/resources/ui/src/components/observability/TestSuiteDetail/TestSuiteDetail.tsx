 ...
 * strip, core-components underline tab strip. All data + handlers come
 * from the shared useTestSuiteDetailsPage OSS hook.
 */
const TestSuiteDetail = () => {
  ...
  const breadcrumbItems = useMemo(
    () => [
      ...
      {
        label: getEntityName(testSuite),
        ariaLabel: getEntityName(testSuite),
      },
    ],
    [t, testSuite]
  );
