...
describe('DataAssetsHeader component', () => {
  ...
  describe('removed header buttons (moved to Asset Health / Data Access widgets)', () => {
    it('never renders the request data access button in the header', () => {
      render(<DataAssetsHeader {...mockProps} />);
    ...
    it('never renders the data-contract status button in the header', () => {
      render(<DataAssetsHeader {...mockProps} />);
