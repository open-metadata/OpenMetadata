...
export const GlossaryWidget: CommonWidgetComponent = ({ showTaskHandler }) => {
  const { data, type, permissions, entityRules, isVersionView } =
  ...
  const canEditGlossaryTerms =
    Boolean(permissions.EditGlossaryTerms || permissions.EditAll) &&
    !data.deleted;
  ...
  return (
    <>
      <TagsContainerV2
        ...
        permission={canEditGlossaryTerms && !isVersionView}
        selectedTags={tags}
