  ...
  return (
    <div
      ...
      <div className="tw:flex tw:min-w-0 tw:flex-1 tw:flex-col">
        <Typography className="tw:truncate" data-testid="document-name" size="text-sm" weight="medium">
          {file.name}
        </Typography>
        <div className="tw:flex tw:items-center tw:gap-1">
          <Typography className="tw:text-gray-500" data-testid="document-size" size="text-xs">
            {file.sizeLabel}
          </Typography>
          {file.updatedBy && (
            <>
              ...
              <Typography className="tw:text-gray-500" data-testid="document-updated-by" size="text-xs">
                {file.updatedBy}
              </Typography>
            </>
          )}
          {file.updatedAt && (
            <>
              ...
              <Typography className="tw:text-gray-500" data-testid="document-updated-at" size="text-xs">
