...
import IconCloseCircleOutlined from '../../assets/svg/close-circle-outlined.svg?react';
import DropDownIcon from '../../assets/svg/drop-down.svg?react';
import IconSuggestionsActive from '../../assets/svg/ic-suggestions-active.svg?react';
