...
import { TABLE_HEADERS_V1 } from './EntityTableV1.constants';
import './EntityTableV1.style.less';
              ...
              {checkIfJoinsAvailable(record?.name) && (
                <div
                  ...
                  <span>
                    ...
                    {getFrequentlyJoinedWithColumns(record?.name).length >
                      3 && (
                      <PopOver
                        html={
            ...
            <Fragment>
              {isReadOnly ? (
                ...
                <span>
                  ...
                  <span className="tw-ml-2">{record.name}</span>
                </span>
              )}
            </Fragment>
          );
