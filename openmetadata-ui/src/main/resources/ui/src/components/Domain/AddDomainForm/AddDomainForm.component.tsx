...
// Extension field pickers keep wrapped select items in form state, while the API
// expects raw values. Shape-based unwrapping keeps drawer submit paths working
// even when custom property definitions are not available.
