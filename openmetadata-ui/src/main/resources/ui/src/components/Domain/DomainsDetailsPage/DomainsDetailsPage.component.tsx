...
import { ReactComponent as DomainIcon } from '../../../assets/svg/layers-icon-large.svg';
...
import '../domain.less';
import { DomainDetailsPageProps } from '../DomainDetailsPage/DomainDetailsPage.interface';
import { DomainFormType } from '../DomainPage.interface';
import { DataProductsTabRef } from '../DomainTabs/DataProductsTab/DataProductsTab.interface';
import './DomainsDetailsPage.less';
...
const DomainsDetailsPage = ({
  ...
  useEffect(() => {
    ...
    window.history.pushState = function (data, title, url) {
      if (typeof url === 'string' && url.startsWith('/domain/')) {
        const pluralUrl = url.replace('/domain/', '/domains/');

        return originalPushState.call(this, data, title, pluralUrl);
      }
  ...
  // ActionButtons for EntityHeaderV2
  const ActionButtons = (
...
export default DomainsDetailsPage;
