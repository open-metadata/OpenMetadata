...
const NO_RESULTS_KEY = '__connections_filter_button_no_results__';

export interface ConnectionsFilterButtonOption {
  value: string;
  label: string;
...
interface ConnectionsFilterButtonBaseProps {
  /**
   ...
   */
  label?: string;
  options: ConnectionsFilterButtonOption[];
...
interface SingleConnectionsFilterButtonProps
  extends ConnectionsFilterButtonBaseProps {
  multiple?: false;
  value: string;
  onChange: (value: string) => void;
}

interface MultiConnectionsFilterButtonProps
  extends ConnectionsFilterButtonBaseProps {
  multiple: true;
 ...
 */
export type ConnectionsFilterButtonProps =
  | SingleConnectionsFilterButtonProps
  | MultiConnectionsFilterButtonProps;

/**
 * Filter dropdown for the Connections page: trigger button showing the active selection, with a
 * popover list whose selected item is indicated by a light-brand background, blue label text, and
 * a checkmark.
 *
  ...
  return (
    ...
    <Dropdown.Root
      ...
      <Dropdown.Popover
        ...
        <Dropdown.Menu
          // The base Dropdown moved scroll to consumers, so without this a long list runs off
...
export default ConnectionsFilterButton;
