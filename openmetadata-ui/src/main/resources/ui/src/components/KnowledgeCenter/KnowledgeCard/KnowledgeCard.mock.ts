...
const LESS_THAN_TWO_MONTHS_HAVE_PASSED_SINCE_OUR_EXCITIN =
...
export const KNOWLEDGE_PAGE_MOCK_DATA = {
  ...
  description: LESS_THAN_TWO_MONTHS_HAVE_PASSED_SINCE_OUR_EXCITIN,
  version: 1.2,
    ...
    fieldsUpdated: [
      {
        ...
        newValue: LESS_THAN_TWO_MONTHS_HAVE_PASSED_SINCE_OUR_EXCITIN,
      },
    ],
    fieldsDeleted: [],
    previousVersion: 1.1,
