...
import {
  MUITableColumnDropdownList,
  MUITableProps,
} from './MUITable.interface';
...
const MUITable = (
  ...
  const handleMoveItem = useCallback(
    (updatedList: MUITableColumnDropdownList[]) => {
  ...
  const handleColumnItemSelect = useCallback(
    ...
    [columnVisibilityModel, selectedEntityTableColumns, entityKey]
  );
                  ...
                  <Menu
                    ...
                    <Box>
                      {dropdownColumnList.map(
                        (item: MUITableColumnDropdownList, index: number) => (
