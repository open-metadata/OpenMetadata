...
describe('MUITable component', () => {
  ...
  it('should display loader if loading is true', async () => {
  ...
  describe('Column Selection Functionality', () => {
    ...
    it('should enable resizable columns when resizableColumns prop is true', () => {
      renderComponent({
    ...
    it('should render custom pagination when customPaginationProps are provided', () => {
      ...
      renderComponent({
        customPaginationProps: mockPaginationProps,
      });
