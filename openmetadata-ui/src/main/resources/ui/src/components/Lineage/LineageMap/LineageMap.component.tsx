  ...
  return (
    <div
      ...
      <ReactFlow
        ...
        // Off under Playwright. Virtualisation means a node outside the
        // viewport is absent from the DOM rather than merely off-screen, so
        // "is this node in the graph" becomes a question about where the
        // camera happens to be pointing — assertions fail on a correct graph,
        // and no amount of waiting fixes it because nothing re-renders. Tests
        // that care about the viewport should use toBeInViewport.
