...
import {
  ...
  CheckCircle as CheckCircleOutlineOutlined,
  CheckCircle as TaskAltOutlined,
  File03 as DescriptionOutlinedIcon,
  Trash01 as DeleteOutlineOutlined,
