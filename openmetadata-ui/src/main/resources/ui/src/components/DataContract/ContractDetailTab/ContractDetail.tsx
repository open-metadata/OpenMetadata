...
import { ChevronDown, Download02, Flag04, PlayCircle, Plus, Trash01, Upload01 } from '@untitledui/icons';
          ...
          <div className='tw:w-full'>
                ...
                {(contract as ContractWithInheritance & { inherited?: boolean })
                  .inherited && (
                    <Tooltip
                      ...
                      <TooltipTrigger>
                        <ButtonUtility color="tertiary" icon={<InheritIcon
            ...
            <Box align="center" className="tw:w-full" gap={2} wrap="wrap">
              {contract.createdBy && (
                <>
                  <Box align='center' gap={2}>
                    ...
                    <OwnerLabel
                      owners={[{ name: contract.createdBy, type: 'user', id: '' }]}
                    />
                  </Box>
              ...
              <Box align='center' gap={2}>
                ...
                <Badge color='purple' size='sm' type='pill-color'>{String(contract.version)}</Badge>
              </Box>
              ...
              <Box align='center' gap={2}>
                ...
                <BadgeWithIcon color='success' iconLeading={Flag04} size='sm' type='pill-color'>{contract.entityStatus ?? t('label.approved')}</BadgeWithIcon>
              </Box>
              ...
              <Box align='center' data-testid="contract-owner-card"
                gap={2}>
                <Typography
                  data-testid="contract-status-label">
