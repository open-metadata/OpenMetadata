...
import { ChartSummaryProps } from './ChartSummary.interface';
...
const ChartSummary = ({
  ...
  const entityInfo = useMemo(
    () => getEntityOverview(ExplorePageTabs.CHART, entityDetails),
    [entityDetails]
  );
        ...
        <Row className="m-md" gutter={[0, 8]}>
          <Col span={24}>
            <Typography.Text
              ...
              data-testid="data-product-header">
