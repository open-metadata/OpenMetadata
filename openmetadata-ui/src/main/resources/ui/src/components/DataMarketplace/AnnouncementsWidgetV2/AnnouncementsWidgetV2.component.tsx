...
const AnnouncementsWidgetV2 = ({ isEditView }: WidgetCommonProps) => {
  ...
  if (loading) {
    return (
      <div
        className="tw:rounded-xl tw:border tw:border-utility-blue-dark-100 tw:bg-utility-blue-dark-50 tw:px-1 tw:pt-3 tw:pb-1"
  ...
  return (
    <div
      className="tw:rounded-xl tw:border tw:border-utility-blue-dark-100 tw:bg-utility-blue-dark-50 tw:px-1 tw:pt-3 tw:pb-1 tw:mb-5"
      data-testid="announcements-widget-v2">
