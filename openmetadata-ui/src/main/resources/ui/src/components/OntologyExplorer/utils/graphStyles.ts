...
export function getEdgeRelationLabelStyle(
  ...
  return {
    ...
    labelBackgroundStroke: meta
      ? 'none'
      : getColor(EDGE_LABEL_BG_STROKE, '#FFF'),
...
export function buildDefaultRectNodeStyle(
  ...
  return {
    ...
    stroke: getColor(NODE_BORDER_COLOR, '#D5D9EB'),
...
export function buildDataModeAssetNodeStyle(
  ...
  if (!entityTypeText) {
    ...
    return {
      ...
      labelBackgroundStroke: getColor(NODE_BORDER_COLOR, '#D5D9EB'),
  ...
  const cardShellBadge = {
    ...
    backgroundStroke: getColor(NODE_BORDER_COLOR, '#D5D9EB'),
