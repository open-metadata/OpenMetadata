...
export default [
  ...
  // Playwright tests
  {
    ...
    rules: {
      ...
      // Cleared to zero in playwright/ too (real Playwright types, structural
      // response types, as-unknown-as casts), so it inherits the repo-wide
      // `error` instead of being downgraded here.
