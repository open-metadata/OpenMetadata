...
## Requirements
<!-- to be updated -->
You can find further information on the OpenMetadata connector in the <a href="https://docs.open-metadata.org/connectors/metadata/openmetadata" target="_blank">docs</a>.
