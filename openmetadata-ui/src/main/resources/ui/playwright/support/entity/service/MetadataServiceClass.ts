...
export class MetadataServiceClass extends EntityClass {
  entity = {
    name: `pw-metadata-service-${uuid()}`,
    serviceType: 'Atlas',
    connection: {
      config: {
        type: 'Atlas',
  ...
  constructor(name?: string) {
    super(EntityTypeEndpoint.MetadataService);
    this.entity.name = name ?? this.entity.name;
    this.type = 'Metadata Service';
  }
