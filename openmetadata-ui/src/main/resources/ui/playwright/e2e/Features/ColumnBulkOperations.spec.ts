...
test.describe('Column Bulk Operations - Filters & Search', () => {
  test.beforeEach(async ({ page }) => {
    await visitColumnBulkOperationsPage(page);
  });
  ...
  test('should search columns with server-side API call', async ({ page }) => {
...
test.describe('Column Bulk Operations - Selection & Edit Drawer', () => {
  ...
  test('should cancel selection and disable edit button', async ({ page }) => {
