...
test.describe('Profiler ingestion form — profile sample config', () => {
  ...
  test(
    'STATIC config sends profileSample and no DYNAMIC-only keys',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
  ...
  test(
    'STATIC config sends all three static-only fields when set',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
  ...
  test(
    'DYNAMIC with smart sampling ON sends only DYNAMIC keys',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
  ...
  test(
    'DYNAMIC with smart sampling OFF and thresholds sends thresholds array',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
  ...
  test(
    'DYNAMIC threshold remove drops only the selected row',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
  ...
  test(
    'switching DYNAMIC → STATIC does not leak smartSampling or thresholds',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
  ...
  test(
    'switching STATIC → DYNAMIC does not leak static-only fields',
    {
      tag: '@ingestion',
    },
    async ({ page }) => {
