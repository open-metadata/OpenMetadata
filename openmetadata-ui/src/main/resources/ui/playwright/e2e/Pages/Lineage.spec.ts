...
test.describe.serial('Test pagination in column level lineage', () => {
  ...
  test.beforeAll(async ({ browser }) => {
    ...
    await test.step('Add edges between T1-P1 and T2-P1', async () => {
      ...
      const table1PaginationNext = table1Node.locator(
        '[data-testid="next-btn"]'
      );
      const table2PaginationNext = table2Node.locator(
        '[data-testid="next-btn"]'
      );
      const table1PaginationPrev = table1Node.locator(
        '[data-testid="prev-btn"]'
      );
      const table2PaginationPrev = table2Node.locator(
        '[data-testid="prev-btn"]'
      );
