...
test.describe('Glossary tests', () => {
  ...
  test('Glossary & terms creation for reviewer as user', async ({
    ...
    await test.step('Create Glossary', async () => {
      await page.goto(ROUTES.GLOSSARY, { waitUntil: 'commit' });
    ...
    await test.step('Approve Glossary Term from Glossary Listing for reviewer user', async () => {
      ...
      await page1.goto(ROUTES.GLOSSARY, { waitUntil: 'commit' });
  ...
  test('Verify Glossary Deny Permission', async ({ browser }) => {
    ...
    try {
      ...
      await dataConsumerPage.goto(ROUTES.GLOSSARY, { waitUntil: 'commit' });
  ...
  test('Term should stay approved when changes made by reviewer', async ({
    ...
    try {
      ...
      await test.step('Perform Changes by reviewer', async () => {
        ...
        await reviewerPage.goto(ROUTES.GLOSSARY, { waitUntil: 'commit' });
