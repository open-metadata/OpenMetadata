...
> **7 Components** | **355 Tests** | **367 Scenarios**

| Component | Files | Tests | Total Scenarios | Skipped |
|-----------|-------|-------|-----------------|---------|
| [Search](./Discovery.md#search) | 5 | 136 | 136 | 0 |
| [Data Assets](./Discovery.md#data-assets) | 12 | 101 | 105 | 0 |
...
> **4 Components** | **39 Tests** | **114 Scenarios**

| Component | Files | Tests | Total Scenarios | Skipped |
|-----------|-------|-------|-----------------|---------|
| [Data Quality](./Observability.md#data-quality) | 7 | 13 | 34 | 0 |
