...
export const LogOut: FC<Props> = ({
  ...
  color = 'currentColor',
  ...props
}) => <svg fill="none" viewBox="0 0 20 20" width={size} height={size} stroke={color} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path stroke="currentColor" strokeWidth={1.3} d="M11.687 10H3.266m4.23 5.053c.04.92.156 1.507.502 1.959q.203.264.467.466c.68.522 1.668.522 3.643.522s2.963 0 3.643-.522q.264-.202.466-.466c.522-.68.522-1.668.522-3.644V6.632c0-1.976 0-2.963-.522-3.644a2.5 2.5 0 0 0-.466-.466C15.071 2 14.083 2 12.108 2s-2.963 0-3.643.522a2.5 2.5 0 0 0-.467.466c-.346.452-.463 1.039-.502 1.96" /><path stroke="currentColor" strokeWidth={1.3} d="M9.582 12.946s2.947-2.171 2.947-2.948-2.947-2.947-2.947-2.947" /></svg>;
