...
export const Follow: FC<Props> = ({
  ...
  color = 'currentColor',
  ...props
}) => <svg fill="none" viewBox="0 0 20 20" width={size} height={size} stroke={color} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path stroke="currentColor" strokeWidth={1.3} d="m11.382 3.155 1.408 2.84c.192.394.704.774 1.136.846l2.551.428c1.632.274 2.016 1.467.84 2.645l-1.983 2c-.336.339-.52.992-.416 1.46l.568 2.476c.448 1.96-.584 2.718-2.304 1.694l-2.392-1.428c-.432-.258-1.144-.258-1.584 0l-2.391 1.428c-1.712 1.024-2.752.258-2.304-1.694l.568-2.476c.104-.468-.08-1.121-.416-1.46l-1.984-2c-1.168-1.178-.792-2.371.84-2.645l2.552-.428c.424-.072.936-.452 1.128-.847l1.407-2.839c.768-1.54 2.016-1.54 2.776 0" /></svg>;
