...
export const All: FC<Props> = ({
  ...
  color = 'currentColor',
  ...props
}) => <svg fill="none" viewBox="0 0 20 20" width={size} height={size} stroke={color} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path stroke="currentColor" strokeWidth={1.3} d="M9.11 4.664H18M9.11 10H18m-8.89 5.332H18M2 5.903s.889.58 1.333 1.429c0 0 1.334-3.334 3.112-4.445M2 15.68s.889.58 1.333 1.429c0 0 1.334-3.334 3.112-4.445" /></svg>;
All.displayName = "All";