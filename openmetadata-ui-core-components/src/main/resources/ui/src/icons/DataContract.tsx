...
export const DataContract: FC<Props> = ({
  ...
  color = 'currentColor',
  ...props
}) => <svg fill="none" viewBox="0 0 20 20" width={size} height={size} stroke={color} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path stroke="currentColor" strokeWidth={1.3} d="M10.002 18h-4.89a2.22 2.22 0 0 1-2.221-2.222V4.222A2.22 2.22 0 0 1 5.113 2H8.89a2 2 0 0 1 2 2v.474a2 2 0 0 0 2 2h3.458m-3.68 7.792 1.511 1.511 2.933-2.933" /></svg>;
