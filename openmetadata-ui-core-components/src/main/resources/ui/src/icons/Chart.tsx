...
export const Chart: FC<Props> = ({
  ...
  color = 'currentColor',
  ...props
}) => <svg fill="none" viewBox="0 0 20 20" width={size} height={size} stroke={color} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path stroke="currentColor" strokeWidth={1.3} d="M2 2v15a1 1 0 0 0 1 1h15" /><path stroke="currentColor" strokeWidth={1.3} d="m5 14.118 2.106-2.633a1 1 0 0 1 1.372-.181l1.102.808a1 1 0 0 0 1.265-.068l5.143-4.689" /></svg>;
