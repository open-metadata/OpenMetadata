...
/**
 * Metric tag — fully rounded pill with tinted background and border, matching
 * GlossaryTag. Default icon: Chart. Color defaults to DEFAULT_TAG_COLOR. Tint
 * colors (border/background/text/close-icon) are computed in CSS via color-mix()
 * off the --tag-color custom property — see styles/globals.css.
 */
export const MetricTag: FC<EntityTagProps> = ({
  label,
  color,
  icon,
  size = 'sm',
