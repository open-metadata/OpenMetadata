...
export const MdFileIcon = ({ width = 40, height = 40, ...props }: SVGProps<SVGSVGElement>) => (
  <svg fill="none" height={height} viewBox="0 0 40 40" width={width} xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
