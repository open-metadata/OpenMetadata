                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Thank you for joining <strong>Openmetadata</strong>, and welcome on an exciting journey to next level of Data Collaboration.</span><br/><br/><span
                                            ...
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Contact our support team if you have any questions or concerns.&nbsp;<a
                                                    ...
                                                    href="https://slack.open-metadata.org" target="_blank" rel="noopener">Ask us any
                                                question</a></p>
                                            <p class="tw-signoff"
