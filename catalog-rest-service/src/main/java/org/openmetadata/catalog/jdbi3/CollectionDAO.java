    ...
    @ConnectionAwareSqlQuery(
        value =
            "SELECT (SELECT COUNT(*) FROM table_entity) as tableCount, "
                ...
                + "(SELECT COUNT(*) FROM user_entity WHERE JSON_EXTRACT(json, '$.isBot') is false or JSON_EXTRACT(json, '$.isBot') is NULL) as userCount, "
    ...
    @ConnectionAwareSqlQuery(
        value =
            "SELECT (SELECT COUNT(*) FROM table_entity) as tableCount, "
                ...
                + "(SELECT COUNT(*) FROM pipeline_service_entity)+ "
                + "(SELECT COUNT(*) FROM mlmodel_service_entity)) as servicesCount, "
                + "(SELECT COUNT(*) FROM user_entity WHERE json#>'{isBot}' is false or json#>'{isBot}' is NULL) as userCount, "
                + "(SELECT COUNT(*) FROM team_entity) as teamCount",
        connectionType = POSTGRES)
