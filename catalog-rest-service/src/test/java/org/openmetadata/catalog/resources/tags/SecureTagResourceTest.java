...
public class SecureTagResourceTest extends SecureCatalogApplicationTest {
  public static final Logger LOG = LoggerFactory.getLogger(SecureTagResourceTest.class);
  ...
  public void get_category_200() throws HttpResponseException {
    ...
    TagCategory category = getCategory("User", TestUtils.authHeaders("test@getcollate.com"));
  ...
  public void get_validTag_200() throws HttpResponseException {
    ...
    Tag tag = getTag("User.Address", TestUtils.authHeaders("test@getcollate.com"));
    String parentURI = BASE_URL + "/User";
    validateHRef(parentURI, tag);
  }

  @Test
  public void post_validTagCategory_201_as_admin(TestInfo test) throws HttpResponseException {
    ...
    TagCategory newCategory = createAndCheckCategory(create, TestUtils.adminAuthHeaders());
  ...
  public void post_validTags_200() throws HttpResponseException, JsonProcessingException {
    ...
    TagCategory category = getCategory("User", TestUtils.authHeaders("test@getcollate.io"));
    CreateTag create = new CreateTag().withName("PrimaryTag").withDescription("description");
    createPrimaryTag(category.getName(), create, TestUtils.adminAuthHeaders());
    TagCategory returnedCategory = getCategory("User", TestUtils.authHeaders("test@getcollate.io"));
    ...
    createSecondaryTag(category.getName(), "PrimaryTag", create, TestUtils.adminAuthHeaders());
  }
  ...
  public void post_invalidTags_400() {
    ...
    HttpResponseException exception = assertThrows(HttpResponseException.class, () ->
            createPrimaryTag("User", create, TestUtils.adminAuthHeaders()));
    ...
    exception = assertThrows(HttpResponseException.class, () -> createSecondaryTag("User",
            "Address", create, TestUtils.adminAuthHeaders()));
    TestUtils.assertResponseContains(exception, BAD_REQUEST, "description must not be null");
    ...
    exception = assertThrows(HttpResponseException.class, () ->
            createSecondaryTag("User", "Address", create, TestUtils.adminAuthHeaders()));
    TestUtils.assertResponseContains(exception, BAD_REQUEST, "name size must be between 2 and 25");
  }
  ...
  public void put_tagCategory_200(TestInfo test) throws HttpResponseException {
    ...
    CreateTagCategory create = new CreateTagCategory().withName(newCategoryName).withDescription("updatedDescription")
            .withCategoryType(TagCategoryType.Descriptive);
    updateCategory("User", create, TestUtils.adminAuthHeaders());

    // Revert tag category back
    create.withName("User").withCategoryType(TagCategoryType.Classification);
    updateCategory(newCategoryName, create, TestUtils.adminAuthHeaders());
  }
  ...
  public void put_primaryTag_200() throws HttpResponseException, JsonProcessingException {
    ...
    updatePrimaryTag("User", "Address", create, TestUtils.adminAuthHeaders());

    // Revert back to old tag name user.address from user.addressUpdated
    create.withName("Address");
    updatePrimaryTag("User", "AddressUpdated", create, TestUtils.adminAuthHeaders());
  }
  ...
  public void put_secondaryTag_200() throws HttpResponseException, JsonProcessingException {
    ...
    updateSecondaryTag("User", "PrimaryTag", "SecondaryTag", create, TestUtils.adminAuthHeaders());

    // Revert back to old tag name user.primaryTag.secondaryTag from user.primaryTag.secondaryTag1
    create.withName("SecondaryTag");
    updateSecondaryTag("User", "PrimaryTag", "SecondaryTag1", create, TestUtils.adminAuthHeaders());
  }
  ...
  private TagCategory createAndCheckCategory(CreateTagCategory create,
    ...
    validate(getCategory(create.getName(), authHeaders), create.getCategoryType(),
            create.getName(), create.getDescription());
    return returnedCategory;
  }

  private void createPrimaryTag(String category, CreateTag create,
                                Map<String, String> authHeaders) throws HttpResponseException,
  ...
  private void updateCategory(String category, CreateTagCategory update,
    ...
    validate(getCategory(update.getName(), authHeaders),
            update.getCategoryType(), update.getName(), update.getDescription());
  }
  ...
  public static CategoryList listCategories() throws HttpResponseException {
    WebTarget target = getResource("tags");
    return TestUtils.get(target, CategoryList.class, TestUtils.authHeaders("test@getcollate.com"));
  }
  ...
  public static TagCategory getCategory(String category, String fields, Map<String, String> authHeaders) throws HttpResponseException {
    WebTarget target = getResource("tags/" + category);
