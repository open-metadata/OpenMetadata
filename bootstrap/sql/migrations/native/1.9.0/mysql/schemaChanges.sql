...
CREATE TABLE IF NOT EXISTS directory_entity (
    ...
    deleted TINYINT(1) GENERATED ALWAYS AS (json_extract(json, '$.deleted')) VIRTUAL,
    PRIMARY KEY (id),
    UNIQUE KEY directory_entity_name_hash (nameHash),
...
CREATE TABLE IF NOT EXISTS file_entity (
    ...
    deleted TINYINT(1) GENERATED ALWAYS AS (json_extract(json, '$.deleted')) VIRTUAL,
    PRIMARY KEY (id),
    UNIQUE KEY file_entity_name_hash (nameHash),
...
CREATE TABLE IF NOT EXISTS spreadsheet_entity (
    ...
    deleted TINYINT(1) GENERATED ALWAYS AS (json_extract(json, '$.deleted')) VIRTUAL,
    PRIMARY KEY (id),
    UNIQUE KEY spreadsheet_entity_name_hash (nameHash),
...
CREATE TABLE IF NOT EXISTS worksheet_entity (
    ...
    deleted TINYINT(1) GENERATED ALWAYS AS (json_extract(json, '$.deleted')) VIRTUAL,
    PRIMARY KEY (id),
    UNIQUE KEY worksheet_entity_name_hash (nameHash),
