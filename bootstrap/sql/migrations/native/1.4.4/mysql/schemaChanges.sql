...
ADD COLUMN taskAssigneesIds VARCHAR(1000) GENERATED ALWAYS AS (JSON_EXTRACT(taskAssignees, '$[*].id'));
ALTER TABLE thread_entity ADD INDEX taskAssigneesIds_index (taskAssigneesIds(500));
