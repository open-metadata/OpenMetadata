...
ADD COLUMN updatedAt TIMESTAMP WITH TIME ZONE GENERATED ALWAYS AS (to_tz_timestamp(json ->> 'updatedAt')) STORED NOT NULL,
ADD COLUMN updatedBy VARCHAR(256) GENERATED ALWAYS AS (json ->> 'updatedBy') STORED NOT NULL;
