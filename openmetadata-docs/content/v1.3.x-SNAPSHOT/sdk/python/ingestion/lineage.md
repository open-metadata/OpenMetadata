...
{% image src="/images/v1.3/sdk/python/ingestion/lineage/simple-lineage.png" alt="simple-lineage" /%}
...
{% image src="/images/v1.3/sdk/python/ingestion/lineage/lineage-col.png" alt="lineage-col" /%}
