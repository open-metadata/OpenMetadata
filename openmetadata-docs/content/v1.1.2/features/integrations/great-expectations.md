...
{% image
src={"/images/v1.1.2/features/integrations/ge-checkpoint-file.gif"}
...
{% image
src="/images/v1.1.2/features/integrations/ge-config-yaml.gif"
...
{% image
src="/images/v1.1.2/features/integrations/ge-run-checkpoint.gif"
