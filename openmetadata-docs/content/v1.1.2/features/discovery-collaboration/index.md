...
{% image src="/images/v1.1.2/features/discovery-collaboration/search-top-bar.png" alt="search-top-bar" /%}
...
{% image src="/images/v1.1.2/features/discovery-collaboration/command-k-search.png" alt="command-k-search" /%}
...
{% image src="/images/v1.1.2/features/discovery-collaboration/add-conversation.png" alt="add-conversation" /%}

{% image src="/images/v1.1.2/features/discovery-collaboration/conversation.png" alt="conversation" /%}

Users can also reply or react with emojis for any Conversation by hovering over the conversation.

{% image src="/images/v1.1.2/features/discovery-collaboration/conversation-reply.png" alt="conversation-reply" /%}
...
{% image src="/images/v1.1.2/features/discovery-collaboration/activity-feed.png" alt="activity-feed" /%}
...
{% image src="/images/v1.1.2/features/discovery-collaboration/create-announcement.png" alt="create-announcement" /%}

{% image src="/images/v1.1.2/features/discovery-collaboration/announcement-banner.png" alt="announcement-banner" /%}
...
{% image src="/images/v1.1.2/features/discovery-collaboration/announcement-reply.png" alt="announcement-reply" /%}
