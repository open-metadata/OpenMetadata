...
{% partial file="/v1.1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/domo-pipeline/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.1.2/connectors/domopipeline/select-service.png",
    addNewServicePath: "/images/v1.1.2/connectors/domopipeline/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.2/connectors/domopipeline/service-connection.png",
} 
/%}
