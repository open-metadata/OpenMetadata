...
{% partial file="/v1.1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/superset/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Superset", 
    selectServicePath: "/images/v1.1.2/connectors/superset/select-service.png",
    addNewServicePath: "/images/v1.1.2/connectors/superset/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.2/connectors/superset/service-connection.png",
} 
/%}
