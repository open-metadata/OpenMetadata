...
{% partial file="/v1.1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/qliksense/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "QlikSense", 
    selectServicePath: "/images/v1.1.2/connectors/qliksense/select-service.png",
    addNewServicePath: "/images/v1.1.2/connectors/qliksense/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.2/connectors/qliksense/service-connection.png",
} 
/%}
