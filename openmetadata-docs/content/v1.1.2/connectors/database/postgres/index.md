...
{% partial file="/v1.1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/postgres/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Postgres", 
    selectServicePath: "/images/v1.1.2/connectors/postgres/select-service.png",
    addNewServicePath: "/images/v1.1.2/connectors/postgres/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.2/connectors/postgres/service-connection.png",
} 
/%}
