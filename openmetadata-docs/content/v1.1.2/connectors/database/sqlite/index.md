...
{% partial file="/v1.1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/sqlite/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "SQLite", 
    selectServicePath: "/images/v1.1.2/connectors/sqlite/select-service.png",
    addNewServicePath: "/images/v1.1.2/connectors/sqlite/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.2/connectors/sqlite/service-connection.png",
} 
/%}
