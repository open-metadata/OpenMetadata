...
{% partial file="/v1.1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/vertica/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Vertica", 
    selectServicePath: "/images/v1.1.2/connectors/vertica/select-service.png",
    addNewServicePath: "/images/v1.1.2/connectors/vertica/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.2/connectors/vertica/service-connection.png",
} 
/%}
