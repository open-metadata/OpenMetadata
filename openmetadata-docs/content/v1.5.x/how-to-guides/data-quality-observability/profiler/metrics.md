...
{% image
  src="/images/v1.5/features/ingestion/workflows/profiler/custom-metric1.png"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/profiler/custom-metric2.png"
  alt="Input SQL query"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/profiler/custom-metric3.png"
  alt="Run Ingestion"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/profiler/custom-metric4.png"
