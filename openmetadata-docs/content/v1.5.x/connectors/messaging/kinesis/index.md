...
{% partial file="/v1.5/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/kinesis/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    addNewServicePath: "/images/v1.5/connectors/kinesis/add-new-service.png",
