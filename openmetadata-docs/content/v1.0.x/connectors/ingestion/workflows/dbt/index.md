...
{% image
  src="/images/v1.0/features/ingestion/workflows/dbt/dbt-features/dbt-lineage.png"
  alt="dbt-lineage"
  caption="dbt Lineage"
 /%}
...
{% image
  src="/images/v1.0/features/ingestion/workflows/dbt/dbt-features/dbt-tags.png"
  alt="dbt-tags"
  caption="dbt Tags"
 /%}
...
{% image
  src="/images/v1.0/features/ingestion/workflows/dbt/dbt-features/dbt-owner.png"
  alt="dbt-owner"
  caption="dbt Owner"
 /%}
...
{% image
  src="/images/v1.0/features/ingestion/workflows/dbt/dbt-features/dbt-descriptions.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/dbt/dbt-features/dbt-tests.png"
  alt="dbt-tests"
  caption="dbt Tests"
 /%}
