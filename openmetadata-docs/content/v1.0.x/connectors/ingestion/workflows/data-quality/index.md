...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/profiler-tab-view.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/test-suite-page.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/test-case-page.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/ingestion-page.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/test-suite-landing.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/test-suite-results.png"
...
{% image
  src="/images/v1.0/features/ingestion/workflows/data-quality/colum-level-test-results.png"
  alt="Test suite results table"
  caption="Test suite results table"
 /%}
