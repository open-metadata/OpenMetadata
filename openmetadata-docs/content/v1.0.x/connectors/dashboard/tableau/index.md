...
{% image
  src="/images/v1.0/connectors/tableau/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0/connectors/tableau/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0/connectors/tableau/service-connection-non-default-site.png"
  alt="Configure service connection"
  caption="Configure the service connection for a non-default site by filling the form" /%}

{% image
  src="/images/v1.0/connectors/tableau/service-connection-basic-auth.png"
...
{% image
  src="/images/v1.0/connectors/tableau/service-connection-access-token-auth.png"
