...
4. Once the restoration process is completed follow the steps defined in [this document](/deployment/upgrade) to upgrade your instance to the newer version depending on your deployment mode.