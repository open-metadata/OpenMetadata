...
{% image
src="/images/v1.3/connectors/bigtable/create-role-1.png"
...
{% image
src="/images/v1.3/connectors/bigtable/create-role-2.png"
...
{% image
src="/images/v1.3/connectors/bigtable/create-role-3.png"
alt="Create Role"
caption="Create Role" /%}
...
{% image
src="/images/v1.3/connectors/bigtable/create-role-4.png"
alt="Add Permissions"
...
{% image
src="/images/v1.3/connectors/bigtable/create-role-5.png"
alt="Add Permissions"
caption="Add Permissions" /%}
