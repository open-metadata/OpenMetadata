...
<Image src="/images/deployment/security/okta/create-oidc-app-integration.webp" alt="create-oidc-app-integration"/>

- Click on **Applications -> Applications** in the left navigation panel.
<Image src="/images/deployment/security/okta/click-applications.webp" alt="click-applications"/>

- Click on the **Create App Integration** button.
<Image src="/images/deployment/security/okta/create-app-integration.webp" alt="create-app-integration"/>
...
<Image src="/images/deployment/security/okta/configuring-the-app.webp" alt="configuring-the-app"/>
...
- Click **Save**.
<Image src="/images/deployment/security/okta/general-settings-click-save.webp" alt="general-settings-click-save"/>

- The app is now configured.
<Image src="/images/deployment/security/okta/app-is-configured.webp" alt="app-is-configured"/>
...
<Image src="/images/deployment/security/okta/click-security-api.webp" alt="click-security-api"/>

- From the **Authorization Servers** tab, click on **Add Authorization Server** button.
<Image src="/images/deployment/security/okta/click-add-authorization-server.webp" alt="click-add-authorization-server"/>
...
- **Save** the changes.
<Image src="/images/deployment/security/okta/add-auth-server-save-changes.webp" alt="add-auth-server-save-changes"/>
...
<Image src="/images/deployment/security/okta/click-auth-server-from-prev-step.webp" alt="click-auth-server-from-prev-step"/>

The Issuer URL shows up as Dynamic by default. Change the Issuer URL to Okta URL and save the changes.
<Image src="/images/deployment/security/okta/change-issuer-url.webp" alt="change-issuer-url"/>
...
<Image src="/images/deployment/security/okta/click-req-auth-server.webp" alt="click-req-auth-server"/>

- In the resulting page, click on the **Scopes** tab
- Click on **Add Scope**
<Image src="/images/deployment/security/okta/add-scope.webp" alt="add-scope"/>

- Set as a **Default Scope**.
<Image src="/images/deployment/security/okta/set-default-scope.webp" alt="set-default-scope"/>
...
<Image src="/images/deployment/security/okta/add-new-access-policy.webp" alt="add-new-access-policy"/>

- To create a policy, add a Name and Description.
- Assign the policy to the required clients.
<Image src="/images/deployment/security/okta/assign-policy.webp" alt=""/>
...
<Image src="/images/deployment/security/okta/add-rule.webp" alt="add-rule"/>
...
<Image src="/images/deployment/security/okta/see-your-application.webp" alt="see-your-application"/>
...
<Image src="/images/deployment/security/okta/deselect-user-consent.webp" alt="deselect-user-consent"/>
...
<Image src="/images/deployment/security/okta/click-edit-token.webp" alt="click-edit-token"/>
...
<Image src="/images/deployment/security/okta/generate-keys.webp" alt="generate-keys"/>
...
<Image src="/images/deployment/security/okta/see-key-ids.webp" alt="see-key-ids"/>
<Image src="/images/deployment/security/okta/enter-key-ids-from-issuer.webp" alt="enter-key-ids-from-issuer"/>
...
<Image src="/images/deployment/security/okta/get-keys.webp" alt="get-keys"/>
...
<Image src="/images/deployment/security/okta/view-service-account.webp" alt="view-service-account"/>
...
<Image src="/images/deployment/security/okta/select-the-service-app.webp" alt="select-the-service-app"/>
...
- Grant the scopes by clicking on **Grant**. Ensure that the following scopes are granted:
  ...
  * okta.users.manage
  * okta.clients.read
<Image src="/images/deployment/security/okta/ensure-scopes-are-granted.webp" alt="ensure-scopes-are-granted"/>
