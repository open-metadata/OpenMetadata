...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-1.webp" alt="create-account" caption="Search for Cognito"/>
...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-2.webp" alt="create-account" caption="Setup User Pool"/>
...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-3.webp" alt="create-account" caption="Configure Sign up Experience"/>
...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-4.webp" alt="create-account" caption="Integrate your App"/>
...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-5.webp" alt="create-account" caption="Configure the App Client"/>
...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-6.webp" alt="create-account" caption="User Pool ID"/>
...
<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-7.webp" alt="create-account"/>

<Image src="/images/deployment/security/amazon-cognito-sso/create-server-credentials-8.webp" alt="create-account" caption="Client ID"/>
