...
| global.authorizer.className | string | `org.openmetadata.apis.security.NoopAuthorizer` |
| global.authorizer.containerRequestFilter | string | `org.openmetadata.apis.security.NoopFilter` |
