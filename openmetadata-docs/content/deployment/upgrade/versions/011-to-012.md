...
- The field to enter the `run_results.json` file path is an optional field in case of local and http DBT configs. The test results will ingested from this file if it is provided.
