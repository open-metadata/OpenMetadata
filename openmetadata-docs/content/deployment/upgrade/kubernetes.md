...
[main] ERROR org.openmetadata.apis.elasticsearch.ElasticSearchIndexDefinition - Failed to update Elastic Search indexes due to
org.elasticsearch.ElasticsearchStatusException: Elasticsearch exception [type=illegal_argument_exception, reason=can't merge a non object mapping [owner] with an object mapping]
    ...
    at org.openmetadata.apis.elasticsearch.ElasticSearchIndexDefinition.updateIndex(ElasticSearchIndexDefinition.java:139)
    at org.openmetadata.apis.elasticsearch.ElasticSearchIndexDefinition.updateIndexes(ElasticSearchIndexDefinition.java:91)
    at org.openmetadata.apis.util.TablesInitializer.execute(TablesInitializer.java:227)
    at org.openmetadata.apis.util.TablesInitializer.main(TablesInitializer.java:149)
