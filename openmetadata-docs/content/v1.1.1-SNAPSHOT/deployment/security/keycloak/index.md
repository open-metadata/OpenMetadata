...
{% image src="/images/v1.1.1/deployment/security/keycloak/1-login-page.png" alt="login-page" /%}
...
{% image src="/images/v1.1.1/deployment/security/keycloak/5-edit-settings-url.png" alt="edit-settings-url.png" /%}
