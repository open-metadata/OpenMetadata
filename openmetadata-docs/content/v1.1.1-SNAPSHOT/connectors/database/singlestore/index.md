...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/singlestore/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.1.1/connectors/singlestore/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors/singlestore/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/singlestore/service-connection.png",
} 
/%}
