...
{% partial file="/v1.4/connectors/yaml/query-usage.md" variables={connector: "mssql"} /%}

{% partial file="/v1.4/connectors/yaml/lineage.md" variables={connector: "mssql"} /%}

{% partial file="/v1.4/connectors/yaml/data-profiler.md" variables={connector: "mssql"} /%}
