...
{% partial file="/v1.4/connectors/yaml/query-usage.md" variables={connector: "athena"} /%}

{% partial file="/v1.4/connectors/yaml/lineage.md" variables={connector: "athena"} /%}

{% partial file="/v1.4/connectors/yaml/data-profiler.md" variables={connector: "athena"} /%}
