...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/glue-pipeline/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.10/connectors/gluepipeline/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/gluepipeline/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/gluepipeline/service-connection.png",
} 
/%}
