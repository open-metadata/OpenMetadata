...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/storage/adls/yaml"} /%}
...
{% image
  src="/images/v1.10/connectors/adls/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.10/connectors/adls/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.10/connectors/adls/service-connection.png"
