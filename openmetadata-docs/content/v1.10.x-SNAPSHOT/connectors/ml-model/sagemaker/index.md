...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/ml-model/sagemaker/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "SageMaker", 
    selectServicePath: "/images/v1.10/connectors/sagemaker/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/sagemaker/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/sagemaker/service-connection.png",
} 
/%}
