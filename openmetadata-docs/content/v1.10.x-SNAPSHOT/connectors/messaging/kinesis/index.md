...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/kinesis/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Kinesis", 
    selectServicePath: "/images/v1.10/connectors/kinesis/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/kinesis/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/kinesis/service-connection.png",
} 
/%}
