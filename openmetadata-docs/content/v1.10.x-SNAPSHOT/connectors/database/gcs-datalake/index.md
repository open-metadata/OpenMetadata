...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/gcs-datalake/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Datalake", 
    selectServicePath: "/images/v1.10/connectors/datalake/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/datalake/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/datalake/service-connection.png",
} 
/%}
