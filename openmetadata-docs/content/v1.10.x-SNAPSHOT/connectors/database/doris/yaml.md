...
{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "doris"} /%}

{% partial file="/v1.10/connectors/yaml/auto-classification.md" variables={connector: "doris"} /%}
