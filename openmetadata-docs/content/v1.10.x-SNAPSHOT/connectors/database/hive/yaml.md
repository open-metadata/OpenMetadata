...
{% partial file="/v1.10/connectors/yaml/lineage.md" variables={connector: "hive"} /%}

{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "hive"} /%}

{% partial file="/v1.10/connectors/yaml/auto-classification.md" variables={connector: "hive"} /%}
