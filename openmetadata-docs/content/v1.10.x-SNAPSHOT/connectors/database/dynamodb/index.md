...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/dynamodb/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "DynamoDB", 
    selectServicePath: "/images/v1.10/connectors/dynamodb/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/dynamodb/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/dynamodb/service-connection.png",
} 
/%}
