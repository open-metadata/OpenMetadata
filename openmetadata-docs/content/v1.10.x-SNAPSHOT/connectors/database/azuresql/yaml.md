...
{% partial file="/v1.10/connectors/yaml/lineage.md" variables={connector: "azuresql"} /%}

{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "azuresql"} /%}

{% partial file="/v1.10/connectors/yaml/auto-classification.md" variables={connector: "azuresql"} /%}
