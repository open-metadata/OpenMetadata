...
{% image
  src="/images/v1.10/features/ingestion/workflows/data-quality/test-suite-home-page.png"
...
{% image
  src="/images/v1.10/features/ingestion/workflows/data-quality/test-suite-results.png"
...
{% image
  src="/images/v1.10/features/ingestion/workflows/data-quality/table-results-entity.png"
