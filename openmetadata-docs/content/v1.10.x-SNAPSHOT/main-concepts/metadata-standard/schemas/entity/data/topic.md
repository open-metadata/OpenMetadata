...
- **`owners`**: Owners of this topic. Refer to *../../type/entityReferenceList.json*.
...
- **`domains`**: Domains the Topic belongs to. When not set, the Topic inherits the domain from the messaging service it belongs to. Refer to *../../type/entityReferenceList.json*.
