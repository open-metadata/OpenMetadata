...
{% image src="/images/v1.0/deployment/security/azure/create-app-1.png" alt="create-app" /%} 

- Click on `New Registration`. This step is for registering the OpenMetadata UI.

{% image src="/images/v1.0/deployment/security/azure/create-app-2.png" alt="create-app" /%}

- Provide an Application Name for registration.
- Provide a redirect URL as a `Single Page Application`.
- Click on `Register`.

{% image src="/images/v1.0/deployment/security/azure/create-app-3.png" alt="create-app" /%}

### Step 3: Where to Find the Credentials

- The `Client ID` and the `Tenant ID` are displayed in the Overview section of the registered application.

{% image src="/images/v1.0/deployment/security/azure/where-to-find-credentials.png" alt="create-app" /%}
...
{% image src="/images/v1.0/deployment/security/azure/access-tokens.png" alt="access-tokens" /%}

### Step 2: Expose an API

- Navigate to the section `Expose an API`.

{% image src="/images/v1.0/deployment/security/azure/expose-api-1.png" alt="expose-api" /%}

- Set the `App ID URI`. If it has not been set, the default value is `api://<client_id>`.
- Click Save.

{% image src="/images/v1.0/deployment/security/azure/expose-api-2.png" alt="expose-api" /%}
...
{% image src="/images/v1.0/deployment/security/azure/add-scope.png" alt="add-scope" /%}
...
{% image src="/images/v1.0/deployment/security/azure/register-another-app.png" alt="add-app" /%}
...
{% image src="/images/v1.0/deployment/security/azure/api-permissions-1.png" alt="api-permissions" /%}

- Click on Add a Permission.

{% image src="/images/v1.0/deployment/security/azure/api-permissions-2.png" alt="api-permissions" /%}

- Select the custom scope created in Step 3.
- Click on Add Permissions.

{% image src="/images/v1.0/deployment/security/azure/api-permissions-3.png" alt="api-permissions" /%}
...
{% image src="/images/v1.0/deployment/security/azure/admin-consent.png" alt="admin-consent" /%}
...
{% image src="/images/v1.0/deployment/security/azure/set-app-id-1.png" alt="app-id" /%}

- Click on Save to set the App ID URI which is required for scopes while connecting from manual ingestion.

{% image src="/images/v1.0/deployment/security/azure/set-app-id-2.png" alt="app-id" /%}
...
{% image src="/images/v1.0/deployment/security/azure/client-secret-1.png" alt="client-secret" /%}

- Enter a description and an expiry period.

{% image src="/images/v1.0/deployment/security/azure/client-secret-2.png" alt="client-secret" /%}
...
{% image src="/images/v1.0/deployment/security/azure/azure-service-application-object-id.png" alt="object-id" /%}
...
{% image src="/images/v1.0/deployment/security/azure/update-ingestion-bot-service-application.png" /%}
