...
{% partial file="/v1.8/connectors/yaml/lineage.md" variables={connector: "mariadb"} /%}

{% partial file="/v1.8/connectors/yaml/data-profiler.md" variables={connector: "mariadb"} /%}

{% partial file="/v1.8/connectors/yaml/auto-classification.md" variables={connector: "mariadb"} /%}
