...
{% partial file="/v1.8/connectors/yaml/lineage.md" variables={connector: "db2"} /%}

{% partial file="/v1.8/connectors/yaml/data-profiler.md" variables={connector: "db2"} /%}

{% partial file="/v1.8/connectors/yaml/auto-classification.md" variables={connector: "db2"} /%}
