---
title: Spline Connector | OpenMetadataData Lineage Integration
description: Connect Spline data lineage to OpenMetadatawith our pipeline connector. Track data flow, automate metadata ingestion, and enhance governance seamlessly.
