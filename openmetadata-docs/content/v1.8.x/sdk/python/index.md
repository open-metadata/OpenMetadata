...
**Important:** The `create_or_update()` method uses PUT operations with server-side business rules that may prevent certain field overwrites for data integrity reasons. This is particularly relevant for glossary terms, where descriptions and other metadata fields are protected.
