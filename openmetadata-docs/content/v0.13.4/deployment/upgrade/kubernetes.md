...
You can get changes from artifact hub of [openmetadata helm chart](https://artifacthub.io/packages/helm/open-metadata/openmetadata) release. Click on Default Values >> Compare to Version.
 ...
 {% image src="/images/v0.13.4/deployment/upgrade/artifact-hub-compare-to-version.png" alt="Helm Chart Release Comparison" /%}
...
Go to Settings -> Elasticsearch
 {% image src="/images/v0.13.4/deployment/upgrade/elasticsearch-re-index.png" alt="create-project" caption="Create a New Project" /%}

Click on reindex all
in the dialog box choose Recreate Indexes to All
 {% image src="/images/v0.13.4/deployment/upgrade/reindex-ES.png" alt="create-project" caption="Reindex" /%}
