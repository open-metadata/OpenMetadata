...
```
 ...
 {% image src="/images/v0.13.4/deployment/security/enable-ssl/openmetadata-server/keystore-1.png" alt="keystore" /%}
...
OpenMetadata installation path under the `conf` directory.
 ...
 {% image src="/images/v0.13.4/deployment/security/enable-ssl/openmetadata-server/keystore-2.png" alt="keystore" /%}
...
[https://localhost:8585](https://localhost:8585). You'll get the following error page and there is no way to proceed.
 ...
 {% image src="/images/v0.13.4/deployment/security/enable-ssl/openmetadata-server/browser.png" alt="browser" /%}
...
Open the KeyChain app in OS X, drag and drop the `public.cert` file generated in the previous command into the Keychain:
 ...
 {% image src="/images/v0.13.4/deployment/security/enable-ssl/openmetadata-server/import-1.png" alt="import" /%}

Double-click on `localhost`:

 {% image src="/images/v0.13.4/deployment/security/enable-ssl/openmetadata-server/import-2.png" alt="import" /%}


Click on `Trust` to open and set `Always Trust`:

 {% image src="/images/v0.13.4/deployment/security/enable-ssl/openmetadata-server/import-3.png" alt="import" /%}
