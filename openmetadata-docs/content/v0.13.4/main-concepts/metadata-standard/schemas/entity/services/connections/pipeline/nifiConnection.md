...
- **`basicAuthentication`**: username/password auth. Cannot contain additional properties.
...
- **`clientCertificateAuthentication`**: client certificate auth. Cannot contain additional properties.
