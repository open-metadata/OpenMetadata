...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/total-data-assets.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/percentage-description.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/percentage-owner.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/data-assets-by-tier.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/most-viewed-assets.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/views-by-assets.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/daily-active-users.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/most-active-users.png"
    alt="Daily Active Users"
    caption="Daily Active Users"
 /%}
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/metadata-nav.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/data-insight-add-ingestion.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/data-insight-ingestion-name.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/data-insight-ingestion-es-config.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/data-insight-ingestion-schedule.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/data-insight-kpi.png"
...
{% image
    src="/images/v0.13.4/openmetadata/data-insight/configure-kpi.png"
