...
{% image
  src="/images/v0.13.4/overview/features/all-your-data-in-one-place.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/data-discovery-kw-search.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/data-discovery-association.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/data-discovery-advanced-search.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/activity-feeds.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/event-notification-slack.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/add-descriptive-metadata.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/complex-data-types.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/deleted-entity.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/importance-owners.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/filter-asset-by-importance.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/identify-asset-owner.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/rbac.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/data-lineage.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/manual-lineage.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/dbt-integration.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/data-profiler.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/ingestion-pipelines.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/metadata-versioning.gif"
/%}
...
{% image
  src="/images/v0.13.4/overview/features/elasticsearch.gif"
/%}
