...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/usage/table-entity-page.png"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/usage/add-ingestion.png"
  alt="add-ingestion"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/usage/configure-usage-ingestion.png"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/usage/scheule-and-deploy.png"
