...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/profiler/profiler-summary-table.png"
  alt="Table profile summary page"
  caption="Table profile summary page"
 /%}

{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/profiler/profiler-summary-colomn.png"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/profiler/add-profiler-workflow.png"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/profiler/configure-profiler-workflow.png"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/profiler/accessing-table-profile-settings.png"
...
{% image
  src="/images/v0.13.4/openmetadata/ingestion/workflows/profiler/table-profile-summary-view.png"
  alt="table profile settings"
  caption="table profile settings"
 /%}
