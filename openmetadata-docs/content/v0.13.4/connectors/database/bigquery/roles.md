...
{% image
src="/images/v0.13.4/openmetadata/connectors/bigquery/create-role-1.png"
...
{% image
src="/images/v0.13.4/openmetadata/connectors/bigquery/create-role-2.png"
...
{% image
src="/images/v0.13.4/openmetadata/connectors/bigquery/create-role-3.png"
alt="Create Role"
caption="Create Role" /%}
...
{% image
src="/images/v0.13.4/openmetadata/connectors/bigquery/create-role-4.png"
alt="Add Permissions"
...
{% image
src="/images/v0.13.4/openmetadata/connectors/bigquery/create-role-5.png"
alt="Add Permissions"
caption="Add Permissions" /%}
...
{% image
src="/images/v0.13.4/openmetadata/connectors/bigquery/create-role-6.png"
alt="Add Permissions"
caption="Add Permissions" /%}
