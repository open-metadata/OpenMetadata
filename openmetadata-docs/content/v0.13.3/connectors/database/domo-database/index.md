...
Select DomoDatabase as the service type and click Next.
...
{% image
  src="/images/v0.13.3/openmetadata/connectors/domodatabase/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v0.13.3/openmetadata/connectors/domodatabase/add-new-service.png"
  alt="Add New Service"
...
you've configured the connector to read from your domo-database service as
desired.
...
{% image
  src="/images/v0.13.3/openmetadata/connectors/domodatabase/service-connection.png"
