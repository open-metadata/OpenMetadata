...
The following diagram shows how is the process between the OM server and Airflow workflows:
 ...
 {% image src="/images/v0.13.3/deployment/secrets-manager/om-secrets-manager-disabled.png" alt="om-secrets-manager-disabled" /%}
...
the KMS will act as a mediator, as we can observe in the diagram below:
 ...
 {% image src="/images/v0.13.3/deployment/secrets-manager/om-secrets-manager-enabled.png" alt="om-secrets-manager-enabled" /%}
