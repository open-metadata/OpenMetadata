...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/profiler/profiler-summary-table.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/profiler/profiler-summary-colomn.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/profiler/add-profiler-workflow.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/profiler/configure-profiler-workflow.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/profiler/accessing-table-profile-settings.png"
  alt="table profile settings"
  caption="table profile settings"
 /%}

{% image
  src="/images/v1.1.1/features/ingestion/workflows/profiler/table-profile-summary-view.png"
  alt="table profile settings"
  caption="table profile settings"
 /%}
