...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/tableau/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Tableau", 
    selectServicePath: "/images/v1.1.1/connectors/tableau/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors/tableau/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/tableau/service-connection.png",
} 
/%}
