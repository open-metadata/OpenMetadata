...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/spline/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Spline", 
    selectServicePath: "/images/v1.1.1/connectors/spline/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors/spline/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/spline/service-connection.png",
} 
/%}
...
{% partial file="/v1.1.1/connectors/pipeline/configure-ingestion.md" /%}
