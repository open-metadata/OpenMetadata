...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/azuresql/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Azure SQL", 
    selectServicePath: "/images/v1.1.1/connectors/azuresql/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors/azuresql/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/azuresql/service-connection.png",
} 
/%}
