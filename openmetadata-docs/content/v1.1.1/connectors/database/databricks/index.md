...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/databricks/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.1.1/connectors/databricks/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors/databricks/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/databricks/service-connection.png",
} 
/%}
