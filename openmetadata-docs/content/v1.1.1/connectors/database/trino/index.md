...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/trino/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Trino", 
    selectServicePath: "/images/v1.1.1/connectors/trino/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors/trino/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/trino/service-connection.png",
} 
/%}
