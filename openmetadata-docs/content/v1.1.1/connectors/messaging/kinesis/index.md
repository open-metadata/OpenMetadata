...
{% partial file="/v1.1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/kinesis/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Kinesis", 
    selectServicePath: "/images/v1.1.1/connectors/kinesis/select-service.png",
    addNewServicePath: "/images/v1.1.1/connectors//add-new-service.png",
    serviceConnectionPath: "/images/v1.1.1/connectors/kinesis/service-connection.png",
} 
/%}
...
{% partial file="/v1.1.1/connectors/messaging/configure-ingestion.md" /%}
