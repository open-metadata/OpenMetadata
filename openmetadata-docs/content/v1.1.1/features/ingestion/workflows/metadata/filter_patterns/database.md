...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/database-filter-patterns.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-1.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-2.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-3.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-4.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/schema-filter-example-1.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/schema-filter-example-2.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/schema-filter-example-3.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/table-filter-example-1.png"
...
{% image
  src="/images/v1.1.1/features/ingestion/workflows/metadata/filter-patterns/table-filter-example-2.png"
