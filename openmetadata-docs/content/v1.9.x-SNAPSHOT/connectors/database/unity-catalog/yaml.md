...
{% partial file="/v1.9connectors/yaml/query-usage.md" variables={connector: "unitycatalog"} /%}

{% partial file="/v1.9connectors/yaml/lineage.md" variables={connector: "unitycatalog"} /%}
