...
{% partial file="/v1.9/connectors/yaml/lineage.md" variables={connector: "hive"} /%}

{% partial file="/v1.9/connectors/yaml/data-profiler.md" variables={connector: "hive"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.md" variables={connector: "hive"} /%}
