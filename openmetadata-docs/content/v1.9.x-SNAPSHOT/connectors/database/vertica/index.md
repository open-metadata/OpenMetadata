...
{% partial file="/v1.9connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/vertica/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Vertica", 
    selectServicePath: "/images/v1.9connectors/vertica/select-service.png",
    addNewServicePath: "/images/v1.9connectors/vertica/add-new-service.png",
    serviceConnectionPath: "/images/v1.9connectors/vertica/service-connection.png",
} 
/%}
