...
{% partial file="/v1.9connectors/yaml/lineage.md" variables={connector: "sapHana"} /%}

{% partial file="/v1.9connectors/yaml/data-profiler.md" variables={connector: "sapHana"} /%}

{% partial file="/v1.9connectors/yaml/auto-classification.md" variables={connector: "sapHana"} /%}
