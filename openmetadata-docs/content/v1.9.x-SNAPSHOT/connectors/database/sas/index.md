...
{% partial file="/v1.9connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/sas/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "SAS", 
    selectServicePath: "/images/v1.9connectors/sas/select-service.png",
    addNewServicePath: "/images/v1.9connectors/sas/add-new-service.png",
    serviceConnectionPath: "/images/v1.9connectors/sas/service-connection.png",
} 
/%}
