...
{% image
  src="/images/v1.2/deployment/ingestion/openmetadata/om-orchestration.png"
...
- If you have an existing Airflow instance, and you want to build and maintain your own ingestion DAGs ([example](/connectors/database/snowflake/airflow#2.-prepare-the-ingestion-dag)),
