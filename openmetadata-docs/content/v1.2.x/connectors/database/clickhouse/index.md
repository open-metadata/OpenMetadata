...
{% partial file="/v1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/clickhouse/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.2/connectors/clickhouse/select-service.png",
    addNewServicePath: "/images/v1.2/connectors/clickhouse/add-new-service.png",
    serviceConnectionPath: "/images/v1.2/connectors/clickhouse/service-connection.png",
} 
/%}
