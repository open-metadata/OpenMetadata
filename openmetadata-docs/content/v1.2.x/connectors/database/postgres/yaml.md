...
{% partial file="/v1.2/connectors/yaml/query-usage.md" variables={connector: "postgres"} /%}

{% partial file="/v1.2/connectors/yaml/data-profiler.md" variables={connector: "postgres"} /%}
