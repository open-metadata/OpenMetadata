...
{% partial file="/v1.2/connectors/yaml/query-usage.md" variables={connector: "mssql"} /%}

{% partial file="/v1.2/connectors/yaml/data-profiler.md" variables={connector: "mssql"} /%}
