...
{% partial file="/v1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/redshift/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Redshift", 
    selectServicePath: "/images/v1.2/connectors/redshift/select-service.png",
    addNewServicePath: "/images/v1.2/connectors/redshift/add-new-service.png",
    serviceConnectionPath: "/images/v1.2/connectors/redshift/service-connection.png",
} 
/%}
