...
{% partial file="/v1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/databricks-pipeline/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.2/connectors/databrickspipeline/select-service.png",
    addNewServicePath: "/images/v1.2/connectors/databrickspipeline/add-new-service.png",
    serviceConnectionPath: "/images/v1.2/connectors/databrickspipeline/service-connection.png",
} 
/%}
