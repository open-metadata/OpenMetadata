...
{% partial file="/v1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/spline/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Spline", 
    selectServicePath: "/images/v1.2/connectors/spline/select-service.png",
    addNewServicePath: "/images/v1.2/connectors/spline/add-new-service.png",
    serviceConnectionPath: "/images/v1.2/connectors/spline/service-connection.png",
} 
/%}
