...
- <a id="definitions/mariaDBType"></a>**`mariaDBType`** *(string)*: Service type. Must be one of: `["MariaDB"]`. Default: `"MariaDB"`.
- <a id="definitions/mariaDBScheme"></a>**`mariaDBScheme`** *(string)*: SQLAlchemy driver scheme options. Must be one of: `["mysql+pymysql"]`. Default: `"mysql+pymysql"`.
