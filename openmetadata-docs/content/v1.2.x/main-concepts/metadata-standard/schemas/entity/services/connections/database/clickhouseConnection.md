...
- <a id="definitions/clickhouseType"></a>**`clickhouseType`** *(string)*: Service type. Must be one of: `["Clickhouse"]`. Default: `"Clickhouse"`.
- <a id="definitions/clickhouseScheme"></a>**`clickhouseScheme`** *(string)*: SQLAlchemy driver scheme options. Must be one of: `["clickhouse+http", "clickhouse+native"]`. Default: `"clickhouse+http"`.
