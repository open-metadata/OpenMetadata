...
- <a id="definitions/greenplumType"></a>**`greenplumType`** *(string)*: Service type. Must be one of: `["Greenplum"]`. Default: `"Greenplum"`.
- <a id="definitions/greenplumScheme"></a>**`greenplumScheme`** *(string)*: SQLAlchemy driver scheme options. Must be one of: `["postgresql+psycopg2"]`. Default: `"postgresql+psycopg2"`.
