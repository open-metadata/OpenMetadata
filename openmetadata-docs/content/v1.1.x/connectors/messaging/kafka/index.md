...
{% partial file="/v1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/kafka/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Kafka", 
    selectServicePath: "/images/v1.1/connectors/kafka/select-service.png",
    addNewServicePath: "/images/v1.1/connectors/kafka/add-new-service.png",
    serviceConnectionPath: "/images/v1.1/connectors/kafka/service-connection.png",
} 
/%}
...
{% partial file="/v1.1/connectors/messaging/configure-ingestion.md" /%}
