...
{% partial file="/v1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/redpanda/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Redpanda", 
    selectServicePath: "/images/v1.1/connectors/redpanda/select-service.png",
    addNewServicePath: "/images/v1.1/connectors/redpanda/add-new-service.png",
    serviceConnectionPath: "/images/v1.1/connectors/redpanda/service-connection.png",
} 
/%}
