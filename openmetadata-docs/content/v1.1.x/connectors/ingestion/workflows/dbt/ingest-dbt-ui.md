...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/add-ingestion.png"
  alt="add-ingestion"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/aws-s3.png"
  alt="aws-s3-bucket"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/gcp-bucket-form.png"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/gcp-bucket-path.png"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/local-storage.png"
  alt="local-storage"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/file_server.png"
  alt="file-server"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/dbt-cloud.png"
  alt="dbt-cloud"
...
{% image
  src="/images/v1.1/features/ingestion/workflows/dbt/schedule-and-deploy.png"
