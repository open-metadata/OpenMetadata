...
{% partial file="/v1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/nifi/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Nifi", 
    selectServicePath: "/images/v1.1/connectors/nifi/select-service.png",
    addNewServicePath: "/images/v1.1/connectors/nifi/add-new-service.png",
    serviceConnectionPath: "/images/v1.1/connectors/nifi/service-connection.png",
} 
/%}
