...
{% partial file="/v1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/clickhouse/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.1/connectors/clickhouse/select-service.png",
    addNewServicePath: "/images/v1.1/connectors/clickhouse/add-new-service.png",
    serviceConnectionPath: "/images/v1.1/connectors/clickhouse/service-connection.png",
} 
/%}
...
- **Use HTTPS Protocol**: Enable this flag when the Clickhouse instance is hosted via HTTPS protocol. This flag is useful when you are using `clickhouse+http` connection scheme.
