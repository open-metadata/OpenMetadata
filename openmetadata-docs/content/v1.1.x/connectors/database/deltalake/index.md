...
{% partial file="/v1.1/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/deltalake/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Deltalake", 
    selectServicePath: "/images/v1.1/connectors/deltalake/select-service.png",
    addNewServicePath: "/images/v1.1/connectors/deltalake/add-new-service.png",
    serviceConnectionPath: "/images/v1.1/connectors/deltalake/service-connection.png",
} 
/%}
