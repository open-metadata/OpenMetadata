...
{% partial file="/v1.4/connectors/yaml/query-usage.md" variables={connector: "postgres"} /%}

{% partial file="/v1.4/connectors/yaml/lineage.md" variables={connector: "postgres"} /%}
