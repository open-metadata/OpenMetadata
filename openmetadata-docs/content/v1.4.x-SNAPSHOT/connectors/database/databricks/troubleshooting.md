...
{% image
src="/images/v1.4/connectors/databricks/select-sql-warehouse.png"
...
{% image
src="/images/v1.4/connectors/databricks/Open-sql-warehouse.png"
...
{% image
src="/images/v1.4/connectors/databricks/Connection-details.png"
...
{% image
src="/images/v1.4/connectors/databricks/Open-create-tocken-page.png"
...
{% image
src="/images/v1.4/connectors/databricks/Generate-token.png"
alt="Generate tocken"
