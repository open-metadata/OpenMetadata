...
{% image src="/images/v1.7/how-to-guides/governance/workflows-glossary-approval.png" alt="glossary-approval" /%}
...
{% image src="/images/v1.7/how-to-guides/governance/workflows-glossary-approval1.png" alt="glossary-approval-process" /%}

3. One can check the configuration of the glossary term by clicking on data asset in **Workflow**.

{% image src="/images/v1.7/how-to-guides/governance/workflows-glossary-approval2.png" alt="glossary-approval-workflow" /%}
