...
{% partial file="/v1.2/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/redash/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Redash", 
    selectServicePath: "/images/v1.2/connectors/redash/select-service.png",
    addNewServicePath: "/images/v1.2/connectors/redash/add-new-service.png",
    serviceConnectionPath: "/images/v1.2/connectors/redash/service-connection.png",
} 
/%}
