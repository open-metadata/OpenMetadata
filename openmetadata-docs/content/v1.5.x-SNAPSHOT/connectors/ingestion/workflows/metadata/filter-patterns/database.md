...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/database-filter-patterns.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-1.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-2.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-3.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/database-filter-example-4.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/schema-filter-example-1.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/schema-filter-example-2.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/schema-filter-example-3.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/table-filter-example-1.webp"
...
{% image
  src="/images/v1.5/features/ingestion/workflows/metadata/filter-patterns/table-filter-example-2.webp"
