...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/s3/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/s3/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/s3/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/s3/service-connection.png"
