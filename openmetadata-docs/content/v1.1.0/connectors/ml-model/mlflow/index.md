...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/ml-model/mlflow/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Mlflow", 
    selectServicePath: "/images/v1.1.0/connectors/mlflow/select-service.png",
    addNewServicePath: "/images/v1.1.0/connectors/mlflow/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.0/connectors/mlflow/service-connection.png",
} 
/%}
...
{% partial file="/v1.1.0/connectors/ml-model/configure-ingestion.md" /%}
