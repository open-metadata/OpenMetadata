...
{% image
  src="/images/v1.0.0/connectors/superset/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/connectors/superset/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/connectors/superset/service-connection.png"
