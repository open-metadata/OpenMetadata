...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/mode/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Mode", 
    selectServicePath: "/images/v1.1.0/connectors/mode/select-service.png",
    addNewServicePath: "/images/v1.1.0/connectors/mode/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.0/connectors/mode/service-connection.png",
} 
/%}
