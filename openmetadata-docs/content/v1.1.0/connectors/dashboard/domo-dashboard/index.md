...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/domo-dashboard/yaml"} /%}
...
For metadata ingestion, kindly make sure add at least `dashboard` scopes to the clientId provided.
...
{% image
  src="/images/v1.1.0/connectors/domodashboard/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/domodashboard/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/domodashboard/service-connection.png"
