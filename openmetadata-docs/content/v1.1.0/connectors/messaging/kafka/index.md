...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/kafka/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/kafka/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/kafka/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/kafka/service-connection.png"
...
{% image
src="/images/v1.1.0/connectors/configure-metadata-ingestion-messaging.png"
