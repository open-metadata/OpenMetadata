...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/databricks-pipeline/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/databrickspipeline/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/databrickspipeline/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/databrickspipeline/service-connection.png"
