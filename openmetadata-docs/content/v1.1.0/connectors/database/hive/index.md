...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/hive/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/hive/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/hive/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/hive/service-connection.png"
