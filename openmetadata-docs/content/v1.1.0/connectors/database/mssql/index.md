...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/mssql/yaml"} /%}
...
{% image
src="/images/v1.1.0/connectors/mssql/remote-connection.png"
...
{% image
  src="/images/v1.1.0/connectors/mssql/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/mssql/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/mssql/service-connection.png"
