...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/snowflake/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/snowflake/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/snowflake/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/snowflake/service-connection.png"
