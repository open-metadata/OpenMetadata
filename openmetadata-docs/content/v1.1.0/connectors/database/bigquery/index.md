...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/bigquery/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/bigquery/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/bigquery/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/bigquery/service-connection.png"
