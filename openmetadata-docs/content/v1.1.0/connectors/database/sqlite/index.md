...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/sqlite/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/presto/select-sqlite-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/sqlite/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/sqlite/service-connection.png"
