...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/domo-database/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/domodatabase/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/domodatabase/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/domodatabase/service-connection.png"
