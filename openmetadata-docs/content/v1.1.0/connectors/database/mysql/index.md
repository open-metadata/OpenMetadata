...
{% partial file="/v1.1.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/mysql/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Athena", 
    selectServicePath: "/images/v1.1.0/connectors/mysql/select-service.png",
    addNewServicePath: "/images/v1.1.0/connectors/mysql/add-new-service.png",
    serviceConnectionPath: "/images/v1.1.0/connectors/mysql/service-connection.png",
} 
/%}
