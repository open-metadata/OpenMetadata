...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/singlestore/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/singlestore/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/singlestore/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/singlestore/service-connection.png"
