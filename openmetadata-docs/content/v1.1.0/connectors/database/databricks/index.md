...
{% partial file="ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/databricks/yaml"} /%}
...
{% image
  src="/images/v1.1.0/connectors/databricks/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.1.0/connectors/databricks/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.1.0/connectors/databricks/service-connection.png"
