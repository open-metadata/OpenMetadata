...
- **`name`**: Name of the tag. Refer to *[#/definitions/tagName](#definitions/tagName)*.
...
- **`children`**: Children tags under this tag. Refer to *[../../type/entityReferenceList.json#/definitions/entityReferenceList](#/../type/entityReferenceList.json#/definitions/entityReferenceList)*.
...
- <a id="definitions/tagName"></a>**`tagName`** *(string)*: Name of the tag.
