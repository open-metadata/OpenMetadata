...
description: Learn to implement data lineage tracking with `brandName`'sPython SDK. Complete guide with code examples, API usage, and best practices for data flow ...
...
{% image src="/images/v1.9/sdk/python/ingestion/lineage/simple-lineage.png" alt="simple-lineage" /%}
...
{% image src="/images/v1.9/sdk/python/ingestion/lineage/lineage-col.png" alt="lineage-col" /%}
