...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/1.6.11-release/docker-compose-openmetadata.yml
```
...
470cc8149826   openmetadata/server:1.6.11                              "./openmetadata-star…"   45 seconds ago   Up 43 seconds             3306/tcp, 9200/tcp, 9300/tcp, 0.0.0.0:8585-8586->8585-8586/tcp   openmetadata_server
```
