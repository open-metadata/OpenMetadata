...
<Image src="/images/developers/architecture/architecture.webp" alt="System and Components" caption="Overview of the OpenMetadata components and high-level interactions."/>
