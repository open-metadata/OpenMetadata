...
Right-click on openmetadata-apis

<Image src="/images/developers/contribute/build-code-and-run-tests/intellij-openmetadata-apis.png" alt="Open project" caption=" "/>
