...
{% partial file="/v1.6/connectors/yaml/data-profiler.md" variables={connector: "sqlite"} /%}

{% partial file="/v1.6/connectors/yaml/auto-classification.md" variables={connector: "sqlite"} /%}
