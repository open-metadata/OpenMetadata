...
{% partial file="/v1.5/connectors/yaml/query-usage.md" variables={connector: "postgres"} /%}

{% partial file="/v1.5/connectors/yaml/lineage.md" variables={connector: "postgres"} /%}
