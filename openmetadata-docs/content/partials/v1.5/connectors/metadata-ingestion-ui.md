...
{% image
  src="/images/v1.5/connectors/select-service-type.png"
  alt="Select Service"
...
{% image
  src="/images/v1.5/connectors/add-service-name.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.5/connectors/configure-service-connection.png"
