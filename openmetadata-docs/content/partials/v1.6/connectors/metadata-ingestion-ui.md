...
{% image
  src="/images/v1.6/connectors/kinesis/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.6/connectors/kinesis/add-service-name.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.6/connectors/kinesis/service-connection.png"
