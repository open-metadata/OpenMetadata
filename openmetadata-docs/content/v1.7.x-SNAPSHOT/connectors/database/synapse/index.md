...
{% partial file="/v1.7/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/synapse/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Synapse", 
    selectServicePath: "/images/v1.7/connectors/synapse/select-service.webp",
    addNewServicePath: "/images/v1.7/connectors/synapse/add-new-service.webp",
    serviceConnectionPath: "/images/v1.7/connectors/synapse/service-connection.webp",
} 
/%}
