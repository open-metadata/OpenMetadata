...
{% image src="/images/v1.7/deployment/secrets-manager/supported-implementations/aws-secrets-manager/secrets-manager-console.png" alt="gcp-secret-manager-console" /%}
