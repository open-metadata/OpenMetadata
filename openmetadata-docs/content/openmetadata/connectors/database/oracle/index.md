...
- **Oracle Connection Type** : Select the Oracle Connection Type. The type can either be `Oracle Service Name` or `Database Schema`
  ...
  - **Database Schema**: Enter the name of the database schema available in Oracle that you want to connect with, and make sure that the user has enough access to use resources available in this database.
