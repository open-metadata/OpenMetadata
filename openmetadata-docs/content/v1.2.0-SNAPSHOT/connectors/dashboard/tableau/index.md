...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/tableau/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Tableau", 
    selectServicePath: "/images/v1.2.0/connectors/tableau/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/tableau/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/tableau/service-connection.png",
} 
/%}
