...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/kafka/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Kafka", 
    selectServicePath: "/images/v1.2.0/connectors/kafka/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/kafka/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/kafka/service-connection.png",
} 
/%}
...
{% partial file="/v1.2.0/connectors/messaging/configure-ingestion.md" /%}
