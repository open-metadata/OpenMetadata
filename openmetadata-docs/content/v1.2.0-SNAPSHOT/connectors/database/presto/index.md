...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/presto/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Presto", 
    selectServicePath: "/images/v1.2.0/connectors/presto/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/presto/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/presto/service-connection.png",
} 
/%}
