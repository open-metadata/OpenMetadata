...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/snowflake/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Snowflake", 
    selectServicePath: "/images/v1.2.0/connectors/snowflake/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/snowflake/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/snowflake/service-connection.png",
} 
/%}
