...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/postgres/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Postgres", 
    selectServicePath: "/images/v1.2.0/connectors/postgres/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/postgres/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/postgres/service-connection.png",
} 
/%}
