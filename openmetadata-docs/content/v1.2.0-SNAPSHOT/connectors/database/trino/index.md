...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/trino/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Trino", 
    selectServicePath: "/images/v1.2.0/connectors/trino/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/trino/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/trino/service-connection.png",
} 
/%}
