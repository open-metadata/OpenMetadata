...
{% partial file="/v1.2.0/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/domo-database/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.2.0/connectors/domodatabase/select-service.png",
    addNewServicePath: "/images/v1.2.0/connectors/domodatabase/add-new-service.png",
    serviceConnectionPath: "/images/v1.2.0/connectors/domodatabase/service-connection.png",
} 
/%}
