...
from openmetadata_managed_apis.api.apis_metadata import APIS_METADATA, get_metadata_api
...
from openmetadata_managed_apis.api.utils import jwt_token_secure
...
class REST_API(AppBuilderBaseView):  # TODO: rename this to View, endpoints go separated
