...
module.exports = {
  ...
  output: {
    ...
    filename: "SlackPlugin.js", // Updated output filename to reflect the plugin name
    library: "SlackPlugin", // Updated library name to match the plugin
  ...
  externals: {
    ...
    // "@ant-design/icons": "AntDesignIcons", // Exclude Ant Design icons
  },
};
