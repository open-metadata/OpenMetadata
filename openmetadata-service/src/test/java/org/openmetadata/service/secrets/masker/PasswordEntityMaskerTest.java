...
public class PasswordEntityMaskerTest extends TestEntityMasker {
  ...
  void testExceptionConnection() {
    Map<String, Object> mysqlConnectionObject = Map.of(
      "authType",
    ...
    EntityMaskException thrown = Assertions.assertThrows(
    ...
    thrown =
      Assertions.assertThrows(
        ...
        () ->
          EntityMaskerFactory
            .createEntityMasker()
            .unmaskServiceConnectionConfig(mysqlConnectionObject, new MysqlConnection(), "Mysql", ServiceType.DATABASE)
      );
