...
public abstract class JwtAuthOpenMetadataApplicationTest {
  protected static final String CONFIG_PATH =
      ResourceHelpers.resourceFilePath("openmetadata-jwt-test.yaml");
  ...
  private static void createClient() {
    // Use JNH connector (Java 11+ HttpClient) - simple, reliable, supports PATCH natively
