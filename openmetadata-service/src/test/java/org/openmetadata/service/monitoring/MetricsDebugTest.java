...
public class MetricsDebugTest {
  ...
  public void debugMetricsOutput() {
    ...
    System.out.println("Contains 'jvm_memory_used_bytes': " + output.contains("jvm_memory_used_bytes"));
    System.out.println("Contains 'area=\"heap\"': " + output.contains("area=\"heap\""));
    System.out.println("Contains 'jvm_memory_used_bytes{area=\"heap\"': " + output.contains("jvm_memory_used_bytes{area=\"heap\""));
