...
public class MicrometerBundleTest {
  ...
  public void setUp() {
    ...
    when(adminEnv.addServlet(anyString(), any(jakarta.servlet.Servlet.class))).thenReturn(servletRegistration);
  }
  ...
  public void testInitialize() {
    ...
    assertTrue(Metrics.globalRegistry.getRegistries().contains(bundle.getPrometheusMeterRegistry()));
  }
