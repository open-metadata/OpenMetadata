...
public class InternalOpenLineageEventsResourceTest {
    ...
    @InjectMocks
    private InternalOpenLineageEventsResource resource;
    ...
    public void testGetEvents_AllParams() {
        ...
        ResultList<OpenLineageWrappedEvent> result = resource.queryEvents(uriInfo, runId, eventType, unprocessed);
    ...
    public void testGetEvents_EventTypeOnly() {
        ...
        ResultList<OpenLineageWrappedEvent> result = resource.queryEvents(uriInfo, null, eventType, null);
    ...
    public void testGetEvents_UnprocessedOnly() {
        ...
        ResultList<OpenLineageWrappedEvent> result = resource.queryEvents(uriInfo, null, null, unprocessed);
