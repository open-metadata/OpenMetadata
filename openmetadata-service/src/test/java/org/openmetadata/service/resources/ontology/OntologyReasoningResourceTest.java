...
class OntologyReasoningResourceTest {
  @Test
  void defersRdfServiceResolutionUntilAnExplanationIsRequested() {
    final AtomicInteger resolutions = new AtomicInteger();

    new OntologyReasoningResource(
        mock(Authorizer.class),
        mock(GlossaryRepository.class),
        () -> {
          resolutions.incrementAndGet();
          return mock(InferenceExplanationService.class);
        });
