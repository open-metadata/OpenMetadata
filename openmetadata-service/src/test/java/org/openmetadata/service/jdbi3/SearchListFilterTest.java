...
public class SearchListFilterTest {
    ...
    void testSimpleGetCondition() {
        ...
        String expected = "{\"_source\": {\"exclude\": [\"fqnParts\",\"entityType\",\"suggest\"]},\"query\": {\"bool\": {\"filter\": [{\"term\": {\"deleted\": \"false\"}}]}}}";
