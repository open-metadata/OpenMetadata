...
class SearchExportCompletenessTest {
  ...
  void elasticsearchRejectsTimeoutsAndPartialShards(boolean timeout, int failed)
      throws IOException {
    ...
    es.co.elastic.clients.elasticsearch.core.SearchResponse<es.co.elastic.clients.json.JsonData>
        response =
            es.co.elastic.clients.elasticsearch.core.SearchResponse.of(
                builder ->
                    builder
                        .took(1)
                        .timedOut(timeout)
  ...
  @ParameterizedTest
  @CsvSource({"true,0", "false,1", "false,0"})
  void opensearchRejectsTimeoutsAndPartialShards(boolean timeout, int failed) throws IOException {
    ...
    os.org.opensearch.client.opensearch.core.SearchResponse<os.org.opensearch.client.json.JsonData>
        response =
            new os.org.opensearch.client.opensearch.core.SearchResponse.Builder<
