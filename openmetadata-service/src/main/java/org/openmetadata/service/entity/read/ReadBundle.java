...
public final class ReadBundle {
  ...
  public void putRelations(
      UUID entityId, String field, Include include, List<EntityReference> refs) {
  ...
  public Optional<List<EntityReference>> getRelations(
      UUID entityId, String field, Include include) {
  ...
  public boolean hasLoadedRelationForField(UUID entityId, String field) {
  ...
  public Set<Include> getLoadedIncludesForField(UUID entityId, String field) {
    Map<String, Set<Include>> includesByField = loadedRelationIncludesByField.get(entityId);
  ...
  public void putTags(UUID entityId, List<TagLabel> tags) {
    loadedTags.add(entityId);
    tagValues.put(entityId, tags == null ? Collections.emptyList() : List.copyOf(tags));
  }

  public Optional<List<TagLabel>> getTags(UUID entityId) {
  ...
  public void putCertification(UUID entityId, AssetCertification certification) {
  ...
  public boolean hasCertification(UUID entityId) {
    return loadedCertifications.contains(entityId);
  }

  public AssetCertification getCertificationOrNull(UUID entityId) {
    return certificationValues.get(entityId);
  }

  public void putVotes(UUID entityId, Votes votes) {
    loadedVotes.add(entityId);
    voteValues.put(entityId, votes == null ? new Votes() : votes);
  }

  public Optional<Votes> getVotes(UUID entityId) {
  ...
  public void putExtension(UUID entityId, Object extension) {
    loadedExtensions.add(entityId);
    extensionValues.put(entityId, extension);
  }

  public boolean hasExtension(UUID entityId) {
    return loadedExtensions.contains(entityId);
  }

  public Object getExtensionOrNull(UUID entityId) {
