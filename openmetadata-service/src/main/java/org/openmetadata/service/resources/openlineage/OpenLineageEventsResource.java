...
@Path("/v1/openlineage")
@Tag(name = "OpenLineageEvents", description = "API for managing OpenLineage events as per the OpenLineage Standard.")
...
public class OpenLineageEventsResource {
    ...
    private static final String INVALID_OPENLINEAGE_CREATE_REQUEST = "Cannot Create OpenLineage Event";
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = OpenLineageWrappedEvent.class))
                    ),
