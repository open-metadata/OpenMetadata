...
public class PersonaResource extends EntityResource<Persona, PersonaRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllPersonaVersionsByTimestamp",
      summary = "List all persona versions within a time range",
      description =
          "Get a paginated list of all persona entity versions within a given time range "
  ...
  public ResultList<Persona> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      ...
      @Parameter(description = "Limit the number of personas returned (1 to 1000000, default = 10)")
          ...
          @QueryParam("limit")
          int limitParam,
      @Parameter(description = "Returns list of persona versions before this cursor")
          @QueryParam("before")
          String before,
      @Parameter(description = "Returns list of persona versions after this cursor")
          @QueryParam("after")
          String after) {
