...
public class SpreadsheetResource extends EntityResource<Spreadsheet, SpreadsheetRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllSpreadsheetVersionsByTimestamp",
      summary = "List all spreadsheet versions within a time range",
      description =
          "Get a paginated list of all spreadsheet entity versions within a given time range "
  ...
  public ResultList<Spreadsheet> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      ...
      @Parameter(
              description =
                  "Limit the number of spreadsheets returned (1 to 1000000, default = 10)")
          @DefaultValue("10")
          @Min(value = 1, message = "must be greater than or equal to 1")
          @Max(value = 1000000, message = "must be less than or equal to 1000000")
          @QueryParam("limit")
          int limitParam,
      @Parameter(description = "Returns list of spreadsheet versions before this cursor")
          @QueryParam("before")
          String before,
      @Parameter(description = "Returns list of spreadsheet versions after this cursor")
          @QueryParam("after")
          String after) {
