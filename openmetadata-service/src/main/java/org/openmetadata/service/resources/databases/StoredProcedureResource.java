...
public class StoredProcedureResource extends EntityResource<StoredProcedure, StoredProcedureRepository> {
  ...
  @Operation(
    ...
    description = "Get a list of stored procedures, optionally filtered by `databaseSchema` it belongs to. Use `fields` " +
    ...
    responses = {
      @ApiResponse(
        ...
        content = @Content(mediaType = "application/json", schema = @Schema(implementation = StoredProcedureList.class))
      )
    }
  )
  public ResultList<StoredProcedure> list(
    ...
    @Parameter(description = "Limit the number schemas returned. (1 to 1000000, default = 10)") @DefaultValue(
      "10"
  ...
  @Operation(
    ...
    responses = {
      @ApiResponse(
        ...
        content = @Content(mediaType = "application/json", schema = @Schema(implementation = StoredProcedure.class))
      ),
