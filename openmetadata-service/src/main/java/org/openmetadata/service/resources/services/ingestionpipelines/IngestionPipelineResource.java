...
public class IngestionPipelineResource extends EntityResource<IngestionPipeline, IngestionPipelineRepository> {
    ...
    public Response createOrUpdate(
        ...
        DatabaseServiceProfilerPipeline databaseServiceProfilerPipeline = JsonUtils.convertValue(
                ingestionPipeline.getSourceConfig().getConfig(), DatabaseServiceProfilerPipeline.class);

        EntityUtil.validateProfileSample(databaseServiceProfilerPipeline.getProfileSampleType(), databaseServiceProfilerPipeline.getProfileSample());
        decryptOrNullify(securityContext, (IngestionPipeline) response.getEntity(), false);
        return response;
    }
