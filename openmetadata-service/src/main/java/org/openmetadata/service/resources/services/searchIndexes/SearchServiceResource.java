...
public class SearchServiceResource
  ...
  public SearchService getByName(
    ...
    SearchService searchService = getByNameInternal(
      uriInfo,
      securityContext,
  ...
  public Response delete(
    ...
    @Parameter(description = "Id of the search service", schema = @Schema(type = "string")) @PathParam("id") UUID id
  ) {
  ...
  public Response delete(
    ...
    @Parameter(description = "Name of the SearchService", schema = @Schema(type = "string")) @PathParam(
      "fqn"
    ) String fqn
  ) {
