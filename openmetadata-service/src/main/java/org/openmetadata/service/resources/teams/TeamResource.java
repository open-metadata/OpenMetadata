...
public class TeamResource extends EntityResource<Team, TeamRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllTeamVersionsByTimestamp",
      summary = "List all team versions within a time range",
      description =
          "Get a paginated list of all team entity versions within a given time range "
  ...
  public ResultList<Team> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      ...
      @Parameter(description = "Limit the number of teams returned (1 to 1000000, default = 10)")
          ...
          @QueryParam("limit")
          int limitParam,
      @Parameter(description = "Returns list of team versions before this cursor")
          @QueryParam("before")
          String before,
      @Parameter(description = "Returns list of team versions after this cursor")
          @QueryParam("after")
          String after) {
