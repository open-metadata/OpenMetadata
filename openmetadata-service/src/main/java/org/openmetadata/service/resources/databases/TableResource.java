...
public class TableResource extends EntityResource<Table, TableRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllTableVersionsByTimestamp",
      summary = "List all table versions within a time range",
      description =
          "Get a paginated list of all table entity versions within a given time range "
  ...
  public ResultList<Table> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
