...
public class DashboardDataModelResource extends EntityResource<DashboardDataModel, DashboardDataModelRepository> {
  ...
  @Operation(
    ...
    description = "Get a list of dashboard datamodels, optionally filtered by `service` it belongs to. Use `fields` " +
  ...
  public EntityHistory listVersions(
    @Context UriInfo uriInfo,
    @Context SecurityContext securityContext,
    @Parameter(description = "Id of the dashboard datamodel", schema = @Schema(type = "UUID")) @PathParam("id") UUID id
  ) {
  ...
  @Operation(
    ...
    responses = {
      ...
      @ApiResponse(responseCode = "404", description = "DataModel for instance {id} and version {version} is not found")
    }
  )
  ...
  public Response deleteFollower(
    ...
    @Context SecurityContext securityContext,
    @Parameter(description = "Id of the data model", schema = @Schema(type = "UUID")) @PathParam("id") UUID id,
    @Parameter(description = "Id of the user being removed as follower", schema = @Schema(type = "UUID")) @PathParam(
      "userId"
    ) UUID userId
  ) {
  ...
  public Response delete(
    ...
    @Parameter(description = "Fully qualified name of the data model", schema = @Schema(type = "string")) @PathParam(
      "fqn"
    ) String fqn
  ) {
