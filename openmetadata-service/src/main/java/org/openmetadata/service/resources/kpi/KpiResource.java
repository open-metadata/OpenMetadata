...
public class KpiResource extends EntityResource<Kpi, KpiRepository> {
  ...
  @Operation(
    ...
    summary = "List KPIs",
    description = "Get a list of KPIs. Use `fields` " +
  ...
  public ResultList<Kpi> list(
    ...
    @Parameter(description = "Limit the number of KIPs returned. (1 to 1000000, default = 10)") @DefaultValue(
      "10"
  ...
  @Operation(
    ...
    responses = {
      ...
      @ApiResponse(responseCode = "404", description = "KPI for instance {id} and version {version} is not found")
    }
  )
  ...
  @Operation(
    ...
    description = "Get a list of all the KPI results for the given KPI id, optionally filtered by  `startTs` and `endTs` of the profile. " +
  ...
  public ResultList<KpiResult> listKpiResults(
    ...
    @Parameter(description = "Order the result ", schema = @Schema(type = "string")) @Valid @QueryParam(
      "orderBy"
    ) @DefaultValue("DESC") OrderBy orderBy
  ) {
  ...
  public Response deleteKpiResult(
    ...
    @Context SecurityContext securityContext,
    @Parameter(description = "Name of the KPI", schema = @Schema(type = "string")) @PathParam("name") String name,
    @Parameter(description = "Timestamp of the KPI result", schema = @Schema(type = "long")) @PathParam(
      "timestamp"
    ) Long timestamp
  ) {
