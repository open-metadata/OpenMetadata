...
public class AppMarketPlaceResource extends EntityResource<AppMarketPlaceDefinition, AppMarketPlaceRepository> {
  ...
  public void initialize(OpenMetadataApplicationConfig config) {
    try {
      ...
      List<CreateAppMarketPlaceDefinitionReq> createAppMarketPlaceDefinitionReqs = getEntitiesFromSeedData(
        APPLICATION,
  ...
  private AppMarketPlaceDefinition getApplicationDefinition(
    CreateAppMarketPlaceDefinitionReq create,
    String updatedBy
  ) {
    AppMarketPlaceDefinition app = repository
