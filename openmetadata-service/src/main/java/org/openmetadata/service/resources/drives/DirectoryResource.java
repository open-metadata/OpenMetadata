...
public class DirectoryResource extends EntityResource<Directory, DirectoryRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllDirectoryVersionsByTimestamp",
      summary = "List all directory versions within a time range",
      description =
          "Get a paginated list of all directory entity versions within a given time range "
  ...
  public ResultList<Directory> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      ...
      @Parameter(description = "End timestamp in milliseconds since epoch", required = true)
          ...
          long endTs,
      @Parameter(
              description = "Limit the number of directories returned (1 to 1000000, default = 10)")
          @DefaultValue("10")
          @Min(value = 1, message = "must be greater than or equal to 1")
          @Max(value = 1000000, message = "must be less than or equal to 1000000")
          @QueryParam("limit")
          int limitParam,
      @Parameter(description = "Returns list of directory versions before this cursor")
          @QueryParam("before")
          String before,
      @Parameter(description = "Returns list of directory versions after this cursor")
          @QueryParam("after")
          String after) {
