...
public class ObjectStoreServiceResource extends ServiceEntityResource<ObjectStoreService, ObjectStoreServiceRepository, ObjectStoreConnection> {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content =
                            @Content(mediaType = "application/json", schema = @Schema(implementation = ObjectStoreServiceResource.ObjectStoreServiceList.class)))
            })
    public ResultList<ObjectStoreService> list(
        ...
        @QueryParam("before")
                String before,
        @Parameter(description = "Returns list of object store services after this cursor", schema = @Schema(type = "string"))
        @QueryParam("after")
                String after,
        @Parameter(
    ...
    @Operation(
            ...
            tags = "objectStoreServices",
            description =
                    "Delete an object store services. If containers belong the service, it can't be " + "deleted.",
            responses = {
                    @ApiResponse(responseCode = "200", description = "OK"),
                    @ApiResponse(responseCode = "404", description = "ObjectStoreService service for instance {id} " + "is not found")
            })
