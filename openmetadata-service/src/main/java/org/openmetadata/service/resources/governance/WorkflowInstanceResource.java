...
public class WorkflowInstanceResource extends EntityTimeSeriesResource<WorkflowInstance, WorkflowInstanceRepository> {
            ...
            responses = {
                    @ApiResponse(
                            ...
                            @Content(
                                    ...
                                    schema = @Schema(implementation = WorkflowInstanceResource.WorkflowInstanceResultList.class)))
            })
