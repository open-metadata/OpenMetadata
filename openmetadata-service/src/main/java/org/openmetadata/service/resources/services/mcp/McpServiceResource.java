...
@Tag(
    name = "MCP Services",
    description =
        "`MCP Service` is a service for discovering and managing MCP (Model Context Protocol) servers, "
            + "their tools, resources, and prompts for AI governance.")
...
public class McpServiceResource
  ...
  @Override
  public McpService addHref(UriInfo uriInfo, McpService service) {
  ...
  @Operation(
      ...
      description = "Get a list of MCP services.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "List of MCP service instances",
            content =
                @Content(
  ...
  @Operation(
      ...
      summary = "Get an MCP service",
      description = "Get an MCP service by `Id`.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "MCP service instance",
            content =
                @Content(
                    mediaType = "application/json",
  ...
  public McpService get(
      ...
      @Parameter(
          ...
          @DefaultValue("non-deleted")
          Include include) {
    McpService mcpService = getInternal(uriInfo, securityContext, id, fieldsParam, include);
    return decryptOrNullify(securityContext, mcpService);
  }
  ...
  @Operation(
      ...
      summary = "Get MCP service by name",
      description = "Get an MCP service by the service `name`.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "MCP service instance",
        ...
        @ApiResponse(
            responseCode = "404",
            description = "MCP service for instance {name} is not found")
      })
  public McpService getByName(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      @Parameter(description = "Name of the MCP service", schema = @Schema(type = "string"))
          @PathParam("name")
          String name,
      @Parameter(
              description = "Fields requested in the returned resource",
      ...
      @Parameter(
          ...
          @DefaultValue("non-deleted")
          Include include) {
    McpService mcpService = getByNameInternal(uriInfo, securityContext, name, fieldsParam, include);
    return decryptOrNullify(securityContext, mcpService);
  }
  ...
  @Path("/{id}/versions")
  @Operation(
      operationId = "listAllMcpServiceVersion",
    ...
    List<Object> versions =
        entityHistory.getVersions().stream()
            .map(
                json -> {
                  try {
                    McpService mcpService = JsonUtils.readValue((String) json, McpService.class);
                    return JsonUtils.pojoToJson(decryptOrNullify(securityContext, mcpService));
                  } catch (Exception e) {
                    return json;
                  }
                })
  ...
  @Operation(
      operationId = "getSpecificMcpServiceVersion",
      summary = "Get a version of the MCP service",
      description = "Get a version of the MCP service by given `Id`",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  public McpService getVersion(
      ...
      @Parameter(
          ...
          @PathParam("version")
          String version) {
    McpService mcpService = super.getVersionInternal(securityContext, id, version);
    return decryptOrNullify(securityContext, mcpService);
  }
  ...
  public Response create(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      @Valid CreateMcpService create) {
    McpService service =
        mapper.createToEntity(create, securityContext.getUserPrincipal().getName());
    Response response = create(uriInfo, securityContext, service);
    decryptOrNullify(securityContext, (McpService) response.getEntity());
    return response;
  }
  ...
  @Operation(
      ...
      description = "Update an existing or create a new MCP service.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "MCP service instance",
  ...
  @Operation(
      ...
      description =
          "Delete an MCP service. If MCP servers belong to the service, it can't be deleted.",
      responses = {
        @ApiResponse(responseCode = "200", description = "OK"),
        @ApiResponse(
            responseCode = "404",
            description = "McpService for instance {id} is not found")
      })
  ...
  @Operation(
      ...
      description =
          "Asynchronously delete an MCP service. If MCP servers belong to the service, it can't be deleted.",
      responses = {
        @ApiResponse(responseCode = "200", description = "OK"),
        @ApiResponse(
            responseCode = "404",
  ...
  @Operation(
      ...
      summary = "Delete an MCP service by name",
      description =
          "Delete an MCP service by `name`. If MCP servers belong to the service, it can't be deleted.",
      responses = {
        @ApiResponse(responseCode = "200", description = "OK"),
        @ApiResponse(
            responseCode = "404",
            description = "McpService for instance {name} is not found")
      })
  public Response delete(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Successfully restored the McpService.",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = McpService.class)))
