...
public abstract class ServiceEntityResource<
  ...
  protected ServiceEntityResource(
      ServiceEntityInfo<T> serviceEntityInfo,
      R serviceEntityRepository,
      Authorizer authorizer,
      Limits limits) {
    super(serviceEntityInfo.getResourceEntityInfo(), serviceEntityRepository, authorizer, limits);
    this.serviceEntityRepository = serviceEntityRepository;
    this.serviceType = serviceEntityInfo.getServiceType();
  }
