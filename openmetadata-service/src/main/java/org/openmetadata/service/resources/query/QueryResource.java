...
public class QueryResource extends EntityResource<Query, QueryRepository> {
  ...
  @Operation(
    ...
    description = "Get a list of queries. Use `fields` " +
  ...
  public ResultList<Query> listQueries(
    ...
    @Parameter(description = "Limit the number queries returned. (1 to 1000000, default = 10)") @DefaultValue(
      "10"
    ...
    ResultList<Query> queries = super.listInternal(
      uriInfo,
      securityContext,
      fieldsParam,
      filter,
  ...
  public Query getQueryByName(
    @Context UriInfo uriInfo,
    @Context SecurityContext securityContext,
    @Parameter(description = "Fully qualified name of the query", schema = @Schema(type = "string")) @PathParam(
      "fqn"
    ) String fqn,
    @Parameter(
      description = "Fields requested in the returned resource",
  ...
  public Response delete(
    @Context UriInfo uriInfo,
    @Context SecurityContext securityContext,
    @Parameter(description = "Fully qualified name of the location", schema = @Schema(type = "string")) @PathParam(
      "fqn"
    ) String fqn
  ) {
