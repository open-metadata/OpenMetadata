...
public class GlossaryTermResource extends EntityResource<GlossaryTerm, GlossaryTermRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllGlossaryTermVersionsByTimestamp",
      summary = "List all glossary term versions within a time range",
      description =
          "Get a paginated list of all glossary term entity versions within a given time range "
  ...
  public ResultList<GlossaryTerm> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      ...
      @Parameter(
              description =
                  "Limit the number of glossary terms returned (1 to 1000000, default = 10)")
          @DefaultValue("10")
          @Min(value = 1, message = "must be greater than or equal to 1")
          @Max(value = 1000000, message = "must be less than or equal to 1000000")
          @QueryParam("limit")
          int limitParam,
      @Parameter(description = "Returns list of glossary term versions before this cursor")
          @QueryParam("before")
          String before,
      @Parameter(description = "Returns list of glossary term versions after this cursor")
          @QueryParam("after")
          String after) {
