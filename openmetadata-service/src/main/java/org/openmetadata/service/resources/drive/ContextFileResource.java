...
@Tag(name = "Context Center Files", description = "APIs for managing files in the Context Center.")
@Path("/v1/contextCenter/files")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@Collection(name = "contextCenterFiles")
public class ContextFileResource extends EntityResource<ContextFile, ContextFileRepository> {
  public static final String COLLECTION_PATH = "v1/contextCenter/files/";
