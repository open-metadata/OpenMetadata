...
public class DataContractResource extends EntityResource<DataContract, DataContractRepository> {
  ...
  @Path("/versions")
  @Operation(
      operationId = "listAllDataContractVersionsByTimestamp",
      summary = "List all data contract versions within a time range",
      description =
          "Get a paginated list of all data contract entity versions within a given time range "
  ...
  public ResultList<DataContract> listAllVersionsByTimestamp(
      @Context UriInfo uriInfo,
      @Context SecurityContext securityContext,
      ...
      @Parameter(
              description =
                  "Limit the number of data contracts returned (1 to 1000000, default = 10)")
          @DefaultValue("10")
          @Min(value = 1, message = "must be greater than or equal to 1")
          @Max(value = 1000000, message = "must be less than or equal to 1000000")
          @QueryParam("limit")
          int limitParam,
      @Parameter(description = "Returns list of data contract versions before this cursor")
          @QueryParam("before")
          String before,
      @Parameter(description = "Returns list of data contract versions after this cursor")
          @QueryParam("after")
          String after) {
