...
public class SearchResource {
  ...
  private SearchSourceBuilder buildTableSearchBuilder(String query, int from, int size) {
    ...
    searchSourceBuilder.aggregation(
        AggregationBuilders.terms("Database").field("database.name.keyword").size(MAX_AGGREGATE_SIZE));
    searchSourceBuilder.aggregation(
        AggregationBuilders.terms("DatabaseSchema").field("databaseSchema.name.keyword").size(MAX_AGGREGATE_SIZE));
