...
public class MSTeamsWebhookPublisher extends AlertsActionPublisher {
  ...
  public MSTeamsWebhookPublisher(Alert alert, AlertAction alertAction, CollectionDAO dao) {
  ...
  public void sendAlert(ChangeEvent event) {
    ...
    try {
      ...
      Response response = target.post(javax.ws.rs.client.Entity.entity(teamsMessage, MediaType.APPLICATION_JSON_TYPE));
