...
public class LookerConnectionClassConverter extends ClassConverter {
  ...
  private static final List<Class<?>> CREDENTIALS_CLASSES = List.of(GitHubCredentials.class, BitBucketCredentials.class);
  ...
  public Object convert(Object object) {
    ...
    tryToConvertOrFail(lookerConnection.getGitCredentials(), CREDENTIALS_CLASSES).ifPresent(lookerConnection::setGitCredentials);
