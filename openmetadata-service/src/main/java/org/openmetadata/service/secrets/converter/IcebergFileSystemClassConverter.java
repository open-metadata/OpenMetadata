...
public class IcebergFileSystemClassConverter extends ClassConverter {
  ...
  public Object convert(Object object) {
    IcebergFileSystem IcebergFileSystem =
        (IcebergFileSystem) JsonUtils.convertValue(object, this.clazz);

    tryToConvert(IcebergFileSystem.getType(), FILE_SYSTEM_CLASSES)
        .ifPresent(IcebergFileSystem::setType);

    return IcebergFileSystem;
  }
}
