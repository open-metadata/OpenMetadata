...
public class ThoughtSpotConnectionClassConverter extends ClassConverter {
  ...
  private static final List<Class<?>> AUTHENTICATION_CLASSES =
      List.of(BasicAuth.class, ApiAccessTokenAuth.class);
  ...
  public Object convert(Object object) {
    ...
    tryToConvertOrFail(thoughtSpotConnection.getAuthentication(), AUTHENTICATION_CLASSES)
