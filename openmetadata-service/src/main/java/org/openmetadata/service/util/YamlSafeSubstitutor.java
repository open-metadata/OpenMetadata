...
/**
 * Extension of {@link EnvironmentVariableSubstitutor} that automatically quotes values containing
 ...
 * </pre>
 *
 * This would be interpreted as an empty block scalar by the YAML parser, causing a parsing error.
 * This class automatically wraps such values in double quotes:
 *
 * <pre>
 * password: ">8fYhD>dkcxy#HkVi8~ET"
 * </pre>
 *
 * Values that look like YAML flow sequences ({@code [...]}) or flow mappings ({@code {...}}) are
