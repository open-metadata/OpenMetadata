...
public final class EntityUtil {
    ...
    public static void validateProfileSample(Object profileSampleType, double profileSampleValue) {
        if (profileSampleType.equals(TableProfilerConfig.ProfileSampleType.PERCENTAGE)) {
