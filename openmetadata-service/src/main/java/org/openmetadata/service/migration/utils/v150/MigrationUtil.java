  ...
  public static void migrateTestCaseDimension(Handle handle, CollectionDAO collectionDAO) {
    ...
    Map<String, String> fqnToDimension =
        Map.ofEntries(
            ...
            Map.entry("columnValueMeanToBeBetween", "Accuracy"),
            Map.entry("columnValueMedianToBeBetween", "Accuracy"),
            Map.entry("columnValueMinToBeBetween", "Accuracy"),
            Map.entry("columnValueLengthsToBeBetween", "Accuracy"),
            Map.entry("columnValuesSumToBeBetween", "Accuracy"),
            Map.entry("columnValueStdDevToBeBetween", "Accuracy"),
            Map.entry("columnValuesToBeBetween", "Accuracy"),
            Map.entry("columnValuesToBeInSet", "Validity"),
            Map.entry("columnValuesToBeNotInSet", "Validity"),
            Map.entry("columnValuesToMatchRegex", "Validity"),
            Map.entry("columnValuesToNotMatchRegex", "Validity"),
            Map.entry("tableColumnCountToBeBetween", "Integrity"),
            Map.entry("tableColumnCountToEqual", "Integrity"),
            Map.entry("tableColumnNameToExist", "Integrity"),
            Map.entry("tableColumnToMatchSet", "Integrity"),
            Map.entry("tableRowCountToBeBetween", "Integrity"),
            Map.entry("tableRowCountToEqual", "Integrity"),
            Map.entry("tableRowInsertedCountToBeBetween", "Integrity"),
            Map.entry("columnValuesToBeUnique", "Uniqueness"),
            Map.entry("columnValuesMissingCount", "Completeness"),
            Map.entry("columnValuesToBeNotNull", "Completeness"),
            Map.entry("tableCustomSQLQuery", "SQL"),
            Map.entry("tableDiff", "Consistency"));
