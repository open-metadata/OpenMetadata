...
public class MigrationUtil {
  ...
  public static void testSuitesMigration(CollectionDAO collectionDAO) {
    ...
    List<TestCase> testCases = testCaseRepository.listAll(new Fields(List.of("id")), new ListFilter(Include.ALL));
    ...
    for (TestCase test : testCases) {
      ...
      try {
        ...
        try {
          ...
          stored =
              testSuiteRepository.getByName(
                  null, EntityInterfaceUtil.quoteName(testSuiteFqn), new Fields(List.of("id")), Include.ALL);
    ...
    List<TestSuite> testSuites = testSuiteRepository.listAll(new Fields(List.of("id")), filter);
