...
public class MigrationUtil {
  ...
  public static void addCreateTaskRuleToDataConsumerPolicy(CollectionDAO collectionDAO) {
    ...
    try {
      ...
      // Let unexpected read/write/cache failures propagate: swallowing them would record the
      // migration as applied and skip the repair on later runs, leaving the policy unrepaired.
