...
/**
 * Service layer for Pipeline entity operations.
 *
...
public class PipelineService extends AbstractEntityService<Pipeline> {
   ...
   *
   * @param repository PipelineRepository for data access (injected by Dagger)
   ...
   * @param mapper PipelineMapper for DTO conversions (injected by Dagger)
   */
  @Inject
