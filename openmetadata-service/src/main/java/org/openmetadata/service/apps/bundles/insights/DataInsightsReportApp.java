...
//
// import static
// org.openmetadata.schema.dataInsight.DataInsightChartResult.DataInsightChartType.PERCENTAGE_OF_ENTITIES_WITH_DESCRIPTION_BY_TYPE;
// import static
// org.openmetadata.schema.dataInsight.DataInsightChartResult.DataInsightChartType.PERCENTAGE_OF_ENTITIES_WITH_OWNER_BY_TYPE;
...
//    Application app = (Application) jobExecutionContext.getJobDetail().getJobDataMap().get(APP_INFO);
//    // Calculate time diff
//    long currentTime = Instant.now().toEpochMilli();
//    ScheduledExecutionContext scheduleConfiguration = app.getExecutionContext().getScheduled();
...
//          JsonUtils.convertValue(app.getConfiguration(), DataInsightAppConfig.class);
//      // Send to Admins
...
//  }
//
//  private long getTimeFromSchedule(ScheduledExecutionContext scheduledConfig) {
//    ScheduledExecutionContext.ScheduleInfo scheduleInfo = scheduledConfig.getScheduleInfo();
//    switch (scheduleInfo) {
//      case DAILY:
//        return 86400000L;
//      case WEEKLY:
...
//  }
//
//  public static int getNumberOfDays(ScheduledExecutionContext scheduledConfig) {
//    ScheduledExecutionContext.ScheduleInfo scheduleInfo = scheduledConfig.getScheduleInfo();
//    switch (scheduleInfo) {
//      case DAILY:
//        return 1;
...
//        return 30;
//      case CUSTOM:
//        if (!CommonUtil.nullOrEmpty(scheduledConfig.getCronExpression())) {
//          Trigger triggerQrz = CronScheduleBuilder.cronSchedule(scheduledConfig.getCronExpression()).build();
//          Date previousFire =
