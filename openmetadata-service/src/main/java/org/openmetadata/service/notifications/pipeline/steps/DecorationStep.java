...
import org.openmetadata.service.notifications.decorator.NotificationMessageDecorator;
...
/**
 * Step 2: Decoration step (optional, used for email)
 */
public class DecorationStep implements NotificationPipelineStep {
  private final NotificationMessageDecorator decorator;

  public DecorationStep(NotificationMessageDecorator decorator) {
  ...
  public NotificationPipelineContext process(NotificationPipelineContext context) {
    if (decorator != null) {
      ...
      context.setRenderedBody(decoratedBody);
    }
    return context;
  }
}
