...
/**
 * Default {@link AiProvider}: extraction calls the shared {@link
 * org.openmetadata.service.llm.LLMCompletionClient} held by {@link LLMClientHolder} — one direct,
 * structured completion per chunk, no agent platform required.
 */
