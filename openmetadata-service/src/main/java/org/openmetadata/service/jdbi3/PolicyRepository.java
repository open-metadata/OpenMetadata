...
public class PolicyRepository extends EntityRepository<Policy> {
  ...
  private void fetchAndSetTeams(List<Policy> policies) {
    ...
    // Bulk fetch teams - relationship is TEAM -> HAS -> POLICY
    // so policyIds are toIds, TEAM is fromEntity, POLICY is toEntity
  ...
  private void fetchAndSetRoles(List<Policy> policies) {
    ...
    // Bulk fetch roles - relationship is ROLE -> HAS -> POLICY
    // so policyIds are toIds, ROLE is fromEntity, POLICY is toEntity
