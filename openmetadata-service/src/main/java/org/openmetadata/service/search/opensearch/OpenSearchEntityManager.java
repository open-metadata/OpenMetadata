                              ...
                              s.inline(
                                  i ->
                                      i.lang(
                                          ...
                                          .params(params)))
                      // refresh=false: rely on the index's configured refresh interval (default 1s unless
                      // configured otherwise) instead of forcing a blocking shard refresh after each
