...
public class OpenSearchClientImpl implements SearchClient {
  ...
  public Response searchBySourceUrl(String sourceUrl) throws IOException {
    ...
    IndicesAliasesRequest.AliasActions aliasAction = IndicesAliasesRequest.AliasActions.add().indices(
        ElasticSearchIndexDefinition.ElasticSearchIndexType.TABLE_SEARCH_INDEX.indexName, ElasticSearchIndexDefinition.ElasticSearchIndexType.TOPIC_SEARCH_INDEX.indexName,
        ...
        ElasticSearchIndexDefinition.ElasticSearchIndexType.MLMODEL_SEARCH_INDEX.indexName).alias("sourceUrlSearchAlias");
