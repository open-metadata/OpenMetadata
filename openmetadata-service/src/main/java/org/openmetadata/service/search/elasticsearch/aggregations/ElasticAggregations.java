...
public interface ElasticAggregations {
    ...
    default Boolean isPipelineAggregation() { return false; }
    ...
    default AggregationBuilder getElasticAggregationBuilder() { return null; }
    default PipelineAggregationBuilder getElasticPipelineAggregationBuilder() { return null; }
}
