...
public record TestCaseResultIndex(TestCaseResult testCaseResult) implements SearchIndex {
    ...
    public void removeNonIndexableFields(Map<String, Object> esDoc) {
        ...
        if (testDefinition != null) SearchIndexUtils.removeNonIndexableFields(testDefinition, excludeFields);
    }

    @Override
    public Map<String, Object> buildSearchIndexDocInternal(Map<String, Object> esDoc) {
        TestCase testCase = Entity.getEntityByName(Entity.TEST_CASE, testCaseResult.getTestCaseFQN(), "*", Include.ALL);
        TestDefinition testDefinition = Entity.getEntityByName(Entity.TEST_DEFINITION, testCase.getTestDefinition().getFullyQualifiedName(), "*", Include.ALL);
        ...
        testCaseMap.keySet().removeAll(Set.of("testSuites", "testSuite", "testCaseResult", "testDefinition")); // remove testCase fields not needed
    ...
    private void setTableEntityParentRelations(MessageParser.EntityLink entityLink, Map<String, Object> esDoc) {
