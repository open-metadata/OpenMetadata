...
public interface SearchApi extends ApiClient.Api {
   ...
   */
  @RequestLine("GET /v1/search/query?q={q}&index={index}&deleted={deleted}&from={from}&size={size}&sort_field={sortField}&sort_order={sortOrder}")
  @Headers({
   ...
   * @return SearchResponse
   */
  @RequestLine("GET /v1/search/suggest?q={q}&index={index}")
  @Headers({
      "Accept: application/json",
  })
