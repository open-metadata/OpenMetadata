...
public interface FeedsApi extends ApiClient.Api {
   ...
   * @return ThreadCount
   */
  @RequestLine("GET /v1/feed/count?entityLink={entityLink}&isResolved={isResolved}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return ThreadList
   */
  @RequestLine("GET /v1/feed?limitPosts={limitPosts}&limit={limit}&before={before}&after={after}&entityLink={entityLink}&userId={userId}&filterType={filterType}&resolved={resolved}")
  @Headers({
      "Accept: application/json",
  })
