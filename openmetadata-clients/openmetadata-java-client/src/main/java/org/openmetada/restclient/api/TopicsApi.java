...
public interface TopicsApi extends ApiClient.Api {
   ...
   */
  @RequestLine("PUT /topics/{id}/followers")
  @Headers({
   ...
   */
  @RequestLine("DELETE /topics/{id}?hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   */
  @RequestLine("DELETE /topics/{id}/followers/{userId}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Topic
   */
  @RequestLine("GET /topics/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Topic
   */
  @RequestLine("GET /topics/name/{fqn}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Topic
   */
  @RequestLine("GET /topics/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return TopicList
   */
  @RequestLine("GET /topics?fields={fields}&service={service}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /topics/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
