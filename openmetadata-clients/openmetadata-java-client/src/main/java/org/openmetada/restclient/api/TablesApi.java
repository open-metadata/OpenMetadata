...
public interface TablesApi extends ApiClient.Api {
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/columnTest")
  @Headers({
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/customMetric")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/dataModel")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/tableProfile")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("PUT /tables/{id}/followers")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   * @param body  (optional)
   */
  @RequestLine("PUT /tables/{id}/joins")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   */
  @RequestLine("PUT /tables/{id}/location")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/tableQuery")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/sampleData")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("PUT /tables/{id}/tableTest")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("DELETE /tables/{id}?hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   * @return Table
   */
  @RequestLine("DELETE /tables/{id}/columnTest/{columnName}/{columnTestType}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("DELETE /tables/{id}/customMetric/{columnName}/{customMetricName}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("DELETE /tables/{id}/followers/{userId}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("DELETE /tables/{id}/location")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("DELETE /tables/{id}/tableTest/{tableTestType}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("GET /tables/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("GET /tables/name/{fqn}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Table
   */
  @RequestLine("GET /tables/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return TableList
   */
  @RequestLine("GET /tables?fields={fields}&database={database}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /tables/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
