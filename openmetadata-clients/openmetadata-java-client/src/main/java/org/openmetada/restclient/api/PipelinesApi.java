...
public interface PipelinesApi extends ApiClient.Api {
   ...
   */
  @RequestLine("PUT /pipelines/{id}/followers")
  @Headers({
   ...
   * @return Pipeline
   */
  @RequestLine("PUT /pipelines/{id}/status")
  @Headers({
      "Content-Type: application/json",
   ...
   */
  @RequestLine("DELETE /pipelines/{id}?hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   */
  @RequestLine("DELETE /pipelines/{id}/followers/{userId}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Pipeline
   */
  @RequestLine("GET /pipelines/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Pipeline
   */
  @RequestLine("GET /pipelines/name/{fqn}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Pipeline
   */
  @RequestLine("GET /pipelines/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return PipelineList
   */
  @RequestLine("GET /pipelines?fields={fields}&service={service}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /pipelines/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("PATCH /pipelines/{id}")
  @Headers({
