...
public interface GlossariesApi extends ApiClient.Api {
   ...
   * @return GlossaryTerm
   */
  @RequestLine("POST /glossaryTerms")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("DELETE /glossaries/{id}?recursive={recursive}&hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   * @param hardDelete Hard delete the entity. (Default &#x3D; &#x60;false&#x60;) (optional)
   */
  @RequestLine("DELETE /glossaryTerms/{id}?recursive={recursive}&hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   * @return Glossary
   */
  @RequestLine("GET /glossaryTerms/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Glossary
   */
  @RequestLine("GET /glossaries/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Glossary
   */
  @RequestLine("GET /glossaries/name/{name}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Glossary
   */
  @RequestLine("GET /glossaryTerms/name/{name}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Glossary
   */
  @RequestLine("GET /glossaries/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Glossary
   */
  @RequestLine("GET /glossaryTerms/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return GlossaryList
   */
  @RequestLine("GET /glossaries?fields={fields}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /glossaryTerms?glossary={glossary}&parent={parent}&fields={fields}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /glossaries/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return EntityHistory
   */
  @RequestLine("GET /glossaryTerms/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("PATCH /glossaryTerms/{id}")
  @Headers({
   ...
   */
  @RequestLine("PATCH /glossaries/{id}")
  @Headers({
      "Content-Type: application/json-patch+json",
      "Accept: application/json",
  })
