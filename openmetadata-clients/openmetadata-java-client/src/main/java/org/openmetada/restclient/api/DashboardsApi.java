...
public interface DashboardsApi extends ApiClient.Api {
   ...
   */
  @RequestLine("PUT /dashboards/{id}/followers")
  @Headers({
   ...
   */
  @RequestLine("DELETE /dashboards/{id}?hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   */
  @RequestLine("DELETE /dashboards/{id}/followers/{userId}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return Dashboard
   */
  @RequestLine("GET /dashboards/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Dashboard
   */
  @RequestLine("GET /dashboards/name/{fqn}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Dashboard
   */
  @RequestLine("GET /dashboards/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /dashboards?fields={fields}&service={service}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /dashboards/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("PATCH /dashboards/{id}")
  @Headers({
