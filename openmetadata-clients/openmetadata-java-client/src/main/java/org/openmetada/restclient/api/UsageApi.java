...
public interface UsageApi extends ApiClient.Api {
   ...
   * @return EntityUsage
   */
  @RequestLine("POST /usage/{entity}/{id}")
  @Headers({
   ...
   * @return EntityUsage
   */
  @RequestLine("POST /usage/{entity}/name/{fqn}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return EntityUsage
   */
  @RequestLine("GET /usage/{entity}/{id}?days={days}&date={date}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return EntityUsage
   */
  @RequestLine("GET /usage/{entity}/name/{fqn}?days={days}&date={date}")
  @Headers({
      "Accept: application/json",
  })
