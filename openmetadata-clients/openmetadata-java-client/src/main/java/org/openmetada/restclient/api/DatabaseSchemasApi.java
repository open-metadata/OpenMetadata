...
public interface DatabaseSchemasApi extends ApiClient.Api {
   ...
   */
  @RequestLine("POST /databaseSchemas")
  @Headers({
   ...
   * @return CreateDatabaseSchema
   */
  @RequestLine("PUT /databaseSchemas")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("DELETE /databaseSchemas/{id}?recursive={recursive}&hardDelete={hardDelete}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
   ...
   */
  @RequestLine("GET /databaseSchemas/{id}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return DatabaseSchema
   */
  @RequestLine("GET /databaseSchemas/name/{fqn}?fields={fields}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return DatabaseSchema
   */
  @RequestLine("GET /databaseSchemas/{id}/versions/{version}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /databaseSchemas?fields={fields}&database={database}&limit={limit}&before={before}&after={after}&include={include}")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("GET /databaseSchemas/{id}/versions")
  @Headers({
      "Accept: application/json",
  })
   ...
   */
  @RequestLine("PATCH /databaseSchemas/{id}")
  @Headers({
