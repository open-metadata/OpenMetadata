...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-05-14T18:11:30.072415+05:30[Asia/Kolkata]")public interface TagsApi extends ApiClient.Api {
   ...
   * @return CreateTag
   */
  @RequestLine("POST /tags/{category}")
  @Headers({
      "Content-Type: */*",
      "Accept: application/json",
  })
   ...
   * @return CreateTag
   */
  @RequestLine("POST /tags/{category}/{primaryTag}")
  @Headers({
      "Content-Type: */*",
      "Accept: application/json",
  })
   ...
   * @return Tag
   */
  @RequestLine("DELETE /tags/{category}/{id}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
   ...
   * @return CategoryList
   */
  @RequestLine("GET /tags?fields={fields}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return TagCategory
   */
  @RequestLine("GET /tags/{category}?fields={fields}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Tag
   */
  @RequestLine("GET /tags/{category}/{primaryTag}?fields={fields}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @return Tag
   */
  @RequestLine("GET /tags/{category}/{primaryTag}/{secondaryTag}?fields={fields}")
  @Headers({
      "Accept: application/json",
  })
   ...
   * @param body  (optional)
   */
  @RequestLine("PUT /tags/{category}/{primaryTag}")
  @Headers({
      "Content-Type: */*",
      "Accept: application/json",
  })
   ...
   * @param body  (optional)
   */
  @RequestLine("PUT /tags/{category}/{primaryTag}/{secondaryTag}")
  @Headers({
      "Content-Type: */*",
      "Accept: application/json",
  })
