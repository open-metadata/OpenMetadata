  ...
  return (
    <div className="min-h-screen p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground">Learn about ZI Score, Purge Scores, and optimization strategies</p>
      </div>
      ...
      <Card className="p-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h2 className="text-3xl font-bold">ZI Score (Zero Index)</h2>
        </div>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-semibold mb-4">What is ZI Score?</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold mb-4">ZI Score Components</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">Regular ZI Score Reviews</p>
                  <p className="text-sm text-muted-foreground">Monitor your ZI Score weekly and investigate any significant drops</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
