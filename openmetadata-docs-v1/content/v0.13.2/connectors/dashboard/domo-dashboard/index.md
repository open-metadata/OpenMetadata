...
{% image
  src="/images/openmetadata/connectors/domodashboard/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/openmetadata/connectors/domodashboard/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/openmetadata/connectors/domodashboard/service-connection.png"
