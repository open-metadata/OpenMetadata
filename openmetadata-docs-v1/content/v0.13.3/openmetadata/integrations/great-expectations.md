...
{% image
src="/images/v0.13.3/openmetadata/integrations/ge-checkpoint-file.gif"
...
{% image
src="/images/v0.13.3/openmetadata/integrations/ge-config-yaml.gif"
...
{% image
src="/images/v0.13.3/openmetadata/integrations/ge-run-checkpoint.gif"
