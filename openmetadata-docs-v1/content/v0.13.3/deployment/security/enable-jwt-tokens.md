...
Once the above configuration is updated, the server is restarted. Admin can go to Settings -> Bots page.
 ...
 {% image src="/images/v0.13.2/deployment/security/enable-jwt/bot.png" alt="Bot settings page" caption="Bot settings page" /%} 

Click on the `ingestion-bot`. The current token can be revoked, or you can create a new one.

 {% image src="/images/v0.13.2/deployment/security/enable-jwt/bot-jwt-token.png" alt="Bot credentials edition" caption="Edit JWT Token for ingestion-bot" /%} 
