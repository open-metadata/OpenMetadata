...
{% tile
    ...
    link="/connectors/database/sqlite/airflow"
  / %}
{% tile
    title="Ingest with the CLI"
    description="Run a one-time ingestion using the metadata CLI"
    link="/connectors/database/sqlite/cli"
  / %}
...
Select SQLite as the service type and click Next.
...
{% image
  src="/images/v0.13.2/openmetadata/connectors/presto/select-sqlite-service.png"
  alt="Select Service"
...
{% image
  src="/images/v0.13.2/openmetadata/connectors/sqlite/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v0.13.2/openmetadata/connectors/sqlite/service-connection.png"
