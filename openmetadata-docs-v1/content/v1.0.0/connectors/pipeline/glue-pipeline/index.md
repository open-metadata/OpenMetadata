...
{% image
  src="/images/v1.0.0/connectors/glue/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/connectors/glue/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/connectors/glue/service-connection.png"
