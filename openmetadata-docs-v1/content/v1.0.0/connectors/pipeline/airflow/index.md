...
{% image
  src="/images/v1.0.0/connectors/airflow/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/connectors/airflow/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/connectors/airflow/service-connection.png"
