...
{% image
  src="/images/v1.0.0/openmetadata/connectors/kafka/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/kafka/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/kafka/service-connection.png"
...
{% image
src="/images/v1.0.0/openmetadata/connectors/configure-metadata-ingestion-messaging.png"
