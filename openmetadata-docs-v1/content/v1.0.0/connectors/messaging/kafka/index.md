...
{% image
  src="/images/v1.0.0/connectors/kafka/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/connectors/kafka/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/connectors/kafka/service-connection.png"
