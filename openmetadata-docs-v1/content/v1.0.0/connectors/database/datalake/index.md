...
{% image
  src="/images/v1.0.0/openmetadata/connectors/datalake/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/datalake/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/datalake/service-connection.png"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/datalake/service-connection-using-aws-s3.png"
  alt="create-account" /%}
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/datalake/service-connection-using-gcs.png"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/datalake/service-connection-using-azure.png"
