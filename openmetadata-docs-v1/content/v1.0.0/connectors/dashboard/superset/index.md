...
{% image
  src="/images/v1.0.0/openmetadata/connectors/superset/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/superset/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.0.0/openmetadata/connectors/superset/service-connection.png"
