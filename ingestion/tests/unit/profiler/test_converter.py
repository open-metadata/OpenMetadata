...
def test_get_columns():
    ...
    assert str(cols["col2.structCol1.arrayStructCol1"].name) == "`col2.structCol1`.arrayStructCol1"
    ...
    assert str(cols["col2.structCol1.arrayStructCol2"].name) == "`col2.structCol1`.arrayStructCol2"
