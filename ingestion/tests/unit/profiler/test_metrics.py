...
class MetricsTest(TestCase):
    ...
    def test_min(self):
        ...
        assert res.get(Min.name()) == 30

    def test_std(self):
        """
        Check STD metric
        """
        std_age = StdDev(col=User.age)
