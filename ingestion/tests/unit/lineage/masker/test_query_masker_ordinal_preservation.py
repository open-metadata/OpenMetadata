...
class TestQueryMaskerOrdinalPreservation(TestCase):
        ...
        query_test_cases = [
            {
                ...
                "query": "SELECT sub.a, sub.cnt FROM (SELECT a, COUNT(*) AS cnt FROM t WHERE x = 10 GROUP BY 1 HAVING COUNT(*) > 2 ORDER BY 1) sub ORDER BY 2 DESC LIMIT 5;",
                "expected": "SELECT sub.a, sub.cnt FROM (SELECT a, COUNT(*) AS cnt FROM t WHERE x = ? GROUP BY 1 HAVING COUNT(*) > ? ORDER BY 1) sub ORDER BY 2 DESC LIMIT ?;",
                "dialect": Dialect.ANSI.value,
            },
            {
                # Subquery in FROM — no GROUP BY ordinals
                "query": "SELECT * FROM (SELECT a, COUNT(*) FROM t WHERE x = 10 GROUP BY 1) sub WHERE sub.a > 5;",
                "expected": "SELECT * FROM (SELECT a, COUNT(*) FROM t WHERE x = ? GROUP BY 1) sub WHERE sub.a > ?;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_ordinal_positions_union_all(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT a FROM t1 WHERE x = 1 GROUP BY 1 UNION ALL SELECT b FROM t2 WHERE y = 2 GROUP BY 1;",
                "expected": "SELECT a FROM t1 WHERE x = ? GROUP BY 1 UNION ALL SELECT b FROM t2 WHERE y = ? GROUP BY 1;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_ordinal_positions_multiple_ctes(self):
        ...
        query_test_cases = [
            {
                "query": "WITH c1 AS (SELECT a FROM t1 WHERE x = 1 GROUP BY 1), c2 AS (SELECT b FROM t2 WHERE y = 2 GROUP BY 1 ORDER BY 1) SELECT * FROM c1 JOIN c2 ON c1.a = c2.b LIMIT 100;",
                "expected": "WITH c1 AS (SELECT a FROM t1 WHERE x = ? GROUP BY 1), c2 AS (SELECT b FROM t2 WHERE y = ? GROUP BY 1 ORDER BY 1) SELECT * FROM c1 JOIN c2 ON c1.a = c2.b LIMIT ?;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_order_by_nulls_first_last(self):
        ...
        query_test_cases = [
            ...
            {
                "query": "SELECT a, b FROM t ORDER BY 1 ASC NULLS FIRST, 2 DESC NULLS LAST;",
                "expected": "SELECT a, b FROM t ORDER BY 1 ASC NULLS FIRST, 2 DESC NULLS LAST;",
                "dialect": Dialect.POSTGRES.value,
            },
        ]
        ...
        query_test_cases = [
            {
                ...
                "query": "SELECT dept, COUNT(*) FROM emp WHERE status = 'active' GROUP BY 1 HAVING dept <> 'HR' ORDER BY 1;",
                "expected": "SELECT dept, COUNT(*) FROM emp WHERE status = ? GROUP BY 1 HAVING dept <> ? ORDER BY 1;",
                "dialect": Dialect.ANSI.value,
            },
            {
                # HAVING with numeric comparison
                "query": "SELECT dept, SUM(salary) FROM emp GROUP BY 1 HAVING SUM(salary) > 100000;",
                "expected": "SELECT dept, SUM(salary) FROM emp GROUP BY 1 HAVING SUM(salary) > ?;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_group_by_column_names_not_affected(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT dept, COUNT(*) FROM emp WHERE status = 'active' GROUP BY dept ORDER BY dept DESC;",
                "expected": "SELECT dept, COUNT(*) FROM emp WHERE status = ? GROUP BY dept ORDER BY dept DESC;",
                "dialect": Dialect.ANSI.value,
            },
            {
                # GROUP BY expression — expressions are not ordinals
                "query": "SELECT EXTRACT(YEAR FROM dt) AS yr, COUNT(*) FROM t WHERE x > 5 GROUP BY EXTRACT(YEAR FROM dt) ORDER BY 1;",
                "expected": "SELECT EXTRACT(YEAR FROM dt) AS yr, COUNT(*) FROM t WHERE x > ? GROUP BY EXTRACT(YEAR FROM dt) ORDER BY 1;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_group_by_string_literal_still_masked(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT 'constant' AS label, COUNT(*) FROM t GROUP BY 'constant';",
    ...
    def test_window_function_order_by_ordinal(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT a, ROW_NUMBER() OVER (PARTITION BY dept ORDER BY 1) AS rn FROM t WHERE x = 5;",
                "expected": "SELECT a, ROW_NUMBER() OVER (PARTITION BY dept ORDER BY 1) AS rn FROM t WHERE x = ?;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_insert_select_with_group_by_ordinal(self):
        ...
        query_test_cases = [
            {
                "query": "INSERT INTO summary SELECT dept, COUNT(*) FROM emp WHERE status = 'active' GROUP BY 1;",
                "expected": "INSERT INTO summary SELECT dept, COUNT(*) FROM emp WHERE status = ? GROUP BY 1;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_bigquery_interval_with_group_by_ordinal(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT * FROM t WHERE dt >= DATETIME_SUB(CURRENT_DATETIME(), INTERVAL 6 MONTH) GROUP BY 1, 2, 3 ORDER BY 1;",
                "expected": "SELECT * FROM t WHERE dt >= DATETIME_SUB(CURRENT_DATETIME(), INTERVAL ? MONTH) GROUP BY 1, 2, 3 ORDER BY 1;",
    ...
    def test_grouping_sets_ordinals_preserved(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT a, b FROM t WHERE x > 5 GROUP BY GROUPING SETS((1), (2), (1, 2)) ORDER BY 1;",
                "expected": "SELECT a, b FROM t WHERE x > ? GROUP BY GROUPING SETS((1), (2), (1, 2)) ORDER BY 1;",
                "dialect": Dialect.ANSI.value,
            },
        ]
    ...
    def test_where_group_by_order_by_context_isolation(self):
        ...
        query_test_cases = [
            {
                "query": "SELECT a, COUNT(*) FROM t WHERE id > 100 AND score < 50 GROUP BY 1 ORDER BY 1;",
                "expected": "SELECT a, COUNT(*) FROM t WHERE id > ? AND score < ? GROUP BY 1 ORDER BY 1;",
                "dialect": Dialect.ANSI.value,
            },
            {
