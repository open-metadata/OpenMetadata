...
"""Unit tests for Superset connection handling."""
...
CONNECTION_MODULE = "metadata.ingestion.source.dashboard.superset.connection"


def test_superset_connection_is_base_connection():
