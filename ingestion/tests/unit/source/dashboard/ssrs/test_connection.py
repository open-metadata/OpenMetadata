...
"""Unit tests for SSRS connection handling."""
...
CONNECTION_MODULE = "metadata.ingestion.source.dashboard.ssrs.connection"


def test_ssrs_connection_is_base_connection():
