...
def test_schema_names_by_database_groups_rows_and_returns_none_on_error(redshift_source):
    ...
    with patch.object(RedshiftSource, "connection", new_callable=PropertyMock) as mock_connection_property:
        ...
        mock_connection.execute.side_effect = Exception("permission denied on SVV_ALL_SCHEMAS")
