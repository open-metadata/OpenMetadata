...
"""Unit tests for Flink connection handling."""
...
CONNECTION_MODULE = "metadata.ingestion.source.pipeline.flink.connection"


def test_flink_connection_is_base_connection():
