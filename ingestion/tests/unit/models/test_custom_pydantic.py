...
class CustomPydanticValidationTest(TestCase):
    ...
    def test_invalid_table(self):
        with pytest.raises(Exception):
            create_request_invalid = CreateTableRequest(
                name=EntityName("Sales::>__reserved__colon__Territory"),
                displayName="SalesTerritory",
                description=Markdown(root="Sales territory lookup table."),
                tableType="Regular",
                columns=[
                    ...
                    Column(
                        ...
                        description=Markdown(
                            root="Date and time the record was last updated."
                        ),
                        fullyQualifiedName=None,
                        tags=None,
                        constraint="NOT_NULL",
                ...
                tableConstraints=[
                    TableConstraint(
                        constraintType="PRIMARY_KEY", columns=["Sales::Last>Year"]
                    )
                ],
                tablePartition=None,
                tableProfilerConfig=None,
