...
class TableauUnitTest(TestCase):
        ...
        data_source = DataSource(
            ...
            fields=[
                DatasourceField(
                    ...
                    upstreamColumns=[
                        UpstreamColumn(
                            id="col-revenue", name="revenue", remoteType="NUMERIC"
                        )
                    ],
                ),
            ],
        ...
        data_source = DataSource(
            ...
            fields=[
                DatasourceField(
                    ...
                    name="Perf",
                    upstreamColumns=[
                        UpstreamColumn(id="col-perf", name="perf", remoteType="STRING")
                    ],
                ),
            ],
        )
            ...
            fields=[
                DatasourceField(
                    ...
                    upstreamColumns=[
                        ...
                        UpstreamColumn(
                            id="col-cost", name="cost", remoteType="NUMERIC"
                        ),
                    ],
                ),
            ],
    ...
    def test_field_without_upstream_columns_stays_tableau_field(self):
        ...
        data_source = DataSource(
            ...
            fields=[
                DatasourceField(
                    id="fld-bucket", name="Region Bucket", upstreamColumns=[]
                )
            ],
        )
