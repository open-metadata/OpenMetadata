...
EXPECTED_DASHBOARD = [
    CreateDashboardRequest(
        ...
        description="tableau dashboard description",
        dashboardUrl="http://tableauHost.com/#/site/hidarsite/workbooks/897790",
        charts=[],
        tags=[],
        owner=None,
...
EXPECTED_CHARTS = [
    CreateChartRequest(
        ...
        description=None,
        chartType="Other",
        chartUrl="http://tableauHost.com/#/site/tableauSiteUrl/views/Regional/Obesity",
        tags=None,
        owner=None,
        service=FullyQualifiedEntityName(__root__="tableau_source_test"),
    ),
    CreateChartRequest(
        ...
        description=None,
        chartType="Other",
        chartUrl="http://tableauHost.com/#/site/tableauSiteUrl/views/Regional/College",
        tags=None,
        owner=None,
        service=FullyQualifiedEntityName(__root__="tableau_source_test"),
    ),
    CreateChartRequest(
        ...
        description=None,
        chartType="Other",
        chartUrl="http://tableauHost.com/#/site/tableauSiteUrl/views/Regional/GlobalTemperatures",
        tags=None,
        owner=None,
        service=FullyQualifiedEntityName(__root__="tableau_source_test"),
    ),
