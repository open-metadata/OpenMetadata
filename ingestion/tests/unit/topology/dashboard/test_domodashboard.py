...
from metadata.ingestion.source.dashboard.domodashboard import (
    DomodashboardSource
)
...
mock_file_path = (
    Path(__file__).parent.parent.parent / "resources/datasets/domodashboard_dataset.json"
)
...
EXPECTED_DASHBOARD = CreateDashboardRequest(
    ...
    tags=None ,
    owner=None ,
    service=EntityReference(id='c3eb265f-5445-4ad3-ba5e-797d3a3071bb', type='dashboardService', name=None, fullyQualifiedName=None, description=None, displayName=None, deleted=None, href=None) ,
    extension=None
)
...
class DomoDashboardUnitTest(TestCase):
    ...
    @patch("pydomo.Domo")
    @patch("metadata.clients.domodashboard_client.DomoDashboardClient.get_chart_details")
    def __init__(self, methodName,get_chart_details ,domo_client, test_connection) -> None:
        ...
        self.domodashboard.context.__dict__["dashboard_service"] = MOCK_DASHBOARD_SERVICE
    ...
    def test_dashboard_name(self):
        assert self.domodashboard.get_dashboard_name(MOCK_DASHBOARD) == mock_data["title"]
