...
# Dashboard with integer format fields - reproduces the original issue
DASHBOARD_WITH_INTEGER_FORMAT_RESPONSE = {
    "dashboard": {
        "id": 201,
        "uid": "integer-format-dashboard",
        "title": "Dashboard with Integer Format Fields",
        "tags": ["test", "integer-format"],
        "panels": [
            {
                "id": 1,
                "type": "table",
                "title": "Table Panel with Integer Format",
                "datasource": {"type": "mysql", "uid": "M96A8BP445022E5A01"},
                "targets": [
                    {
                        "refId": "A",
                        "datasource": {"type": "mysql", "uid": "M96A8BP445022E5A01"},
                        "rawSql": "SELECT id, name, value FROM test_table",
                        "format": 0  # Integer format - was causing validation error
                    }
                ]
            },
            {
                "id": 2,
                "type": "timeseries",
                "title": "Time Series Panel with Integer Format",
                "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                "targets": [
                    {
                        "refId": "A",
                        ...
                        "format": 1  # Integer format - was causing validation error
                    }
                ]
            },
            {
                "id": 3,
                "type": "logs",
                "title": "Logs Panel with Integer Format",
                "datasource": {"type": "loki", "uid": "LOKI8BP445022E5"},
                "targets": [
                    {
                        "refId": "A",
                        "datasource": {"type": "loki", "uid": "LOKI8BP445022E5"},
                        "expr": '{job="app"}',
                        "format": 2  # Integer format for logs
                    }
                ]
            },
            {
                ...
                "targets": [
                    {
                        ...
                        "format": "table"  # String format - should continue to work
                    },
                    {
                        "refId": "B", 
                        "datasource": {"type": "mysql", "uid": "M96A8BP445022E5A01"},
                        "rawSql": "SELECT COUNT(*) FROM orders",
                        "format": 0  # Integer format in same panel
                    }
                ]
            }
        ],
    ...
    "meta": {
        ...
        "canStar": True,
        "canDelete": True,
        "slug": "integer-format-dashboard",
        "url": "/d/integer-format-dashboard/dashboard-with-integer-format-fields",
