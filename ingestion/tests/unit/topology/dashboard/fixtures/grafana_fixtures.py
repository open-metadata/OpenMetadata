...
# Dashboard with a collapsed row whose child panels must still be ingested
DASHBOARD_WITH_COLLAPSED_ROW = {
    "dashboard": {
        "id": 300,
        "uid": "collapsed-row-test",
        "title": "Collapsed Row Test Dashboard",
        "tags": [],
        "panels": [
            {
                "id": 1,
                "type": "graph",
                "title": "Visible Top-Level Panel",
                "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                "targets": [
                    {
                        "refId": "A",
                        "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                        "rawSql": "SELECT id FROM visible_table",
                    }
                ],
            },
            {
                "id": 2,
                "type": "row",
                "title": "Hidden Row (collapsed)",
                "collapsed": True,
                "panels": [
                    {
                        "id": 3,
                        "type": "stat",
                        "title": "Panel Inside Collapsed Row",
                        "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                        "targets": [
                            {
                                "refId": "A",
                    ...
                    },
                    {
                        "id": 4,
                        "type": "table",
                        "title": "Second Panel Inside Collapsed Row",
                        "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                        "targets": [
                            {
                                "refId": "A",
            ...
            },
            {
                "id": 5,
                "type": "row",
                "title": "Expanded Row (not collapsed)",
                "collapsed": False,
                "panels": [],
            },
            {
                "id": 6,
                "type": "bargauge",
                "title": "Child of Expanded Row (at top level)",
                "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                "targets": [
                    {
                        "refId": "A",
                        "datasource": {"type": "postgres", "uid": "P44A8B96022E5A01A"},
                        "rawSql": "SELECT * FROM expanded_child_table",
                    }
                ],
            },
        ],
    ...
    "meta": {
        ...
        "canStar": True,
        "canDelete": True,
        "slug": "collapsed-row-test",
        "url": "/d/collapsed-row-test/collapsed-row-test",
