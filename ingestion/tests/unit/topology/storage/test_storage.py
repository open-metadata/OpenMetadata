...
class StorageUnitTest(TestCase):
    ...
    def test_generate_unstructured_container(self):
        ...
        self.assertEqual(
            S3ContainerDetails(
                ...
                sourceUrl=SourceUrl(
                    root="https://s3.console.aws.amazon.com/s3/buckets/test_bucket?region=us-east-1&tab=objects"
                ),
    ...
    def test_generate_structured_container(self):
        ...
        columns: List[Column] = [
            Column(
                name=ColumnName(root="transaction_id"),
                dataType=DataType.INT,
                dataTypeDisplay="INT",
                displayName="transaction_id",
            ),
            Column(
                name=ColumnName(root="transaction_value"),
                dataType=DataType.INT,
                dataTypeDisplay="INT",
        ...
        self.assertEqual(
            S3ContainerDetails(
                ...
                parent=entity_ref,
                sourceUrl=SourceUrl(
                    root="https://s3.console.aws.amazon.com/s3/buckets/test_bucket?region=us-east-1&prefix=transactions/&showversions=false"
                ),
