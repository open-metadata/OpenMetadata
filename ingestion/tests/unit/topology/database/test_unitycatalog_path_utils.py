...
class TestNormalizeStoragePath:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "ABFSS://raw@acct.dfs.core.windows.net/t",
                "abfss://raw@acct.dfs.core.windows.net/t",
            ),
            (
                "abfs://raw@acct.dfs.core.windows.net/t",
                "abfss://raw@acct.dfs.core.windows.net/t",
            ),
            (
                "wasbs://raw@acct.blob.core.windows.net/t",
                "abfss://raw@acct.blob.core.windows.net/t",
            ),
    ...
    def test_the_object_key_keeps_its_case(self):
        ...
        assert (
            normalize_storage_path("s3://Bucket/Key/File.CSV")
