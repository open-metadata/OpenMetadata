...
class DatabricksUnitTest(TestCase):
    ...
    def __init__(self, methodName, test_connection, db_init_version) -> None:
        ...
        self.databricks_source.context.__dict__["database"] = (
            MOCK_DATABASE.name.__root__
        )
        self.databricks_source.context.__dict__["database_service"] = (
            MOCK_DATABASE_SERVICE.name.__root__
        )

        self.databricks_source.context.__dict__["database_schema"] = (
