...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [
                ("name=Alice", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=Bob", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=Charlie", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=Diana", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=Jane", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=Others", TestCaseStatus.Failed, None, None, None, None, 0.0033),
            ],
        ),
        (
            ...
            [
                ("name=Alice", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=Charlie", TestCaseStatus.Failed, None, None, None, None, 0.0033),
                ("name=John", TestCaseStatus.Failed, None, None, None, None, 0.0033),
