...
from metadata.generated.schema.tests.basic import TestCaseResult, TestCaseStatus, TestCaseFailureStatusType
...
def test_suite_validation_datalake(
    ...
    if res.testCaseStatus == TestCaseStatus.Failed:
        assert res.testCaseFailureStatus.testCaseFailureStatusType == TestCaseFailureStatusType.New
