...
from metadata.ingestion.models.table_queries import TableColumn, TableColumnJoin
...
class QueryParserTests(TestCase):
    ...
    def test_get_table_joins(self):
        ...
        self.assertEqual(
            ...
            [
                TableColumnJoin(
                    table_column=TableColumn(table="foo", column="col1"),
                    joined_with=[
                ...
                TableColumnJoin(
                    table_column=TableColumn(table="foo", column="col2"),
                    joined_with=[
