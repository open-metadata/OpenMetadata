...
from metadata.generated.schema.security.credentials.azure.clientSecretCredentials import (
    ClientSecretCredentials,
)
from metadata.generated.schema.security.credentials.azure.usernamePasswordCredentials import (
...
class TestAzureClient(unittest.TestCase):
    ...
    def test_create_client(
        ...
        credentials = AzureCredentials(
            clientId="clientId",
            azureAuthType=UsernamePasswordCredentials(
        ...
        mock_user_pass_credential.assert_called_once()

        mock_user_pass_credential.reset_mock()
        credentials = AzureCredentials(
            clientId="clientId",
        )
        instance = AzureClient(credentials)
