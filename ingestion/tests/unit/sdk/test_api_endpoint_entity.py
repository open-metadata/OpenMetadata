...
from metadata.sdk.entities.apiendpoint import APIEndpoint
...
class TestAPIEndpointEntity(unittest.TestCase):
    ...
    def test_create_api_endpoint(self):
        ...
        result = APIEndpoint.create(create_request)
    ...
    def test_retrieve_api_endpoint_by_id(self):
        ...
        result = APIEndpoint.retrieve(self.entity_id)
    ...
    def test_retrieve_api_endpoint_by_name(self):
        ...
        result = APIEndpoint.retrieve_by_name(self.entity_fqn)
    ...
    def test_update_api_endpoint(self):
        ...
        result = APIEndpoint.update(self.entity_id, entity_to_update)
    ...
    def test_patch_api_endpoint(self):
        ...
        result = APIEndpoint.patch(self.entity_id, json_patch)
    ...
    def test_delete_api_endpoint(self):
        ...
        APIEndpoint.delete(self.entity_id, recursive=True, hard_delete=False)
    ...
    def test_list_api_endpoints(self):
        ...
        result = APIEndpoint.list(limit=10)
