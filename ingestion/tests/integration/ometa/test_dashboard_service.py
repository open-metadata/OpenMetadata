...
"""
OpenMetadata high-level API Dashboard Servie tests
"""
import uuid
...
class OMetaDatabaseServiceTest(TestCase):
    ...
    def test_get_name_not_found(self):
        """
        We can not fetch a Database Service by a wrong name
        """

        self.metadata.create_or_update(data=self.create)

        res = self.metadata.get_by_name(entity=DatabaseService, fqn="skkkkk")
    ...
    def test_health_check(self):
        ...
        Is service health?
        """
        self.assertTrue(self.metadata.health_check())
