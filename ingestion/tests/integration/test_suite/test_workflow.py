...
class TestSuiteWorkflowTests(unittest.TestCase):
    ...
    def test_create_workflow_object_from_cli_config(self):
        ...
        workflow_test_suite = workflow.get_or_create_test_suite_entity_for_cli_workflow()
    ...
    def test_get_test_suite_entity_for_ui_workflow(self):
        ...
        expected_test_suite = self.metadata.get_by_name(entity=TestSuite,fqn="critical_metrics_suite")
    ...
    def test_get_test_cases_from_test_suite(self):
        ...
        assert {'table_column_count_between', 'table_column_count_equals'}.intersection({test_case.name.__root__ for test_case in test_cases})
    ...
    def test_get_test_case_names_from_cli_config(self):
        ...
        assert [test_case_def[0].name for test_case_def in test_cases_def] == ["my_test_case", "my_test_case_two", "my awesome test case"]
        assert set([test_suite_def[1].name for test_suite_def in test_cases_def]) == {"my_test_suite", "my_test_suite_two"}
    ...
    def test_compare_and_create_test_cases(self):
        ...
        created_test_case = workflow.compare_and_create_test_cases(config_test_cases_def, test_cases)
