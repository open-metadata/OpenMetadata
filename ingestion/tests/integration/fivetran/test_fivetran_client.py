...
class TestFivetranClient:
    def test_list_groups(self, fivetran_client):
        groups = fivetran_client.list_groups()
        assert len(groups) == 3
    ...
    def test_list_group_connectors(self, fivetran_client):
        connectors = fivetran_client.list_group_connectors("group_postgres_rds")
    ...
    def test_hva_connector_listed(self, fivetran_client):
        connectors = fivetran_client.list_group_connectors("group_hva_sqlserver")
        assert len(connectors) == 1
