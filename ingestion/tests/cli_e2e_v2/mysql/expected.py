...
MYSQL_TYPE_MAP: TypeMap = {
    **CORE_TYPE_MAP,
    ...
    mysql.VARCHAR:      DataType.VARCHAR,
    mysql.CHAR:         DataType.CHAR,
    mysql.TINYTEXT:     DataType.TEXT,        # no TINYTEXT in OM DataType
    mysql.TEXT:         DataType.TEXT,
