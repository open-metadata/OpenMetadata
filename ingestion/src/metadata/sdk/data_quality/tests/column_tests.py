...
class ColumnValueMaxToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the maximum value in column '{column}' is between {min_value or 'any'} and {max_value or 'any'}",
        )
        if min_value is not None:
            self.parameters.append(
...
class ColumnValueMinToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the minimum value in column '{column}' is between {min_value or 'any'} and {max_value or 'any'}",
        )
        if min_value is not None:
            self.parameters.append(
...
class ColumnValueMeanToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the mean value in column '{column}' is between {min_value or 'any'} and {max_value or 'any'}",
        )
        if min_value is not None:
            self.parameters.append(
...
class ColumnValueMedianToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the median value in column '{column}' is between {min_value or 'any'} and {max_value or 'any'}",
        )
        if min_value is not None:
            self.parameters.append(
                TestCaseParameterValue(
...
class ColumnValueStdDevToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the standard deviation in column '{column}' is between {min_value or 'any'} and {max_value or 'any'}",
        )
        if min_value is not None:
            self.parameters.append(
                TestCaseParameterValue(
...
class ColumnValuesSumToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the sum of values in column '{column}' is between {min_value or 'any'} and {max_value or 'any'}",
        )
        if min_value is not None:
            self.parameters.append(
...
class ColumnValueLengthsToBeBetween(ColumnTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that value lengths in column '{column}' are between {min_length or 'any'} and {max_length or 'any'}",
        )
