...
class TableColumnCountToBeBetween(TableTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            or f"Validates that the number of columns in the table is between {min_count or 'any'} and {max_count or 'any'}",
        )
...
class TableRowCountToBeBetween(TableTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that the number of rows in the table is between {min_count or 'any'} and {max_count or 'any'}",
        )
        if min_count is not None:
            self.parameters.append(
...
class TableRowInsertedCountToBeBetween(TableTest):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Validates that rows inserted in the last {range_interval} {range_type.lower()}(s) is between {min_count or 'any'} and {max_count or 'any'}",
        )
        if min_count is not None:
            self.parameters.append(
                TestCaseParameterValue(name="minValue", value=str(min_count))
...
class TableDiff(TableTest):
    ...
    Args:
        table_fqn: Fully qualified name of the table to compare against
    ...
    Example:
        >>> test = TableDiff(
        ...     table_fqn="service.database.schema.reference_table",
        ...     key_columns=["id"],
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description=description
            or f"Compares current table with {table_fqn} to identify differences",
        )
        self.parameters.append(TestCaseParameterValue(name="tableFqn", value=table_fqn))
        if key_columns:
            self.parameters.append(
