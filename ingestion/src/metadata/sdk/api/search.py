...
class Search:
    ...
    def search(  # pylint: disable=too-many-arguments
        ...
        Args:
            ...
            include_aggregations: Include aggregations in response. Defaults to False for better performance.
...
class SearchBuilder:
    ...
    def __init__(self) -> None:
        ...
        self._include_aggregations: bool = False
    ...
    def include_aggregations(self, include: bool = True) -> "SearchBuilder":
        """Set whether to include aggregations. Defaults to False for better performance."""
