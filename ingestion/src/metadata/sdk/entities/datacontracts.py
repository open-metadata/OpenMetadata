...
from metadata.sdk.types import OMetaClient, UuidLike, ensure_uuid
...
class ODCSImportOperation:
    ...
    entity_id: str
    entity_type: str
    odcs_data: ODCSDataContract | None = None
    ...
    def execute(self) -> DataContract | None:
...
class DataContracts(BaseEntity[DataContract, CreateDataContractRequest]):
    ...
    def import_odcs(cls, entity_id: UuidLike, entity_type: str) -> ODCSImportOperation:
        ...
        Args:
            entity_id: UUID of the entity (table/topic) to attach the contract
            to (accepts str, uuid.UUID, or schema Uuid)
    ...
    @classmethod
    def get_by_entity(cls, entity_id: UuidLike, entity_type: str) -> DataContract | None:
        """
    ...
    @classmethod
    def validate_by_entity(cls, entity_id: UuidLike, entity_type: str) -> DataContractResult | None:
        """
    ...
    @classmethod
    def validate_request(cls, request: CreateDataContractRequest) -> DataContractResult | None:
        """
    ...
    @classmethod
    def validate_request_yaml(cls, yaml_content: str) -> Any | None:
        """
    ...
    @classmethod
    def parse_odcs_yaml(cls, yaml_content: str) -> Any | None:
        """
