...
"""
Source connection handler for StarRocks
"""
...
def get_connection(connection: StarRocksConnection) -> Engine:
    """
    Create connection for StarRocks
    """
...
def test_connection(
    ...
    def custom_executor_for_queries():
        engine.execute(STARROCKS_TEST_GET_QUERIES)
    ...
    return test_connection_db_schema_sources(
        ...
        queries={"GetQueries": custom_executor_for_queries},
    )
