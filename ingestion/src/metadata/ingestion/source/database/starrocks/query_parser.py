...
class StarRocksQueryParserSource(QueryParserSource, ABC):
    """
    StarRocks base class for Usage and Lineage extraction.
    Queries the FE audit log plugin table for query history.
    """
    ...
    def get_sql_statement(self, start_time: datetime, end_time: datetime) -> str:
        """
        Returns the SQL statement to fetch query logs from the audit table.
        """
