...
_CUSTOM_TYPE_MAP = {DataType.MONEY: GaussdbMoney}
_CUSTOM_TYPE_MAP_reversed = {v: {k} for k, v in _CUSTOM_TYPE_MAP.items()}


class GaussdbMapTypes(CommonMapTypes):
    """Gaussdb type mapper, inherits from CommonMapTypes"""
...
converter_registry[DatabaseServiceType.Gaussdb] = GaussdbMapTypes
