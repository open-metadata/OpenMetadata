...
OracleDialect.get_view_names = get_view_names
OracleDialect._get_default_schema_name = _get_default_schema_name
OracleDialect._prepare_reflection_args = _prepare_reflection_args
