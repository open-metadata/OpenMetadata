...
class OracleSource(StoredProcedureMixin, CommonDbSourceService):
    ...
    def __init__(self, config: WorkflowSource, metadata: OpenMetadata) -> None:
        ...
        self.service_connection: OracleConnection = cast(OracleConnection, self.service_connection)
    ...
    def query_table_names_and_types(
        ...
        regular_tables = [
            ...
            for table_name in self.inspector.get_table_names(schema=schema_name, **{'oracle_table_prefix':self.oracle_table_prefix}) or []
        ]
        material_tables = [
