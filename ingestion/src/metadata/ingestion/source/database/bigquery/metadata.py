...
class BigquerySource(LifeCycleQueryMixin, CommonDbSourceService, MultiDBSource):
    ...
    def __init__(self, config, metadata, incremental_configuration: IncrementalConfig):
        ...
        self._policy_tag_prefetch_key: Optional[Tuple[str, ...]] = None
                ...
                for project_id in list_project_ids:
                    try:
                        parent = (
                            ...
                            f"{self.service_connection.taxonomyLocation}"
                        )
                        taxonomies = list(
                        ...
                        for taxonomy in taxonomies:
                            ...
                            policy_tags = list(
                                self._policy_tag_client.list_policy_tags(
                            ...
                            for tag in policy_tags:
                                ...
                                taxonomy_to_tags[taxonomy.display_name].append(
                                    tag.display_name
                                )
                    except Exception as exc:
                        logger.warning(
