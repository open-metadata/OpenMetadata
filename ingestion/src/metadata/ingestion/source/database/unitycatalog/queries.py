...
def unity_catalog_native_lineage_query(
    query_log_duration: int, include_query_history: bool
) -> str:
    """
    ...
    return UNITY_CATALOG_NATIVE_LINEAGE.format(
        ...
        history_join=UNITY_CATALOG_QUERY_HISTORY_JOIN.format(
            history_lookback=query_log_duration + 1
        ),
    )
