...
def get_table_names(self, connection, schema=None, **kw):
    ...
    Returns:
    """
    return self._get_table_or_view_names(["r", "e"], connection, schema, **kw)  # pylint: disable=protected-access
...
def get_view_names(self, connection, schema=None, **kw):
    ...
    Returns:
    """
    return self._get_table_or_view_names(["v"], connection, schema, **kw)  # pylint: disable=protected-access
...
def _get_table_or_view_names(self, relkinds, connection, schema=None, **kw):
    ...
    all_relations = self._get_all_relation_info(connection, info_cache=info_cache)  # pylint: disable=protected-access
    relation_names = []
...
def _get_column_info(self, *args, **kwargs):
    ...
    if sa_version < Version("1.4.0") and "identity" in kwdrs:
        ...
        kwdrs["identity"] = None
    column_info = super(RedshiftDialectMixin, self)._get_column_info(*args, **kwdrs)  # pylint: disable=protected-access
...
RedshiftDialectMixin._get_table_or_view_names = _get_table_or_view_names  # pylint: disable=protected-access
RedshiftDialectMixin.get_view_names = get_view_names  # pylint: disable=protected-access
RedshiftDialectMixin.get_table_names = get_table_names  # pylint: disable=protected-access
RedshiftDialectMixin._get_column_info = _get_column_info  # pylint: disable=protected-access
RedshiftDialectMixin._get_all_relation_info = _get_all_relation_info  # pylint: disable=protected-access
RedshiftDialectMixin._get_schema_column_info = _get_schema_column_info  # pylint: disable=protected-access
