...
class GoogleSheetsSheet(BaseModel):
    ...
    properties: Optional[GoogleSheetsProperties] = Field(None, description="Sheet properties")
    gridProperties: Optional[GoogleSheetsGridProperties] = Field(None, description="Sheet grid properties")
...
class GoogleSheetsSpreadsheetDetails(BaseModel):
    ...
    properties: Optional[GoogleSheetsSpreadsheetProperties] = Field(None, description="Spreadsheet properties")
    ...
    parents: Optional[List[str]] = Field(default_factory=list, description="Parent directory IDs")
    createdTime: Optional[str] = Field(None, description="Creation time")
    modifiedTime: Optional[str] = Field(None, description="Last modified time")
