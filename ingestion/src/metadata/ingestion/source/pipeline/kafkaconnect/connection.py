...
from metadata.generated.schema.entity.services.connections.pipeline.kafkaConnectConnection import (
    KafkaConnectConnection as KafkaConnectConnectionConfig,
)
...
class KafkaConnectConnection(BaseConnection[KafkaConnectConnectionConfig, KafkaConnectClient]):
    def _get_client(self) -> KafkaConnectClient:
