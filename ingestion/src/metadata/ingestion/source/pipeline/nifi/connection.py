...
from metadata.generated.schema.entity.services.connections.pipeline.nifiConnection import (
    NifiConnection as NifiConnectionConfig,
)
...
class NifiConnection(BaseConnection[NifiConnectionConfig, NifiClient]):
    def _get_client(self) -> NifiClient:
        connection = self.service_connection

        return NifiClient(connection=connection)
