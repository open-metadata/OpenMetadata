...
from metadata.generated.schema.entity.services.connections.dashboard.qlikSenseConnection import (
    QlikSenseConnection as QlikSenseConnectionConfig,
)
...
class QlikSenseConnection(BaseConnection[QlikSenseConnectionConfig, QlikSenseClient]):
    def _get_client(self) -> QlikSenseClient:
