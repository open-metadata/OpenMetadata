...
from metadata.generated.schema.entity.services.connections.dashboard.qlikCloudConnection import (
    QlikCloudConnection as QlikCloudConnectionConfig,
)
...
class QlikCloudConnection(BaseConnection[QlikCloudConnectionConfig, QlikCloudClient]):
    def _get_client(self) -> QlikCloudClient:
