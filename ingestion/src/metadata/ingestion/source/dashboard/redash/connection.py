...
from metadata.generated.schema.entity.services.connections.dashboard.redashConnection import (
    RedashConnection as RedashConnectionConfig,
)
...
class RedashConnection(BaseConnection[RedashConnectionConfig, RedashApiClient]):
    def _get_client(self) -> RedashApiClient:
