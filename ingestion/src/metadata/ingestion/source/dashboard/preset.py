...
class PresetSource(DashboardServiceSource):
    """
    Preset Source Class
    """
    ...
    status: SourceStatus
    platform = "preset"
    service_type = DashboardServiceType.Preset.value
    ...
    def create(cls, config_dict: dict, metadata_config: OpenMetadataConnection):
        ...
        connection: PresetConnection = config.serviceConnection.__root__.config
    ...
    def prepare(self):
        """
        Fetching all charts available in preset
