...
class AzureClient:
    ...
    def create_client(
        ...
        try:
            ...
            logger.error(f"Error creating Azure Client: {e}")  # noqa: G004
            raise e  # noqa: TRY201
    ...
    def create_blob_client(self):
        ...
        try:
            ...
            logger.error(f"Error creating Blob Service Client: {e}")  # noqa: G004
            raise e  # noqa: TRY201
    ...
    def create_secret_client(self):
        ...
        try:
            ...
            logger.error(f"Error creating Secret Client: {e}")  # noqa: G004
            raise e  # noqa: TRY201
