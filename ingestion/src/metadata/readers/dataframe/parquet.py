...
class ParquetDataFrameReader(DataFrameReader):
    ...
    def _(self, _: S3Config, key: str, bucket_name: str) -> DatalakeColumnWrapper:
        ...
        client_kwargs = {
            "endpoint_override": str(self.config_source.securityConfig.endPointURL) if self.config_source.securityConfig.endPointURL else None,
            "region": self.config_source.securityConfig.awsRegion if self.config_source.securityConfig.awsRegion else None,
