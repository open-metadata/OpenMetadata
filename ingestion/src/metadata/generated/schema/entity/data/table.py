...
class ColumnProfile(BaseModel):
    ...
    min: Optional[float] = Field(
        None,
        description='Minimum value in a column. Applies to column with number values. It will be 0 for any other types',
    )
    max: Optional[float] = Field(
        None,
        description='Maximum value in a column. Applies to column with number values. It will be 0 for any other types',
    )
    mean: Optional[float] = Field(
        None,
        description='Avg value in a column. Applies to column with number values. It will be 0 for any other types',
    )
...
class TableProfile(BaseModel):
    ...
    column_profile: Optional[List[ColumnProfile]] = Field(
...
class Table(BaseModel):
    ...
    dataProfile: Optional[TableProfile] = Field(
