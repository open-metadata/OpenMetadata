...
from metadata.cli.mysql_dump import dump
...
def run_backup(
    ...
    connection = MysqlConnection(
        ...
        connectionOptions=ConnectionOptions(**connection_options)
        if connection_options
        else None,
        connectionArguments=ConnectionArguments(**connection_arguments)
        if connection_arguments
        else None,
    )

    dump(connection=connection, output=out)
