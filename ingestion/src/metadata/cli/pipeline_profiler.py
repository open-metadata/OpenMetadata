...
"""
Pipeline Profiler utility for the metadata CLI
"""
import sys
import traceback
...
from metadata.workflow.pipeline_profiler import PipelineProfilerWorkflow
from metadata.workflow.workflow_init_error_handler import WorkflowInitErrorHandler

logger = cli_logger()


def run_pipeline_profiler(config_path: Path) -> None:
    """
    Run the pipeline profiler workflow from a config path
