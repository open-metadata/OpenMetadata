...
class DataBricksProfilerSource(ProfilerSource):
    ...
    def __init__(self, config: OpenMetadataWorkflowConfig, database: DatabaseService, ometa_client: OpenMetadata):
    ...
    def set_is_disconnect(self):
        ...
        from databricks.sqlalchemy import DatabricksDialect # pylint: disable=import-outside-toplevel
