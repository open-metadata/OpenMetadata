...
base_requirements = {
    ...
    "jaraco.context==6.0.1",  # 6.1.0 causes distribution not found error with keyring. Note: 6.0.1 has path traversal vulnerability (patched in 6.1.0), but 6.1.0 breaks ingestion
