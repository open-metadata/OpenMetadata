...
plugins: Dict[str, Set[str]] = {
    ...
    "kafka": {"confluent_kafka==1.8.2", "fastavro>=1.2.0", "avro-python3", "avro", "grpcio-tools", "protobuf"},
    "kinesis": {"boto3~=1.19.12"},
    "redpanda": {"confluent_kafka==1.8.2", "fastavro>=1.2.0", "avro-python3", "avro", "grpcio-tools", "protobuf"},
