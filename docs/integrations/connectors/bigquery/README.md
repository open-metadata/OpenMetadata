...
1. [Prepare a Python virtual environment](./#1.-prepare-a-python-virtual-environment)
2. [Install the Python module for this connector](./#2.-install-the-python-module-for-this-connector)
3. [Create a configuration file using template JSON](./#3.-create-a-configuration-file-using-template-json)
4. [Configure service settings](./#4.-configure-service-settings)
5. [Enable/disable the data profiler](./#5.-enable-disable-the-data-profiler)
6. [Install the data profiler Python module (optional)](./#6.-install-the-data-profiler-python-module-optional)
7. [Configure data filters (optional)](./#7.-configure-data-filters-optional)
8. [Configure sample data (optional)](./#8.-configure-sample-data-optional)
9. [Configure DBT (optional)](./#9.-configure-dbt-optional)
10. [Confirm sink settings](./#10.-confirm-sink-settings)
11. [Confirm metadata\_server settings](./#11.-confirm-metadata\_server-settings)
12. [Run ingestion workflow](./#12.-run-ingestion-workflow)
13. [Ingest metadata in production (optional)](./#13.-productionize-ingestion-optional)
...
### **13. Ingest metadata in production (optional)**
...
Then re-run the metadata ingestion workflow in [Step 12](./#12.-run-ingestion-workflow).
