---
description: Use your own Airflow instance to schedule and run the Postgres connector.
---

# Run Postgres Connector with the Airflow SDK

Configure and schedule Postgres **metadata** and **profiler** workflows using your own Airflow instances.

* [Requirements](run-postgres-connector-with-the-airflow-sdk.md#requirements)
* [Metadata Ingestion](run-postgres-connector-with-the-airflow-sdk.md#metadata-ingestion)
* [Data Profiler and Quality Tests](run-postgres-connector-with-the-airflow-sdk.md#data-profiler-and-quality-tests)
* [DBT Integration](run-postgres-connector-with-the-airflow-sdk.md#dbt-integration)
...
The same as the [metadata](run-postgres-connector-with-the-airflow-sdk.md#workflow-configuration) ingestion.
