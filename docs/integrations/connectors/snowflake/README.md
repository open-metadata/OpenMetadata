...
![Configure the Service connection](<../../../../.gitbook/assets/image (94).png>)
...
You can learn more about how to run a one-time ingestion of the different workflows using the `metadata` CLI [here](../../../../integrations/connectors/mysql-1-1-1/run-mysql-connector-using-cli.md).
