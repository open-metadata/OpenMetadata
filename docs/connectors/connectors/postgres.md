---
description: >-
  This guide will help you install and configure the Postgres connector and run
...
1. [Prepare a Python virtual environment](postgres.md#1.-prepare-a-python-virtual-environment)
2. [Install the Python module for this connector](postgres.md#2.-install-the-python-module-for-this-connector)
3. [Create a configuration file using template JSON](postgres.md#3.-create-a-configuration-file-using-template-json)
4. [Configure service settings](postgres.md#4.-configure-service-settings)
5. [Enable/disable the data profiler](postgres.md#5.-enable-disable-the-data-profiler)
6. [Install the data profiler Python module (optional)](postgres.md#6.-install-the-data-profiler-python-module-optional)
7. [Configure data filters (optional)](postgres.md#7.-configure-data-filters-optional)
8. [Configure sample data (optional)](postgres.md#8.-configure-sample-data-optional)
9. [Configure DBT (optional)](postgres.md#9.-configure-dbt-optional)
10. [Confirm sink settings](postgres.md#10.-confirm-sink-settings)
11. [Confirm metadata\_server settings](postgres.md#11.-confirm-metadata\_server-settings)
12. [Run ingestion workflow](postgres.md#12.-run-ingestion-workflow)
...
The syntax and semantics for `schema_filter_pattern` are the same as for [`table_filter_pattern`](postgres.md#table\_filter\_pattern-optional). Please check that section for details.
...
Then re-run the install command in [Step 2](postgres.md#2.-install-the-python-module-for-this-connector).
...
Then re-run the metadata ingestion workflow in [Step 12](postgres.md#12.-run-ingestion-workflow).
