...
![./images/new-issue.png](../open-source-community/developer/images/new-issue.png)
...
![./images/fork-github.png](<../../.gitbook/assets/fork-github (2).png>)
...
Make changes. Follow the [Coding Style](https://github.com/open-metadata/OpenMetadata/blob/main/docs/open-source-community/developer/docs/open-source-community/developer/backend/coding-style.md) Guide on best practices and [Build the code & run tests](broken-reference) on how to set up IntelliJ, Maven.
...
2. It should show an option to open a pull request. ![./images/pull-request-1.png](../open-source-community/developer/images/pull-request-1.png)
3.  If not, click on "New Pull request"

    ![./images/pull-request.png](../open-source-community/developer/images/pull-request.png)
4. Select your fork repository and branch ![./images/pull-request-2.png](../open-source-community/developer/images/pull-request-2.png)
