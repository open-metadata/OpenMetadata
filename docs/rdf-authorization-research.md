...
4. **The Fuseki registry is static and user-keyed (S5, S6).** Mirroring OM owner, team, tag, and domain policies into it is the synchronization infrastructure the user excluded. It would also require non-anonymous query endpoints.
