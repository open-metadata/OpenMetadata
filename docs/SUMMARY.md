...
* [Connectors](integrations/connectors/README.md)
  ...
  * [Metabase](integrations/connectors/mysql/README.md)
    * [Run Metabase Connector with the Airflow SDK](integrations/connectors/mysql/run-metabase-connector-with-the-airflow-sdk.md)
    * [Run Metabase Connector with the CLI](integrations/connectors/mysql/run-metabase-connector-with-the-cli.md)
  ...
  * [MySQL](integrations/connectors/mysql-1/README.md)
    * [Run MySQL Connector with the Airflow SDK](integrations/connectors/mysql-1/run-mysql-connector-with-the-airflow-sdk.md)
    * [Run MySQL Connector using CLI](integrations/connectors/mysql-1/run-mysql-connector-using-cli.md)
  ...
  * [Oracle](integrations/connectors/mysql-2/README.md)
    * [Run Oracle Connector with the Airflow SDK](integrations/connectors/mysql-2/run-oracle-connector-with-the-airflow-sdk.md)
    * [Run Oracle Connector with the CLI](integrations/connectors/mysql-2/run-oracle-connector-with-the-cli.md)
  ...
  * [Clickhouse](integrations/connectors/snowflake-2/README.md)
    * [Run Clickhouse Connector with the Airflow SDK](integrations/connectors/snowflake-2/run-clickhouse-connector-with-the-airflow-sdk.md)
    * [Run Clickhouse Connector with the CLI](integrations/connectors/snowflake-2/run-clickhouse-connector-with-the-cli.md)
