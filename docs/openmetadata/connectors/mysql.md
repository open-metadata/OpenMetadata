...
You need not make any changes to the fields defined for `sink` in the template code you copied into `mysql.json` in Step 1. This part of your configuration file should be as follows.
...
```bash
pip3 install --upgrade 'openmetadata-ingestion[mysql]'
```
