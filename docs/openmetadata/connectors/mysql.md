...
3. [Create a configuration file using template JSON](mysql.md#3.-create-a-configuration-file-using-template-json)
4. [Configure service settings](mysql.md#4.-configure-service-settings)
5. [Enable/disable the data profiler](mysql.md#5.-enable-disable-the-data-profiler)
6. [Install the data profiler Python module (optional)](mysql.md#6.-install-the-data-profiler-python-module-optional)
