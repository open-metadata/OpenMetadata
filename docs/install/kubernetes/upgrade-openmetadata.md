...
Follow the [Backup Metadata](../backup-metadata.md) guide to ensure you have a restorable copy of your metadata before proceeding further.
{% endhint %}
...
Head on to [connectors](broken-reference) section to ingest data from various sources.
