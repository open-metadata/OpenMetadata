...
public final class RestUtil {
  ...
  public static class PutResponse<T> {
     ...
     * a new entity
     */
    public PutResponse(Status status, T entity, String changeType) {
      this.entity = entity;
      this.status = status;
    ...
    public PutResponse(Status status, ChangeEvent changeEvent, String changeType) {
  ...
  public static class PatchResponse<T> {
     ...
     * a new entity
     */
    public PatchResponse(Status status, T entity, String changeType) {
      this.entity = entity;
      this.status = status;
      this.changeType = changeType;
    }
